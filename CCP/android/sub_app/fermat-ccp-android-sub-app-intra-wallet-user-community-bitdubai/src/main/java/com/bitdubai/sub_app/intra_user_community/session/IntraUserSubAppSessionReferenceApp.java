 ...
 */
public class IntraUserSubAppSessionReferenceApp extends AbstractReferenceAppFermatSession<InstalledSubApp,IntraUserModuleManager,SubAppResourcesProviderManager> {
    ...
    public IntraUserSubAppSessionReferenceApp() {}
}
