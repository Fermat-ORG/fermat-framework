...
public class FragmentsCommons {
    ...
    public static View setUpHeaderScreen(LayoutInflater inflater, Context activity, IntraUserSubAppSessionReferenceApp intraUserSubAppSession,final FermatApplicationCaller applicationsHelper) throws CantGetActiveLoginIdentityException {
        /**
