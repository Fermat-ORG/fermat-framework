 ...
 */
public class PresentationGeolocationIntraUserIdentityDialog extends FermatDialog<ReferenceAppFermatSession, SubAppResourcesProviderManager> implements View.OnClickListener {
     ...
     */
    public PresentationGeolocationIntraUserIdentityDialog(Activity activity, ReferenceAppFermatSession<IntraUserIdentityModuleManager> fermatSession, SubAppResourcesProviderManager resources, final IntraUserIdentityModuleManager moduleManager) {
    ...
    protected int setLayoutId() {
        return R.layout.tutorial_intra_user_geolocation;
    }
