...
public class ReceiveTransactionHistoryFragment extends FermatWalletListFragment<LossProtectedWalletTransaction,ReferenceAppFermatSession,ResourceProviderManager>
     ...
     */
    public static ReceiveTransactionHistoryFragment newInstance() {
        return new ReceiveTransactionHistoryFragment();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        try {
            ...
            makeText(getActivity(), "Oooops! recovering from system error - Option Menu selected",
