...
public class LossProtectedWalletSessionReferenceApp extends AbstractReferenceAppFermatSession<InstalledWallet,LossProtectedWallet,WalletResourcesProviderManager> {
    ...
    */
    ...
    public LossProtectedWalletSessionReferenceApp() {
    }


    public LossProtectedWalletSessionReferenceApp(String publicKey, InstalledWallet fermatApp, ErrorManager errorManager, LossProtectedWallet moduleManager, WalletResourcesProviderManager resourceProviderManager) {
    ...
    public boolean equals(Object o) {
        ...
        LossProtectedWalletSessionReferenceApp that = (LossProtectedWalletSessionReferenceApp) o;
