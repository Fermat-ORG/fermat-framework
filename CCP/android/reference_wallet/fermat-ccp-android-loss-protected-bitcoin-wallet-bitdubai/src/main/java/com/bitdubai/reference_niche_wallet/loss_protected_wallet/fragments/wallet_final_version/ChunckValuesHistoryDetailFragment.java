 ...
 */
public class ChunckValuesHistoryDetailFragment extends FermatWalletListFragment<LossProtectedWalletTransaction> implements FermatListItemListeners<LossProtectedWalletTransaction>,onRefreshList {
    ...
    private TextView chunck_txt_amount;
     ...
     */
    public static ChunckValuesHistoryDetailFragment newInstance() {
        return new ChunckValuesHistoryDetailFragment();
    }
    ...
    private void  setUpHeader(LayoutInflater inflater) {
        try {
            final RelativeLayout container_chunck_header = getToolbarHeader();
            try {
                container_chunck_header.removeAllViews();
            } catch (Exception e) {

            }

            final View chunk_balance_header = inflater.inflate(R.layout.chunck_header, container_chunck_header, true);

            container_chunck_header.setVisibility(View.VISIBLE);
