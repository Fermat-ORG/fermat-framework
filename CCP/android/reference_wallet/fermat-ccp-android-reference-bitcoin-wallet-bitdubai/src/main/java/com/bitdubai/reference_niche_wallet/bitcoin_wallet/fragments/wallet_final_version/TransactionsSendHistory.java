 ...
 */
public class TransactionsSendHistory extends FermatWalletListFragment<CryptoWalletTransaction> implements FermatListItemListeners<CryptoWalletTransaction> {


    /**
     * MANAGERS
     */
    private com.bitdubai.fermat_ccp_api.layer.wallet_module.crypto_wallet.interfaces.CryptoWallet cryptoWallet;
     ...
     */
    public static TransactionsSendHistory newInstance() {
        TransactionsSendHistory requestPaymentFragment = new TransactionsSendHistory();
        return new TransactionsSendHistory();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            referenceWalletSession.getErrorManager().reportUnexpectedUIException(UISource.VIEW, UnexpectedUIExceptionSeverity.CRASH,ex);
    ...
    public List<CryptoWalletTransaction> getMoreDataAsync(FermatRefreshTypes refreshType, int pos) {
        ...
        try {
            lstTransactions = cryptoWallet.getTransactions(referenceWalletSession.getIntraUserModuleManager().getActiveIntraUserIdentity().getPublicKey(),BalanceType.AVAILABLE,TransactionType.DEBIT,referenceWalletSession.getWalletSessionType().getWalletPublicKey(), MAX_TRANSACTIONS, offset);
