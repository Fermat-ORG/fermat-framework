 ...
 */
public class PresentationBitcoinWalletDialog extends FermatDialog<ReferenceWalletSessionReferenceApp,SubAppResourcesProviderManager> implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
     ...
     */
    public PresentationBitcoinWalletDialog(Activity activity, ReferenceWalletSessionReferenceApp fermatSession, SubAppResourcesProviderManager resources,int type,boolean checkButton) {
