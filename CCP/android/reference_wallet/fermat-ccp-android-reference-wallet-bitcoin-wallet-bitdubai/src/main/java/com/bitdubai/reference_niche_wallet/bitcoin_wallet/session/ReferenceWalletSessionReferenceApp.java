...
public class ReferenceWalletSessionReferenceApp extends AbstractReferenceAppFermatSession<InstalledWallet,CryptoWallet,WalletResourcesProviderManager> {
    ...
    */
    ...
    public ReferenceWalletSessionReferenceApp() {
    }




    public ReferenceWalletSessionReferenceApp(String publicKey, InstalledWallet fermatApp, ErrorManager errorManager, CryptoWallet moduleManager, WalletResourcesProviderManager resourceProviderManager) {
