 ...
 *
 */
public class CryptoWalletBasicWalletAvailableBalance implements CryptoWalletBalance {
     ...
     * Constructor.
     */
    public CryptoWalletBasicWalletAvailableBalance(final Database database, final Broadcaster broadcaster){
