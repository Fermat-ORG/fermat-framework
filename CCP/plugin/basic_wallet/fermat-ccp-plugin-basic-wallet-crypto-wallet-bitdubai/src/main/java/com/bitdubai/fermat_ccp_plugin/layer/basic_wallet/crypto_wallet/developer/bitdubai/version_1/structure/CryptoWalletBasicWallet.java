 ...
 */
public class CryptoWalletBasicWallet implements CryptoWalletWallet {
    ...
    public CryptoWalletBasicWallet(final ErrorManager errorManager,
     ...
     */
    public void initialize(UUID walletId) throws CantInitializeCryptoWalletBasicException {
        if (walletId == null)
            throw new CantInitializeCryptoWalletBasicException("InternalId is null", null, "Parameter walletId is null", "loadWallet didn't find the asociated id");
    ...
    @Override
    public List<CryptoWalletTransaction> listTransactions(BalanceType balanceType,
    ...
    @Override
    public CryptoWalletBalance getBalance(final BalanceType balanceType) {

        switch (balanceType) {
            case AVAILABLE:
                return new CryptoWalletBasicWalletAvailableBalance(database,this.broadcaster);
            case BOOK:
                return new CryptoWalletBasicWalletBookBalance(database,this.broadcaster);
            default:
                return new CryptoWalletBasicWalletAvailableBalance(database,this.broadcaster);
        }
    }
    ...
    @Override
    public CryptoWalletTransactionSummary getActorTransactionSummary(final String actorPublicKey,
    ...
    private void createWalletDatabase(final UUID internalWalletId) throws CantCreateWalletException {
        try {
            CryptoWalletDatabaseFactory databaseFactory = new CryptoWalletDatabaseFactory();
    ...
    @Override
    public void revertTransaction(CryptoWalletTransactionRecord transactionRecord, boolean credit) throws CantRevertTransactionException {
        try {
    ...
    @Override
    public CryptoWalletTransaction getTransactionById(UUID transactionID) throws com.bitdubai.fermat_ccp_api.layer.basic_wallet.common.exceptions.CantFindTransactionException{
        try {
            CryptoWalletBasicWalletDao bitcoinWalletBasicWalletDao = new CryptoWalletBasicWalletDao(database);
