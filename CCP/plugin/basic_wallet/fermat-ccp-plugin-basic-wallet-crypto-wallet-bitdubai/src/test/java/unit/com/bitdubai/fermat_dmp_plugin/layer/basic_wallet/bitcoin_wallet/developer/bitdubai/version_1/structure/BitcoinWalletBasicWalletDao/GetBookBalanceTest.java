...
public class GetBookBalanceTest {
    ...
    private com.bitdubai.fermat_ccp_plugin.layer.basic_wallet.bitcoin_wallet.developer.bitdubai.version_1.structure.CryptoWalletBasicWalletDao testWalletDao;

    @Before
    public void setUpWalletDao(){
        testWalletDao = new com.bitdubai.fermat_ccp_plugin.layer.basic_wallet.bitcoin_wallet.developer.bitdubai.version_1.structure.CryptoWalletBasicWalletDao(mockDatabase);
    }
