 ...
 * @since Java JDK 1.7
 */
public class CantCreateOrRegisterLossProtectedActorException extends LossProtectedWalletException {

    public static final String DEFAULT_MESSAGE = "CAN'T CREATE OR REGISTER ACTOR EXCEPTION";

    public CantCreateOrRegisterLossProtectedActorException(final String message, final Exception cause, final String context, final String possibleReason) {
