...
import com.bitdubai.fermat_ccp_api.layer.identity.intra_user.exceptions.CantShowProfileImageException;
...
public class Getters_Identity_Test{
    ...
    public void setUpVariable1(){
        ...
        identity_1 = new IntraUserIdentityIdentity(alias_1, publicKey_1, privateKey_1, profileImage_1, mockPluginFileSystem, pluginId);
