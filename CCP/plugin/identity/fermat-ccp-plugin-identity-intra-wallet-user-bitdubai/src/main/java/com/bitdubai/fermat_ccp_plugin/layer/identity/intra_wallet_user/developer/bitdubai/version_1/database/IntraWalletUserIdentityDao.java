package com.bitdubai.fermat_ccp_plugin.layer.identity.intra_wallet_user.developer.bitdubai.version_1.database;
...
import com.bitdubai.fermat_ccp_plugin.layer.identity.intra_wallet_user.developer.bitdubai.version_1.exceptions.CantPersistPrivateKeyException;
import com.bitdubai.fermat_ccp_plugin.layer.identity.intra_wallet_user.developer.bitdubai.version_1.exceptions.CantPersistProfileImageException;
...
public class IntraWalletUserIdentityDao implements DealsWithPluginDatabaseSystem {
    ...
    public List<IntraWalletUser> getAllIntraUserFromCurrentDeviceUser (DeviceUser deviceUser) throws CantListIntraWalletUserIdentitiesException {


        // Setup method.
        List<IntraWalletUser> list = new ArrayList<IntraWalletUser>(); // Intra User list.
