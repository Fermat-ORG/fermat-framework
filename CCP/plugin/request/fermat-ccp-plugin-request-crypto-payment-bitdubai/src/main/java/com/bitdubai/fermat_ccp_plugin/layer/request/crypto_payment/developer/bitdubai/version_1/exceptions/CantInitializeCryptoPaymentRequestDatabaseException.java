 ...
 */
public class CantInitializeCryptoPaymentRequestDatabaseException extends FermatException {

    private static final String DEFAULT_MESSAGE = "CAN'T INITIALIZE CRYPTO PAYMENT REQUEST DATABASE EXCEPTION";

    public CantInitializeCryptoPaymentRequestDatabaseException(String message, Exception cause, String context, String possibleReason) {
        super(message, cause, context, possibleReason);
    }

    public CantInitializeCryptoPaymentRequestDatabaseException(Exception cause, String context, String possibleReason) {
        this(DEFAULT_MESSAGE, cause, context, possibleReason);
    }

    public CantInitializeCryptoPaymentRequestDatabaseException(Exception cause) {
