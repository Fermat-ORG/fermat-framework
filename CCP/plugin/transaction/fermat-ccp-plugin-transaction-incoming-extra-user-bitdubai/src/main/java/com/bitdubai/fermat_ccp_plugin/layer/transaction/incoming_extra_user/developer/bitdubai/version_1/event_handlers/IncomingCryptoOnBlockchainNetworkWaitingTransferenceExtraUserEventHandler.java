...
import com.bitdubai.fermat_pip_api.layer.platform_service.event_manager.events.IncomingCryptoOnBlockchainWaitingTransferenceExtraUserEvent;
...
public class IncomingCryptoOnBlockchainNetworkWaitingTransferenceExtraUserEventHandler implements FermatEventHandler {
    ...
    public void handleEvent(FermatEvent fermatEvent) throws FermatException {
        ...
        if(fermatEvent instanceof IncomingCryptoOnBlockchainWaitingTransferenceExtraUserEvent)
            ...
            throw  new com.bitdubai.fermat_ccp_plugin.layer.transaction.incoming_extra_user.developer.bitdubai.version_1.exceptions.CantSaveEventException(com.bitdubai.fermat_ccp_plugin.layer.transaction.incoming_extra_user.developer.bitdubai.version_1.exceptions.CantSaveEventException.DEFAULT_MESSAGE, null, "Event: " + fermatEvent.getEventType().toString(), "This should have been IncomingCryptoOnBlockchainWaitingTransferenceExtraUserEvent");
    }
}