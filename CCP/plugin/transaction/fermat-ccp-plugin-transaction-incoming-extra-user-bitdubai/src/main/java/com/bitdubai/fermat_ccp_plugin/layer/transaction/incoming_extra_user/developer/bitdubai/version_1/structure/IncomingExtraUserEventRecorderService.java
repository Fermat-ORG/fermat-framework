...
public class IncomingExtraUserEventRecorderService implements DealsWithEvents, DealsWithRegistry, TransactionService {
    ...
    public void saveEvent(FermatEvent event) throws com.bitdubai.fermat_ccp_plugin.layer.transaction.incoming_extra_user.developer.bitdubai.version_1.exceptions.CantSaveEventException {
    ...
    public void start() throws CantStartServiceException {
        ...
        try{
            ...
            onBlockchainFermatEventListener.setEventHandler(new com.bitdubai.fermat_ccp_plugin.layer.transaction.incoming_extra_user.developer.bitdubai.version_1.event_handlers.IncomingCryptoOnBlockchainNetworkWaitingTransferenceExtraUserEventHandler(this));
            onCryptoNetworkFermatEventListener.setEventHandler(new com.bitdubai.fermat_ccp_plugin.layer.transaction.incoming_extra_user.developer.bitdubai.version_1.event_handlers.IncomingCryptoOnCryptoNetworkWaitingTransferenceExtraUserEventHandler(this));
            reversedOnBlockchainFermatEventListener.setEventHandler(new com.bitdubai.fermat_ccp_plugin.layer.transaction.incoming_extra_user.developer.bitdubai.version_1.event_handlers.IncomingCryptoReversedOnBlockchainWaitingTransferenceExtraUserEventHandler(this));
            reversedOnCryptoNetworkFermatEventListener.setEventHandler(new com.bitdubai.fermat_ccp_plugin.layer.transaction.incoming_extra_user.developer.bitdubai.version_1.event_handlers.IncomingCryptoReversedOnCryptoNetworkWaitingTransferenceExtraUserEventHandler(this));
