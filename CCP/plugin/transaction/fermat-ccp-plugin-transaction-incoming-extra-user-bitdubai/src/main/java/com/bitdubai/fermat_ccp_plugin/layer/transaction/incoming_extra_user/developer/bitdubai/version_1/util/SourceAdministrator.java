        ...
        try {
            ...
            switch (eventSource) {
                ...
                default:
                    ...
                    throw new com.bitdubai.fermat_ccp_plugin.layer.transaction.incoming_extra_user.developer.bitdubai.version_1.exceptions.SourceNotRecognizedException(exceptionMessage, null, context, possibleCause);
            }
        } catch (com.bitdubai.fermat_ccp_plugin.layer.transaction.incoming_extra_user.developer.bitdubai.version_1.exceptions.SourceNotRecognizedException e) {
            throw e;
        } catch (Exception e) {
