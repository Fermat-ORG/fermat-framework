...
import com.bitdubai.fermat_pip_api.layer.platform_service.event_manager.events.IncomingCryptoOnCryptoNetworkWaitingTransferenceExtraUserEvent;

/**
 * Created by eze on 2015.06.19..
 */
public class IncomingCryptoOnCryptoNetworkWaitingTransferenceExtraUserEventHandler implements FermatEventHandler {
    /**
    ...
    public void handleEvent(FermatEvent fermatEvent) throws FermatException {
        ...
        if(fermatEvent instanceof IncomingCryptoOnCryptoNetworkWaitingTransferenceExtraUserEvent)
            ...
            throw  new CantSaveEventException(CantSaveEventException.DEFAULT_MESSAGE, null, "Event: " + fermatEvent.getEventType().toString(), "This should have been IncomingCryptoOnCryptoNetworkWaitingTransferenceExtraUserEvent");
