 ...
 */
public class IncomingCryptoOnBlockchainWaitingTransferenceIntraUserEventHandler implements FermatEventHandler {
    IncomingIntraUserEventRecorderService incomingIntraUserEventRecorderService;

    public IncomingCryptoOnBlockchainWaitingTransferenceIntraUserEventHandler(IncomingIntraUserEventRecorderService incomingIntraUserEventRecorderService){
