...
public class IncomingIntraUserCryptoMonitorAgent {
    ...
    public void start() throws com.bitdubai.fermat_ccp_plugin.layer.transaction.incoming_intra_user.developer.bitdubai.version_1.exceptions.CantStartIntraUserCryptoMonitorAgentException {
    ...
    private static class MonitorAgent implements Runnable {
         ...
         */
        private com.bitdubai.fermat_ccp_plugin.layer.transaction.incoming_intra_user.developer.bitdubai.version_1.util.IncomingIntraUserCryptoSourceAdministrator sourceAdministrator;
        ...
        private void initialize () {
            this.sourceAdministrator = new com.bitdubai.fermat_ccp_plugin.layer.transaction.incoming_intra_user.developer.bitdubai.version_1.util.IncomingIntraUserCryptoSourceAdministrator(this.incomingCryptoManager);
        }
        ...
        private void doTheMainTask() {
            com.bitdubai.fermat_ccp_plugin.layer.transaction.incoming_intra_user.developer.bitdubai.version_1.util.EventWrapper eventWrapper = null;
            try {
        ...
        private boolean thisIsAPendingEvent(com.bitdubai.fermat_ccp_plugin.layer.transaction.incoming_intra_user.developer.bitdubai.version_1.util.EventWrapper eventWrapper){
