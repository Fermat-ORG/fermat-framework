...
import com.bitdubai.fermat_ccp_plugin.layer.transaction.outgoing_extra_user.developer.bitdubai.version_1.exceptions.UnexpectedCryptoStatusException;
...
public class TransactionHandler {
    ...
    public static void handleTransaction(TransactionWrapper   transaction       ,
                                         ...
                                         com.bitdubai.fermat_ccp_plugin.layer.transaction.outgoing_extra_user.developer.bitdubai.version_1.structure.OutgoingExtraUserDao dao               ,
            ...
            switch (cryptoStatus) {
                ...
                case ON_CRYPTO_NETWORK:
                    try {
                        ...
                        cryptoVaultManager.getTransactionManager().confirmReception(transaction.getTransactionId());
