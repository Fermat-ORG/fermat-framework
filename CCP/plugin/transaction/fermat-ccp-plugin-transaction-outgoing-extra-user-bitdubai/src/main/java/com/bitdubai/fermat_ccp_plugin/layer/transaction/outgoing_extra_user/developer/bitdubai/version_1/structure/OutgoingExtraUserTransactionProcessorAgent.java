...
import com.bitdubai.fermat_ccp_api.layer.transaction.outgoing_extra_user.exceptions.InconsistentFundsException;
 ...
 */
public class OutgoingExtraUserTransactionProcessorAgent extends FermatAgent implements com.bitdubai.fermat_ccp_plugin.layer.transaction.outgoing_extra_user.developer.bitdubai.version_1.interfaces.TransactionAgent {
    ...
    private void doTheMainTask() {
         ...
         *       necesarios.
         */
        List<com.bitdubai.fermat_ccp_plugin.layer.transaction.outgoing_extra_user.developer.bitdubai.version_1.util.TransactionWrapper> transactionList;
        ...
        */
        ...
        long funds;
        for(com.bitdubai.fermat_ccp_plugin.layer.transaction.outgoing_extra_user.developer.bitdubai.version_1.util.TransactionWrapper transaction : transactionList) {
        ...
        for(com.bitdubai.fermat_ccp_plugin.layer.transaction.outgoing_extra_user.developer.bitdubai.version_1.util.TransactionWrapper transaction : transactionList){
            ...
            try {
                ...
                com.bitdubai.fermat_ccp_plugin.layer.transaction.outgoing_extra_user.developer.bitdubai.version_1.util.TransactionHandler.handleTransaction(transaction, cryptoVaultManager, cryptoStatus, bitcoinWalletWallet, this.dao, this.errorManager);
