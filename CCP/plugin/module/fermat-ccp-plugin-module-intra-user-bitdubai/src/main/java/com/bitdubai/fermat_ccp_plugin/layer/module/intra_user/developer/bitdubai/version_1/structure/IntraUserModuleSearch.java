            ...
            for (IntraUserInformation intraUser : intraUserList) {
                ...
                for (IntraWalletUserIdentity intraWalletUser : intraWalletUserList) {
                   if(intraWalletUser.getPublicKey().equals(intraUser.getPublicKey()) ){
                       ...
                       intraUserInformationList.add(new IntraUserModuleInformation(intraWalletUser.getAlias(),intraWalletUser.getPhrase(), intraWalletUser.getPublicKey(), intraWalletUser.getImage(), connectionState,intraUser.getState()));
