 ...
 */
public class MissingUnHoldCryptoDataException extends FermatException {
    ...
    public MissingUnHoldCryptoDataException(String message, Exception cause, String context, String possibleReason) {
