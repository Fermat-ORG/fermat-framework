...
public class ConstructionTest {
    ...
    public void Construction_ValidParameters_NewObjectCreated(){
        ...
        UnHoldCryptoMoneyTransactionManager unHoldCryptoMoneyTransactionManager  = new UnHoldCryptoMoneyTransactionManager(
                this.pluginDatabaseSystem,
                this.pluginId
        );
        assertThat(unHoldCryptoMoneyTransactionManager).isNotNull();
    }
}
