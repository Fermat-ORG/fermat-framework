...
public class SetPublicKeyPluginTest {

    @Test
    public void setPublicKeyPlugin(){
        ...
        doCallRealMethod().when(unHoldCryptoMoneyTransaction).setPublicKeyPlugin(Mockito.any(String.class));
    }
