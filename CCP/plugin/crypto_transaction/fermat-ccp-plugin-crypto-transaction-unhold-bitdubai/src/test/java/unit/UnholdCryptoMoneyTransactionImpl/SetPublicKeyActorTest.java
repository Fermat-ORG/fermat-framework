...
public class SetPublicKeyActorTest {

    @Test
    public void setPublicKeyActor(){
        ...
        doCallRealMethod().when(unHoldCryptoMoneyTransaction).setPublicKeyActor(Mockito.any(String.class));
    }
