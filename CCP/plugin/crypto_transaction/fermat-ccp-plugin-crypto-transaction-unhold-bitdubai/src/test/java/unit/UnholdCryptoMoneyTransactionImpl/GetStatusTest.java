...
public class GetStatusTest {
    ...
    public void getStatus(){
        ...
        when(unHoldCryptoMoneyTransaction.getStatus()).thenReturn(CryptoTransactionStatus.ACKNOWLEDGED);
        assertThat(unHoldCryptoMoneyTransaction.getStatus()).isNotNull();
    }
