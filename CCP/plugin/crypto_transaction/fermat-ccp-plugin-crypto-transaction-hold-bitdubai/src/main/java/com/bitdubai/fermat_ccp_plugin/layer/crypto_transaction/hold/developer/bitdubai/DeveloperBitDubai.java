package com.bitdubai.fermat_ccp_plugin.layer.crypto_transaction.hold.developer.bitdubai;
...
public class DeveloperBitDubai extends AbstractPluginDeveloper implements PluginLicensor {
    ...
    public void start() throws CantStartPluginDeveloperException {
        try {
            registerVersion(new HoldCryptoMoneyTransactionPluginRoot());
        }
        catch (CantRegisterVersionException e) {
            throw new CantStartPluginDeveloperException(e,
                    "Plugin Developer BitDubai",
                    "Can't register Plugins version Hold Crypto Money Transaction");
        }
    }
