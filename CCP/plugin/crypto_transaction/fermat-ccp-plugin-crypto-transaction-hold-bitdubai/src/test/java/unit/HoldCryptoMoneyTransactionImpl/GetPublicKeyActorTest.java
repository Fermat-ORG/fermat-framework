...
public class GetPublicKeyActorTest {

    @Test
    public void getPublicKeyActor(){
        HoldCryptoMoneyTransactionImpl holdCryptoMoneyTransaction = mock(HoldCryptoMoneyTransactionImpl.class);
        when(holdCryptoMoneyTransaction.getPublicKeyActor()).thenReturn(new String());
        assertThat(holdCryptoMoneyTransaction.getPublicKeyActor()).isNotNull();
    }
