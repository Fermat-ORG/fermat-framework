...
import com.bitdubai.fermat_ccp_plugin.layer.crypto_transaction.incoming_intra_user.developer.bitdubai.version_1.database.IncomingIntraUserDao;
...
import com.bitdubai.fermat_ccp_plugin.layer.crypto_transaction.incoming_intra_user.developer.bitdubai.version_1.exceptions.IncomingIntraUserCantAcknowledgeTransactionException;
import com.bitdubai.fermat_ccp_plugin.layer.crypto_transaction.incoming_intra_user.developer.bitdubai.version_1.exceptions.IncomingIntraUserCantReadEventException;
...
public class IncomingIntraUserRegistry {
    ...
    public void disableEvent(UUID eventId) throws com.bitdubai.fermat_ccp_plugin.layer.crypto_transaction.incoming_intra_user.developer.bitdubai.version_1.exceptions.IncomingIntraUserCantDisableEventException {
        try {
            this.incomingIntraUserDao.disableEvent(eventId);
        } catch (CantUpdateRecordException | CantLoadTableToMemoryException e) {
            throw new com.bitdubai.fermat_ccp_plugin.layer.crypto_transaction.incoming_intra_user.developer.bitdubai.version_1.exceptions.IncomingIntraUserCantDisableEventException("A database exception occurred",e,"","");
        } catch (Exception e) {
            throw new com.bitdubai.fermat_ccp_plugin.layer.crypto_transaction.incoming_intra_user.developer.bitdubai.version_1.exceptions.IncomingIntraUserCantDisableEventException("An unexpected exception occurred",FermatException.wrapException(e),"","");
        }
    }
    ...
    // Pasa una a (R,TBA)
    public void acquireResponsibility(Transaction<CryptoTransaction> transaction) throws com.bitdubai.fermat_ccp_plugin.layer.crypto_transaction.incoming_intra_user.developer.bitdubai.version_1.exceptions.IncomingIntraUserCantAcquireResponsibilityException {
        try {
            this.incomingIntraUserDao.updateTransactionToResponsibleToBeApplied(transaction);
        } catch (CantUpdateRecordException | CantLoadTableToMemoryException | com.bitdubai.fermat_ccp_plugin.layer.crypto_transaction.incoming_intra_user.developer.bitdubai.version_1.exceptions.IncomingIntraUserExpectedTransactionNotFoundException e) {
            throw new com.bitdubai.fermat_ccp_plugin.layer.crypto_transaction.incoming_intra_user.developer.bitdubai.version_1.exceptions.IncomingIntraUserCantAcquireResponsibilityException("Database errors ocurred",e,"","");
        } catch (Exception e) {
            throw new com.bitdubai.fermat_ccp_plugin.layer.crypto_transaction.incoming_intra_user.developer.bitdubai.version_1.exceptions.IncomingIntraUserCantAcquireResponsibilityException("An unexpected exception ocurred",FermatException.wrapException(e),"","");
        }
    }
    ...
    public void setToApplied(UUID id) throws IncomingIntraUserCantAccessTransactionsException {
        ...
        } catch (CantLoadTableToMemoryException | com.bitdubai.fermat_ccp_plugin.layer.crypto_transaction.incoming_intra_user.developer.bitdubai.version_1.exceptions.IncomingIntraUserExpectedTransactionNotFoundException | CantUpdateRecordException e) {
    ...
    public void acquireFermatCryptoTransactionResponsibility(Transaction<FermatCryptoTransaction> transaction) throws com.bitdubai.fermat_ccp_plugin.layer.crypto_transaction.incoming_intra_user.developer.bitdubai.version_1.exceptions.IncomingIntraUserCantAcquireResponsibilityException { //
        try {
