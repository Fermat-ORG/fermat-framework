...
public class IncomingIntraUserTransactionHandler {
    ...
    public IncomingIntraUserTransactionHandler(EventManager eventManager, BitcoinWalletManager bitcoinWalletManager, CryptoAddressBookManager cryptoAddressBookManager,CryptoPaymentManager cryptoPaymentManager) {
