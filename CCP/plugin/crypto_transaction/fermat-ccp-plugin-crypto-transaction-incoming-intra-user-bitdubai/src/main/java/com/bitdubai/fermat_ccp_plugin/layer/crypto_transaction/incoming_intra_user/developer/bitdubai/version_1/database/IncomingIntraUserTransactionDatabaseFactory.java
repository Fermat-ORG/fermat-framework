...
public class IncomingIntraUserTransactionDatabaseFactory implements DealsWithPluginDatabaseSystem {
    ...
    protected Database createDatabase(UUID ownerId, String databaseName) throws CantCreateDatabaseException {
        ...
        try {
            ...
            table.addColumn(IncomingIntraUserTransactionDatabaseConstants.INCOMING_INTRA_USER_REGISTRY_CRYPTO_CURRENCY_COLUMN_NAME, DatabaseDataType.STRING, 10, Boolean.FALSE);
