 ...
 * @since Java JDK 1.7
 */
public class CryptoAddressesNetworkServiceMessage implements Message, Serializable {
    /**
     ...
     * Constructor
     */
    public CryptoAddressesNetworkServiceMessage() {
        super();
     ...
     */
    public CryptoAddressesNetworkServiceMessage(Timestamp deliveryTimestamp, Long id, UUID receiver, UUID sender, Timestamp shippingTimestamp, MessagesStatus status, String textContent, MessagesTypes messageType) {
        super();
     ...
     */
    @Override
    public CryptoAddressesNetworkServiceMessage fromJson(String json) {

        Gson gson = new Gson();
        return gson.fromJson(json, CryptoAddressesNetworkServiceMessage.class);
