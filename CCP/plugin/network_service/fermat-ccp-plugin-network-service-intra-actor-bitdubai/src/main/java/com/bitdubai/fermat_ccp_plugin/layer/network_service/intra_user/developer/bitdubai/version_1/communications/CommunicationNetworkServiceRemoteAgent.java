...
//        ExecutorService executorService =
    ...
    private void processMessageReceived(){
        ...
        try {
           ...
           // System.out.println("CommunicationNetworkServiceRemoteAgent - "+communicationsVPNConnection.isActive());
            ...
            errorManager.reportUnexpectedPluginException(Plugins.BITDUBAI_TEMPLATE_NETWORK_SERVICE, UnexpectedPluginExceptionSeverity.DISABLES_SOME_FUNCTIONALITY_WITHIN_THIS_PLUGIN, new Exception("Can not sleep to RECEIVE - CCP NS INTRA ACTOR"));
    ...
    public void processMessageToSend(){
        ...
        try {
            ...
            errorManager.reportUnexpectedPluginException(Plugins.BITDUBAI_TEMPLATE_NETWORK_SERVICE, UnexpectedPluginExceptionSeverity.DISABLES_SOME_FUNCTIONALITY_WITHIN_THIS_PLUGIN, new Exception("Can not sleep to SEND - CCP NS INTRA ACTOR"));
        }
