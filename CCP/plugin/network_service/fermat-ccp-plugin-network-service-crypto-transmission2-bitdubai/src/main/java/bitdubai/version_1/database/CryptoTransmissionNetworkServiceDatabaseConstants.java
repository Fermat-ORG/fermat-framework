...
public class CryptoTransmissionNetworkServiceDatabaseConstants {
    ...
    public static final String CRYPTO_TRANSMISSION_METADATA_SENT_COUNT_COLUMN_NAME = "sentCount";
    public static final String CRYPTO_TRANSMISSION_METADATA_MESSAGE_TYPE_COLUMN_NAME = "transmission_message_type";
