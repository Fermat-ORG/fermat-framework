...
public interface IntraUserModuleManager extends ModuleManager<IntraUserWalletSettings, ActiveActorIdentityInformation>,ModuleSettingsImpl<IntraUserWalletSettings> {
     ...
     */
    void  updateIntraUserIdentity(String identityPublicKey, String identityAlias, String identityPhrase,byte[] profileImage, Long accuracy, GeoFrequency frecuency) throws CantUpdateIdentityException;
