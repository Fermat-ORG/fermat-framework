...
public interface CryptoWallet extends Serializable {
     ...
     *
     * @throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantGetAllWalletContactsException if something goes wrong
     */
    List<CryptoWalletWalletContact> listWalletContacts(String walletPublicKey) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantGetAllWalletContactsException;
    ...
    List<CryptoWalletWalletContact> listWalletContactsScrolling(String  walletPublicKey,
                                                                Integer max,
                                                                Integer offset) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantGetAllWalletContactsException;
     ...
     *
     * @throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantGetAllIntraUserConnectionsException if something goes wrong.
     */
    List<CryptoWalletIntraUserActor> listAllIntraUserConnections(String  intraUserSelectedPublicKey,
                                                                 String  walletPublicKey,
                                                                 Integer max,
                                                                 Integer offset) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantGetAllIntraUserConnectionsException;
     ...
     *
     * @throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantCreateWalletContactException if something goes wrong
     */
    CryptoWalletWalletContact createWalletContact(CryptoAddress receivedCryptoAddress,
                                                  ...
                                                  Actors        actorType,
                                                  String        walletPublicKey) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantCreateWalletContactException, com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.ContactNameAlreadyExistsException;
     ...
     *
     * @throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantCreateWalletContactException if something goes wrong
     * @throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.ContactNameAlreadyExistsException if the name of the contact already exists
     */
    CryptoWalletWalletContact createWalletContactWithPhoto(CryptoAddress receivedCryptoAddress,
                                                           ...
                                                           Actors        actorType,
                                                           String        walletPublicKey,
                                                           byte[]        photo) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantCreateWalletContactException, com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.ContactNameAlreadyExistsException;
    ...
    CryptoWalletWalletContact addIntraUserActorLikeContact(String intraUserPublicKey,
                                                           ...
                                                           String actorFirstName,
                                                           String actorLastName,
                                                           String walletPublicKey) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantCreateWalletContactException;
     ...
     * @throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantUpdateWalletContactException
     */
    void updateContactPhoto(String actorPublicKey,
                            Actors actor,
                            byte[] photo) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantUpdateWalletContactException;

    void updateWalletContact(UUID contactId,
                             CryptoAddress receivedCryptoAddress,
                             String actorName) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantUpdateWalletContactException;
     ...
     * @throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantDeleteWalletContactException
     */
    void deleteWalletContact(UUID contactId) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantDeleteWalletContactException;
     ...
     * @throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantFindWalletContactException
     * @throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.WalletContactNotFoundException
     */
    CryptoWalletWalletContact findWalletContactById(UUID contactId) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantFindWalletContactException, com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.WalletContactNotFoundException;
    ...
    CryptoAddress requestAddressToKnownUser(String deliveredByActorPublicKey,
                                            ...
                                            String walletPublicKey,
                                            ReferenceWallet walletType) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantRequestCryptoAddressException;
    // TODO ADD BLOCKCHAIN CRYPTO NETWORK ENUM (TO VALIDATE WITH THE SPECIFIC NETWORK).
    ...
    void send(long cryptoAmount,
              ...
              String deliveredToActorPublicKey,
              Actors deliveredToActorType,
              ReferenceWallet referenceWallet) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantSendCryptoException, com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.InsufficientFundsException;
     ...
     *
     * @throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantGetBalanceException if something goes wrong
     */
    long getBalance(BalanceType balanceType,
                    String      walletPublicKey) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantGetBalanceException;
     ...
     *
     * @throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantListTransactionsException if something goes wrong.
     */
    List<com.bitdubai.fermat_ccp_api.layer.crypto_wallet.interfaces.CryptoWalletTransaction> getTransactions(BalanceType balanceType,
                                                  ...
                                                  String      walletPublicKey,
                                                  int         max,
                                                  int         offset) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantListTransactionsException;
     ...
     *
     * @throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantGetActorTransactionHistoryException if something goes wrong.
     */
    com.bitdubai.fermat_ccp_api.layer.crypto_wallet.interfaces.ActorTransactionSummary getActorTransactionHistory(BalanceType balanceType,
                                                       String      walletPublicKey,
                                                       String      actorPublicKey) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantGetActorTransactionHistoryException;
     ...
     *
     * @throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantSaveTransactionDescriptionException if something goes wrong.
     * @throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.TransactionNotFoundException if we cant find the transaction.
     */
    void setTransactionDescription(String walletPublicKey,
                                   UUID   transactionID,
                                   String description) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantSaveTransactionDescriptionException, com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.TransactionNotFoundException;
     ...
     */
    List<com.bitdubai.fermat_ccp_api.layer.crypto_wallet.interfaces.PaymentRequest> listSentPaymentRequest(String  walletPublicKey,int max,int offset) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantListSentPaymentRequestException;
     ...
     * @return List of PaymentRequest object
     */
    List<com.bitdubai.fermat_ccp_api.layer.crypto_wallet.interfaces.PaymentRequest> listReceivedPaymentRequest(String  walletPublicKey,int max,int offset)throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantListReceivePaymentRequestException;
     ...
     * @return List of PaymentRequest object
     */
    List<com.bitdubai.fermat_ccp_api.layer.crypto_wallet.interfaces.PaymentRequest> listPaymentRequestDateOrder(String  walletPublicKey,int max,int offset) throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantListPaymentRequestDateOrderException;

    /**
     *
     * @return
     * @throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantListCryptoWalletIntraUserIdentityException
     */

    List<CryptoWalletIntraUserIdentity> getAllIntraWalletUsersFromCurrentDeviceUser() throws com.bitdubai.fermat_ccp_api.layer.crypto_wallet.exceptions.CantListCryptoWalletIntraUserIdentityException;
