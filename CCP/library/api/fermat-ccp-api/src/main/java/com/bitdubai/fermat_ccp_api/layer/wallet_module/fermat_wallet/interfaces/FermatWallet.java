...
public interface FermatWallet extends Serializable,ModuleManager<FermatWalletSettings,ActiveActorIdentityInformation>,ModuleSettingsImpl<FermatWalletSettings> {
    ...
    * @param intraUserLoggedInPublicKey public key of the wallet intra user identity.
     ...
     * @throws CantGetAllWalletContactsException if something goes wrong
     */
    List<FermatWalletWalletContact> listWalletContactsScrolling(String walletPublicKey,
     ...
     */
    List<FermatWalletIntraUserActor> listAllIntraUserConnections(String intraUserIdentityPublicKey,
     ...
     */
    FermatWalletWalletContact createWalletContact(CryptoAddress receivedCryptoAddress,
                                                  String actorAlias,
     ...
     */
    FermatWalletWalletContact convertConnectionToContact(String actorAlias,
     ...
     */
    FermatWalletWalletContact createWalletContactWithPhoto(CryptoAddress receivedCryptoAddress,
                                                           String actorAlias,
                                                           String actorFirstName,
                                                           String actorLastName,
                                                           Actors actorType,
     ...
     * @throws CantCreateWalletContactException if something goes wrong.
     */
    FermatWalletWalletContact addIntraUserActorLikeContact(String intraUserPublicKey,
                                                           String alias,
                                                           String actorFirstName,
                                                           String actorLastName,
     ...
     */
    FermatWalletWalletContact findWalletContactById(UUID contactId, String intraUserLoggedInPublicKey) throws CantFindWalletContactException, WalletContactNotFoundException;
     ...
     *
     * @return
     * @throws CantListFermatWalletIntraUserIdentityException
     */

    ArrayList<FermatWalletIntraUserIdentity> getAllIntraWalletUsersFromCurrentDeviceUser() throws CantListFermatWalletIntraUserIdentityException;
