 ...
 * @version 1.0
 */
public interface CryptoWalletWallet {
     ...
     */
    CryptoWalletBalance getBalance(BalanceType balanceType);
     ...
     */
    List<CryptoWalletTransaction> listTransactions(BalanceType balanceType, com.bitdubai.fermat_ccp_api.layer.basic_wallet.common.enums.TransactionType transactionType,
                                                    int         max,
     ...
     * @throws com.bitdubai.fermat_ccp_api.layer.basic_wallet.common.exceptions.CantListTransactionsException if something goes wrong.
     */
    List<CryptoWalletTransaction> listTransactionsByActor(String      actorPublicKey,
     ...
     */
    List<CryptoWalletTransaction> listTransactionsByActorAndType(final String           actorPublicKey,
    ...
    List<CryptoWalletTransaction> listLastActorTransactionsByTransactionType(BalanceType     balanceType,
                                                                              ...
                                                                              int             max,
                                                                              int             offset,
                                                                             final BlockchainNetworkType blockchainNetworkType) throws com.bitdubai.fermat_ccp_api.layer.basic_wallet.common.exceptions.CantListTransactionsException;
     ...
     */
    CryptoWalletTransactionSummary getActorTransactionSummary(String      actorPublicKey,
     ...
     */
    CryptoWalletTransaction getTransactionById(UUID   transactionID) throws com.bitdubai.fermat_ccp_api.layer.basic_wallet.common.exceptions.CantFindTransactionException;
     ...
     */
    void revertTransaction(CryptoWalletTransactionRecord transactionRecord, boolean credit) throws CantRevertTransactionException;
}
