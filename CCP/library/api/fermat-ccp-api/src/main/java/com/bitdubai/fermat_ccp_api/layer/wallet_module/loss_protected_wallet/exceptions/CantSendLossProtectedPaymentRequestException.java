 ...
 */
public class CantSendLossProtectedPaymentRequestException extends FermatException {

    private static final String DEFAULT_MESSAGE = "CAN'T SEND CRYPTO PAYMENT REQUEST EXCEPTION";

    public CantSendLossProtectedPaymentRequestException(String message, Exception cause, String context, String possibleReason) {
        super(message, cause, context, possibleReason);
    }

    public CantSendLossProtectedPaymentRequestException(Exception cause, String context, String possibleReason) {
