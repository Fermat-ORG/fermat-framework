...
public interface IntraWalletUserIdentityManager  extends ModuleManager<FermatSettings, ActiveActorIdentityInformation> {
    ...
    IntraWalletUserIdentity createNewIntraWalletUser(String alias, String phrase, byte[] profileImage, Long accuracy, GeoFrequency frecuency) throws CantCreateNewIntraWalletUserException;
    ...
    IntraWalletUserIdentity createNewIntraWalletUser(String alias, byte[] profileImage, Long accuracy, GeoFrequency frecuency) throws CantCreateNewIntraWalletUserException;
     ...
     */
    void  updateIntraUserIdentity(String identityPublicKey, String identityAlias, String phrase,byte[] profileImage, Long accuracy, GeoFrequency frecuency) throws CantUpdateIdentityException;
