		...
		public AIDLObject createFromParcel(Parcel in) {
			...
			try {
				...
				for (Constructor constructor : clazz.getConstructors()) {
					Log.i(TAG, Arrays.toString(constructor.getGenericParameterTypes()));
				}
				Constructor<?> implementerConstructor = AndroidMagicConstructorMaker.make(clazz);
				...
				e.printStackTrace();
				Log.e("AIDLObject.CREATOR", e.getCause().getMessage());
			}
