...
public class SubAppManagerProvisory implements SubAppManager {
    ...
    private void loadMap(Map<String, InstalledSubApp> lstInstalledSubApps) {
        ...
        lstInstalledSubApps.put(installedSubApp.getAppPublicKey(), installedSubApp);
        installedSubApp = new com.bitdubai.sub_app.wallet_manager.structure.provisory_classes.InstalledSubApp(SubApps.CHT_COMMUNITY, null, null, "sub_app_chat_community", "Chat Community", SubAppsPublicKeys.CHT_COMMUNITY.getCode(), "sub_app_chat_community", new Version(1, 0, 0),Platforms.CHAT_PLATFORM);
        lstInstalledSubApps.put(installedSubApp.getAppPublicKey(), installedSubApp);
        //TODO - TKY Platform
        ...
        lstInstalledSubApps.put(installedSubApp.getAppPublicKey(), installedSubApp);
        //TODO - ART Platform
        installedSubApp = new com.bitdubai.sub_app.wallet_manager.structure.provisory_classes.InstalledSubApp(SubApps.ART_FAN_COMMUNITY, null, null, "sub_app_art_fan_community", "Tonkenly", SubAppsPublicKeys.ART_FAN_COMMUNITY.getCode(), "sub_app_art_fan_community", new Version(1, 0, 0),Platforms.ART_PLATFORM);
        lstInstalledSubApps.put(installedSubApp.getAppPublicKey(), installedSubApp);
