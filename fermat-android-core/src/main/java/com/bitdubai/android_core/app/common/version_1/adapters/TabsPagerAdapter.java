...
import com.bitdubai.sub_app.wallet_store.fragment.InstalledFragment;
import com.bitdubai.sub_app.wallet_store.fragment.WalletsFragment;
        ...
        try {
            switch (fragmentType) {
                ...
                case CWP_SUB_APP_DEVELOPER_LOG_TOOLS:
                    ...
                    break;
                //wallet store
                case CWP_SHOP_MANAGER_INSTALLED:
                    //todo: add wallet module manager (wallet store)
                    currentFragment = InstalledFragment.newInstance(position, null);
                    break;
                case CWP_SHOP_MANAGER_WALLETS:
                    //todo: add wallet module manager (wallet store)
                    currentFragment = WalletsFragment.newInstance(position, null);
                    break;
                //**
