        ...
        try{
            ...
            */
            ...
            if(stringBuffer.length() > 0){
                ...
                /*
                 * Create a new CommunicationFermatPacket whit the decrypted string of data
                 */
            ...
            if (destination != null){
                ...
                */
                ...
                if (dataPacketToSend != null){
                    ...
                    System.out.println("CloudFMPConnectionManager - CommunicationFermatPacket json to send = " + dataPacketToSend.toJson());
                    ...
                    System.out.println("CloudFMPConnectionManager - CommunicationFermatPacket data length = " + encryptedJson.length());
