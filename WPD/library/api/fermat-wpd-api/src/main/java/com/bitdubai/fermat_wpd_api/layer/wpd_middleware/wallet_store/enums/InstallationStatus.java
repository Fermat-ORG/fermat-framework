 ...
 */
public enum InstallationStatus implements FermatEnum {
    INSTALLED("INSED"),
    NOT_INSTALLED("NOINS"),
    INSTALLING("INSING"),
    UNINSTALLING("UNING"),
    ...
    public static InstallationStatus getByCode(String code) throws InvalidParameterException {
        switch (code) {
            ...
            case "UNING":
                return InstallationStatus.UNINSTALLING;
            case "UNED":
                return InstallationStatus.UNINSTALLED;
            case "NUNED":
                return InstallationStatus.NOT_UNINSTALLED;
            case "INSA":
                return InstallationStatus.INSTALL_AVAILABLE;
            case "UPGA":
                return InstallationStatus.UPGRADE_AVAILABLE;
            case "UPGING":
                return InstallationStatus.UPGRADING;
