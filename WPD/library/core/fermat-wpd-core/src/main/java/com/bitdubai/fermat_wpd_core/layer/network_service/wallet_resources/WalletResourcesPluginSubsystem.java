package com.bitdubai.fermat_wpd_core.layer.network_service.wallet_resources;
 ...
 * @since Java JDK 1.7
 */
public class WalletResourcesPluginSubsystem extends AbstractPluginSubsystem {

    public WalletResourcesPluginSubsystem() {
        super(new PluginReference(Plugins.WALLET_RESOURCES));
    }
