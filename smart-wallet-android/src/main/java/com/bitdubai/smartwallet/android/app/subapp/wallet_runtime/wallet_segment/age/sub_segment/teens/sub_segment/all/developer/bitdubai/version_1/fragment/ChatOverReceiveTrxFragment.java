 ...
 */
public class ChatOverReceiveTrxFragment extends android.app.Fragment {
    ...
    public static ChatOverReceiveTrxFragment newInstance(int position) {
        ChatOverReceiveTrxFragment f = new ChatOverReceiveTrxFragment();
        Bundle b = new Bundle();
