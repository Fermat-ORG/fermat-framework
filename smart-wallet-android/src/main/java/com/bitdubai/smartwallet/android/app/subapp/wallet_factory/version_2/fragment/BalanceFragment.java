...
import com.bitdubai.smartwallet.android.app.subapp.wallet_runtime.wallet_framework.version_1.activity.AccountDetailActivity;
...
public class BalanceFragment extends ListFragment implements LoaderManager.LoaderCallbacks<List<BalanceFragment.Model>> {
    ...
    public class CustomArrayAdapter extends ArrayAdapter<Model> {
        ...
        @Override public View getView(int position, View convertView, ViewGroup parent) {
            ...
            //if (convertView == null) {
            view = mInflater.inflate(R.layout.wallets_factory_fragment_balance_list_item, parent, false);
            //} else {
            //    view = convertView;
            //}
