...
import com.bitdubai.smartwallet.android.app.subapp.wallet_runtime.wallet_framework.version_1.activity.ShopActivity;
...
public class ShopFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        gridView.setAdapter(new AppListAdapter(getActivity(), R.layout.wallets_factory_fragment_shop_item, mlist));
    ...
    public class AppListAdapter extends ArrayAdapter<App> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = inflater.inflate(R.layout.wallets_factory_fragment_shop_item, parent, false);
