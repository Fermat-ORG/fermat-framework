...
import com.bitdubai.smartwallet.android.app.subapp.wallet_runtime.wallet_framework.version_1.activity.ReceiveFromNewContactActivity;
...
public  class ReceiveFragment extends Fragment {
    ...
    public class ExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
            ...
            // if (convertView == null) {
            if (1 == 1) {
                convertView = inf.inflate(R.layout.wallets_factory_fragment_receive_list_detail, parent, false);
        ...
        public View getGroupView(final int groupPosition, final boolean isExpanded, View convertView, final ViewGroup parent) {
            ...
            else
            {
                ...
                // if (convertView == null) {
                if (1 == 1) {
                    convertView = inf.inflate(R.layout.wallets_factory_fragment_receive_list_header, parent, false);
