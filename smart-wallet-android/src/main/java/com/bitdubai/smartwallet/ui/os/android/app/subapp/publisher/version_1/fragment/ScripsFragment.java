...
public  class ScripsFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        description = new String[]{"llenar esto","llenar esto","We are giving away som money for yo to spend with us.","20M user anniversary."};

        name = new String[]{"Another voucher.","Redeem it.","This is a DEAL.","Our first voucher!!"};
    ...
    public class ExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(final int groupPosition, final boolean isExpanded, View convertView, final ViewGroup parent) {
            ...
            {
                case 0:
                    image.setImageResource(R.drawable.voucher_icon_big);
                    break;
                case 1:
                    image.setImageResource(R.drawable.voucher_icon_big);
                    break;
