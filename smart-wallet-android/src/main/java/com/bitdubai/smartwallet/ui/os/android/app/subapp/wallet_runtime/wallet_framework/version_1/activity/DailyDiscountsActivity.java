...
import com.bitdubai.smartwallet.ui.os.android.app.subapp.wallet_runtime.wallet_segment.age.sub_segment.teens.sub_segment.all.developer.bitdubai.version_1.fragment.DailyDiscountsFragment;
...
public class DailyDiscountsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((MyApplication) this.getApplication()).setActionBarProperties(this,getWindow(),tabs, getActionBar(), getResources(),abTitle, "Daily Discounts");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.wallet_framework_activity_daily_discounts_menu, menu);
        return true;
    }
