package com.bitdubai.fermat_core.layer.dap_transaction.user_redemption;
 ...
 */
public class UserRedemptionSubsystem implements DAPTransactionSubsystem {
    ...
    public void start() throws CantStartSubsystemException {
        ...
        {
            throw new CantStartSubsystemException(FermatException.wrapException(exception),"UserRedemptionSubsystem","Unexpected Exception");
        }
    }
