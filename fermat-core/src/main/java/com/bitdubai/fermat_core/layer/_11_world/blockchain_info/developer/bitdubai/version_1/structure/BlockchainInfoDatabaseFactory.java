...
public class BlockchainInfoDatabaseFactory implements DealsWithPluginDatabaseSystem {
    ...
    Database createDatabase(UUID ownerId, UUID walletId) throws CantCreateDatabaseException {
        ...
        try {
            ...
            table.addColumn(BlockchainInfoDatabaseConstants.INCOMING_CRYPTO_TABLE_CURRENT_CONFIRMATIONS_COLUMN_NAME, DatabaseDataType.INTEGER, 0);
            table.addColumn(BlockchainInfoDatabaseConstants.INCOMING_CRYPTO_TABLE_PREVIOUS_CONFIRMATIONS_COLUMN_NAME, DatabaseDataType.INTEGER, 0);
            ...
            table.addColumn(BlockchainInfoDatabaseConstants.OUTGOING_CRYPTO_TABLE_ID_COLUMN_NAME, DatabaseDataType.STRING, 36);
            table.addColumn(BlockchainInfoDatabaseConstants.OUTGOING_CRYPTO_TABLE_TRX_COLUMN_NAME, DatabaseDataType.STRING, 100);
            table.addColumn(BlockchainInfoDatabaseConstants.OUTGOING_CRYPTO_TABLE_WALLET_COLUMN_NAME, DatabaseDataType.STRING, 100);
            ...
            table.addColumn(BlockchainInfoDatabaseConstants.CRYPTO_ADDRESSES_TABLE_ID_COLUMN_NAME, DatabaseDataType.STRING, 36);
            table.addColumn(BlockchainInfoDatabaseConstants.CRYPTO_ADDRESSES_TABLE_WALLET_COLUMN_NAME, DatabaseDataType.STRING, 100);
            table.addColumn(BlockchainInfoDatabaseConstants.CRYPTO_ADDRESSES_TABLE_ADDRESS_COLUMN_NAME, DatabaseDataType.STRING, 100);
