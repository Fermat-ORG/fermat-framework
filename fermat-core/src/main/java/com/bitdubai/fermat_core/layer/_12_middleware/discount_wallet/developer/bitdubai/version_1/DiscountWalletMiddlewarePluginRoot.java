...
import com.bitdubai.fermat_api.layer._12_middleware.discount_wallet.interfaces.DiscountWallet;
import com.bitdubai.fermat_api.layer._12_middleware.discount_wallet.exceptions.CantCreateWalletException;
import com.bitdubai.fermat_core.layer._12_middleware.discount_wallet.developer.bitdubai.version_1.exceptions.CantInitializeWalletException;
import com.bitdubai.fermat_api.layer._12_middleware.discount_wallet.exceptions.CantLoadWalletException;
...
import com.bitdubai.fermat_core.layer._12_middleware.discount_wallet.developer.bitdubai.version_1.structure.MiddlewareDiscountWallet;
...
public class DiscountWalletMiddlewarePluginRoot implements Service, DiscountWalletManager, Middleware, DealsWithCryptoIndex, DealsWithEvents, DealsWithErrors, DealsWithPluginFileSystem, DealsWithPluginDatabaseSystem, Plugin {
    ...
    public void createWallet(UUID walletId) throws CantCreateWalletException {
         ...
         */
        MiddlewareDiscountWallet newWallet = new MiddlewareDiscountWallet(this.pluginId);
    ...
    public void loadWallet(UUID walletId) throws CantLoadWalletException{
         ...
         * Finally I fire the event announcing the new wallet was created.
         */
        this.currentDiscountWallet = new MiddlewareDiscountWallet(walletId);
