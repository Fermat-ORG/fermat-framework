 ...
 */
public class IncomingCryptoIdentifiedFromIntraUserEventListener implements EventListener {

    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public IncomingCryptoIdentifiedFromIntraUserEventListener(EventType eventType, EventMonitor eventMonitor){
