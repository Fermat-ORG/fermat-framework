 ...
 */
public class IncomingMoneyRequestReceivedEventListener implements EventListener {

    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public IncomingMoneyRequestReceivedEventListener(EventType eventType, EventMonitor eventMonitor){
