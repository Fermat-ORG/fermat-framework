 ...
 */
public class NavigationStructureUpdatedEventListener implements EventListener {

    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public NavigationStructureUpdatedEventListener(EventType eventType, EventMonitor eventMonitor){
