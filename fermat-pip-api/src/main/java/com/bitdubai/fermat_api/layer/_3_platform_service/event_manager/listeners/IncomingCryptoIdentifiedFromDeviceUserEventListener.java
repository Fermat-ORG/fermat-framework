 ...
 */
public class IncomingCryptoIdentifiedFromDeviceUserEventListener implements EventListener {

    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public IncomingCryptoIdentifiedFromDeviceUserEventListener(EventType eventType, EventMonitor eventMonitor){
