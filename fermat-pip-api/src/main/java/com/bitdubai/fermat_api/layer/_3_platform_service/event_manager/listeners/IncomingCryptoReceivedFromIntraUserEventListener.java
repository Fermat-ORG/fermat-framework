 ...
 */
public class IncomingCryptoReceivedFromIntraUserEventListener implements EventListener {

    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public IncomingCryptoReceivedFromIntraUserEventListener(EventType eventType, EventMonitor eventMonitor){
