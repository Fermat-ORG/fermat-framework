 ...
 */
public class OutgoingMoneyRequestApprovedEventListener implements EventListener {

    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public OutgoingMoneyRequestApprovedEventListener(EventType eventType, EventMonitor eventMonitor){
