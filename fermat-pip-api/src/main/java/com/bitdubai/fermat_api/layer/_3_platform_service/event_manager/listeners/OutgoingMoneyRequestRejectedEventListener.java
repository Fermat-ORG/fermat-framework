 ...
 */
public class OutgoingMoneyRequestRejectedEventListener implements EventListener {

    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public OutgoingMoneyRequestRejectedEventListener(EventType eventType, EventMonitor eventMonitor){
