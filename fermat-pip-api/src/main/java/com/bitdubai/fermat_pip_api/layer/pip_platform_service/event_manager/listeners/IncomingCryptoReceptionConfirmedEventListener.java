 ...
 */
public class IncomingCryptoReceptionConfirmedEventListener implements FermatEventListener {

    FermatEventMonitor fermatEventMonitor;
    private EventType eventType;
    private FermatEventHandler fermatEventHandler;

    public IncomingCryptoReceptionConfirmedEventListener(EventType eventType, FermatEventMonitor fermatEventMonitor){
