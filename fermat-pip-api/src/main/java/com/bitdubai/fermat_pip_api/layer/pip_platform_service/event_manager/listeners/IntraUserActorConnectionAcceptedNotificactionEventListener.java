 ...
 */
public class IntraUserActorConnectionAcceptedNotificactionEventListener implements EventListener {
    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public IntraUserActorConnectionAcceptedNotificactionEventListener(EventType eventType, EventMonitor eventMonitor){
