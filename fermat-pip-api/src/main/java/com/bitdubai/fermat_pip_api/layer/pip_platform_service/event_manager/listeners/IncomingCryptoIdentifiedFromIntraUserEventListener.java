 ...
 */
public class IncomingCryptoIdentifiedFromIntraUserEventListener implements FermatEventListener {

    FermatEventMonitor fermatEventMonitor;
    private EventType eventType;
    private FermatEventHandler fermatEventHandler;

    public IncomingCryptoIdentifiedFromIntraUserEventListener(EventType eventType, FermatEventMonitor fermatEventMonitor){
