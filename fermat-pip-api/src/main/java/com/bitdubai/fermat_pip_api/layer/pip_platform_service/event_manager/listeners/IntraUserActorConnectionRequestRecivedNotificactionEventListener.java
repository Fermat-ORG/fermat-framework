 ...
 */
public class IntraUserActorConnectionRequestRecivedNotificactionEventListener implements EventListener {
    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public IntraUserActorConnectionRequestRecivedNotificactionEventListener(EventType eventType, EventMonitor eventMonitor){
