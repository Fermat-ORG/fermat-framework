 ...
 */
public class IncomingCryptoTransactionsWaitingTransferenceExtraUserEventListener implements EventListener {

    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public IncomingCryptoTransactionsWaitingTransferenceExtraUserEventListener(EventType eventType, EventMonitor eventMonitor){
