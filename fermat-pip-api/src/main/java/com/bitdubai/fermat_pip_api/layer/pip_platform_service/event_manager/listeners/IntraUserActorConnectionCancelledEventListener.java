 ...
 */
public class IntraUserActorConnectionCancelledEventListener implements EventListener {
    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public IntraUserActorConnectionCancelledEventListener(EventType eventType, EventMonitor eventMonitor){
