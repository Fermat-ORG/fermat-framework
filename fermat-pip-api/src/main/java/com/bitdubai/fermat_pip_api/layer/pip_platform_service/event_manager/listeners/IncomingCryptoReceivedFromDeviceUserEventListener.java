 ...
 */
public class IncomingCryptoReceivedFromDeviceUserEventListener implements FermatEventListener {

    FermatEventMonitor fermatEventMonitor;
    private EventType eventType;
    private FermatEventHandler fermatEventHandler;

    public IncomingCryptoReceivedFromDeviceUserEventListener(EventType eventType, FermatEventMonitor fermatEventMonitor){
