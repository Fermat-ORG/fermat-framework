 ...
 */
public class OutgoingMoneyRequestDeliveredEventListener implements FermatEventListener {

    FermatEventMonitor fermatEventMonitor;
    private EventType eventType;
    private FermatEventHandler fermatEventHandler;

    public OutgoingMoneyRequestDeliveredEventListener(EventType eventType, FermatEventMonitor fermatEventMonitor){
