...
public enum EventType {
    ...
    BEGUN_WALLET_INSTALLATION("BWI") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new BegunWalletInstallationEventListener(this, eventMonitor);
        }
    ...
    DEVICE_USER_CREATED("DUC") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new DeviceUserCreatedEventListener(this, eventMonitor);
        }
    ...
    DEVICE_USER_LOGGED_IN("DLI") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new DeviceUserLoggedInEventListener(this, eventMonitor);
        }
    ...
    DEVICE_USER_LOGGED_OUT("DLO") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new DeviceUserLoggedOutEventListener(this, eventMonitor);
        }
    ...
    /**
     * ADDING BY FRANCISCO BECAUSE WAS MISSING IN THE LATEST COMMITS
     */
    ...
    FINISHED_WALLET_INSTALLATION("FWI") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new FinishedWalletInstallationEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_IDENTIFIED("ICI") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoIdentifiedEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_IDENTIFIED_FROM_DEVICE_USER("ICIDU") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoIdentifiedFromDeviceUserEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_IDENTIFIED_FROM_EXTRA_USER("ICIEU") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoIdentifiedFromExtraUserEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_IDENTIFIED_FROM_INTRA_USER("ICIIU") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoIdentifiedFromIntraUserEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_ON_BLOCKCHAIN("ICOBC") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoOnBlockchainEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_ON_CRYPTO_NETWORK("ICOCN") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoOnCryptoNetworkEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_RECEIVED("ICR") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoReceivedEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_RECEIVED_FROM_DEVICE_USER("ICRDU") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoReceivedFromDeviceUserEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_RECEIVED_FROM_EXTRA_USER("ICREU") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoReceivedFromExtraUserEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_RECEIVED_FROM_INTRA_USER("ICRIU") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoReceivedFromIntraUserEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_RECEPTION_CONFIRMED("IIRC") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoReceptionConfirmedEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_RECEPTION_CONFIRMED_FROM_DEVICE_USER("ICCDU") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoReceptionConfirmedFromDeviceUserEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_RECEPTION_CONFIRMED_FROM_EXTRA_USER("ICCEU") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoReceptionConfirmedFromExtraUserEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_RECEPTION_CONFIRMED_FROM_INTRA_USER("ICCIU") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoReceptionConfirmedFromIntraUserEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_REVERSED("ICREV") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoReversedEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_REVERSED_FROM_DEVICE_USER("REVDU") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoReversedFromDeviceUserEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_REVERSED_FROM_EXTRA_USER("REVEU") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoReversedFromExtraUserEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_REVERSED_FROM_INTRA_USER("REVIU") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoReversedFromIntraUserEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_REVERSED_ON_BLOCKCHAIN("ICROBC") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoReversedOnBlockchainEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_REVERSED_ON_CRYPTO_NETWORK("ICROCN") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoReversedOnCryptoNetworkEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_TRANSACTIONS_WAITING_TRANSFERENCE("TWT") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoTransactionsWaitingTransferenceEventListener(this, eventMonitor);
        }
    ...
    INCOMING_CRYPTO_TRANSACTIONS_WAITING_TRANSFERENCE_EXTRA_USER("TWE") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingCryptoTransactionsWaitingTransferenceExtraUserEventListener(this, eventMonitor);
        }
    ...
    INCOMING_MONEY_REQUEST_APPROVED("IMRA") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingMoneyRequestApprovedEventListener(this, eventMonitor);
        }
    ...
    INCOMING_MONEY_REQUEST_RECEIVED("IMRR") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingMoneyRequestReceivedEventListener(this, eventMonitor);
        }
    ...
    INCOMING_MONEY_REQUEST_REJECTED("IMRRJ") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IncomingMoneyRequestRejectedEventListener(this, eventMonitor);
        }
    ...
    INTRA_USER_CONNECTION_ACCEPTED("IUCA") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IntraUserActorConnectionAcceptedEventListener(this, eventMonitor);
        }
    ...
    INTRA_USER_CONNECTION_ACCEPTED_NOTIFICATION("IUCAN") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IntraUserActorConnectionAcceptedNotificactionEventListener(this, eventMonitor);
        }
    ...
    INTRA_USER_CONNECTION_REQUEST_RECEIVED_NOTIFICATION("IUCRRN") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IntraUserActorConnectionRequestRecivedNotificactionEventListener(this, eventMonitor);
        }
    ...
    INTRA_USER_CONNECTION_DENIED("IUCD") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IntraUserDeniedConnectionEventListener(this, eventMonitor);
        }
    ...
    INTRA_USER_CONTACT_CREATED("ICC") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IntraUserContactCreatedEventListener(this, eventMonitor);
        }
    ...
    INTRA_USER_DISCONNECTION_REQUEST_RECEIVED("IUCC") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IntraUserActorConnectionCancelledEventListener(this, eventMonitor);
        }
    ...
    INTRA_USER_LOGGED_IN("ILI") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IntraUserLoggedInEventListener(this, eventMonitor);
        }
    ...
    INTRA_USER_REQUESTED_CONNECTION("IURC") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new IntraUserActorRequestConnectionEventListener(this, eventMonitor);
        }
    ...
    MONEY_RECEIVED("MR1") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new MoneyReceivedEventListener(this, eventMonitor);
        }
    ...
    NAVIGATION_STRUCTURE_UPDATED("NSU") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new NavigationStructureUpdatedEventListener(this, eventMonitor);
        }
    ...
    OUTGOING_MONEY_REQUEST_APPROVED("OMRA") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new OutgoingMoneyRequestApprovedEventListener(this, eventMonitor);
        }
    ...
    OUTGOING_MONEY_REQUEST_DELIVERED("OMRD") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new OutgoingMoneyRequestDeliveredEventListener(this, eventMonitor);
        }
    ...
    OUTGOING_MONEY_REQUEST_REJECTED("OMRRJ") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new OutgoingMoneyRequestRejectedEventListener(this, eventMonitor);
        }
    ...
    WALLET_CLOSED("WC2") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new WalletClosedEventListener(this, eventMonitor);
        }
    ...
    WALLET_CREATED("WC1") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new WalletCreatedEventListener(this, eventMonitor);
        }
    ...
    WALLET_INSTALLED("WI1") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new WalletInstalledEventListener(this, eventMonitor);
        }
    ...
    WALLET_OPENED("WO1") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new WalletOpenedEventListener(this, eventMonitor);
        }
    ...
    WALLET_RESOURCES_INSTALLED("WRI") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new WalletResourcesInstalledEventListener(this, eventMonitor);
        }
    ...
    WALLET_RESOURCES_NAVIGATION_STRUCTURE_DOWNLOADED("WRNSD") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new WalletNavigationStructureDownloadedEventListener(this, eventMonitor);
        }
    ...
    WALLET_UNINSTALLED("WU1") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new WalletUninstalledEventListener(this, eventMonitor);
        }
    ...
    WALLET_WENT_ONLINE("WWO") {
        public EventListener getListener(EventMonitor eventMonitor) {
            return new WalletWentOnlineEventListener(this, eventMonitor);
        }
