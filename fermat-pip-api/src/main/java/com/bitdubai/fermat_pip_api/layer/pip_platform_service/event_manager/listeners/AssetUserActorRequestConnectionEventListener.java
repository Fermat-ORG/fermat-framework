 ...
 */
public class AssetUserActorRequestConnectionEventListener implements FermatEventListener {

    FermatEventMonitor fermatEventMonitor;
    private EventType eventType;
    private FermatEventHandler fermatEventHandler;

    public AssetUserActorRequestConnectionEventListener(EventType eventType, FermatEventMonitor fermatEventMonitor) {
