 ...
 */
public class IntraUserActorConnectionAcceptedEventListener implements EventListener {
    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public IntraUserActorConnectionAcceptedEventListener(EventType eventType, EventMonitor eventMonitor){
