 ...
 */
public class IncomingCryptoIdentifiedFromDeviceUserEventListener implements FermatEventListener {

    FermatEventMonitor fermatEventMonitor;
    private EventType eventType;
    private FermatEventHandler fermatEventHandler;

    public IncomingCryptoIdentifiedFromDeviceUserEventListener(EventType eventType, FermatEventMonitor fermatEventMonitor){
