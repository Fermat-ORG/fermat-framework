 ...
 */
public class IncomingCryptoReceivedFromIntraUserEventListener implements FermatEventListener {

    FermatEventMonitor fermatEventMonitor;
    private EventType eventType;
    private FermatEventHandler fermatEventHandler;

    public IncomingCryptoReceivedFromIntraUserEventListener(EventType eventType, FermatEventMonitor fermatEventMonitor){
