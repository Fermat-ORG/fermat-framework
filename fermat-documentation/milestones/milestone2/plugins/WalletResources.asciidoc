...
resoutces. Así, el botón dirá que tiene referencia a al texto llamado "botón1Text" y el archivo de strings
será quién indique a qué string corresponde la clabe "botón1Text". +
