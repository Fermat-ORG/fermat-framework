[[digital-asset-transaction-asset-appropiation-BitDubai-V1]]
= Version 1
...
Para apropiarse la genesis amount del digital asset, el usuario debera presionar el boton "Appropiate" para poner en marcha el proceso descrito anteriormente. Otra condición
para que se ejecute la transacción, es que el contrato del digital asset esté vencido.

La transacción Asset Appropiation ejecuta los siguientes pasos:
