 ...
 */
package com.bitdubai.fermat_cbp_plugin.layer.network_service.transaction_transmission.developer.bitdubai.version_1.database.communications;

/**
 * The Class <code>CommunicationNetworkServiceDatabaseConstants</code> is
 * throw when error occurred updating new record in a table of the data base
 * <p/>
 * Created by Manuel Perez on 21/11/2015
 * Based on CommunicationNetworkServiceDatabaseConstants by Roberto Requena - (rart3001@gn¡mail.com) on 15/10/2015
 *
 * @version 1.0
 * @since Java JDK 1.7
 */
public class CommunicationNetworkServiceDatabaseConstants {
     ...
     */
    public static final String CONTRACT_HASH_TRANSACTION_TABLE_NAME = "contract_hash_transaction";

    public static final String CONTRACT_HASH_TRANSACTION_TRANSACTION_ID_COLUMN_NAME = "transaction_id";
    public static final String CONTRACT_HASH_TRANSACTION_GENESIS_TRANSACTION_COLUMN_NAME = "negotiation_id";
    public static final String CONTRACT_HASH_TRANSACTION_SENDER_ID_COLUMN_NAME = "sender_id";
    public static final String CONTRACT_HASH_TRANSACTION_SENDER_TYPE_COLUMN_NAME = "sender_type";
    public static final String CONTRACT_HASH_TRANSACTION_RECEIVER_ID_COLUMN_NAME = "receiver_id";
    public static final String CONTRACT_HASH_TRANSACTION_RECEIVER_TYPE_COLUMN_NAME = "receiver_type";
    public static final String CONTRACT_HASH_TRANSACTION_CONTRACT_HASH_COLUMN_NAME = "contract_hash";
    public static final String CONTRACT_HASH_TRANSACTION_TYPE_COLUMN_NAME = "type";
    public static final String CONTRACT_HASH_TRANSACTION_CONTRACT_STATUS_COLUMN_NAME = "contract_status";
    public static final String CONTRACT_HASH_TRANSACTION_TIMESTAMP_COLUMN_NAME = "timestamp";
    public static final String CONTRACT_HASH_TRANSACTION_PROCESSED_COLUMN_NAME = "processed";

    public static final String CONTRACT_HASH_TRANSACTION_FIRST_KEY_COLUMN = "transaction_id";
