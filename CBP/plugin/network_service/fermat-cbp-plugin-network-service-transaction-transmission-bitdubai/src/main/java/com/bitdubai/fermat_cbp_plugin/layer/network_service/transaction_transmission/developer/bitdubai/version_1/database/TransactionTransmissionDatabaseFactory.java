...
public final class TransactionTransmissionDatabaseFactory {
    ...
    public final Database createDatabase(final UUID   ownerId     ,
        ...
        try {
            ...
            table.addColumn(TransactionTransmissionNetworkServiceDatabaseConstants.TRANSACTION_TRANSMISSION_HASH_SENDER_TYPE_COLUMN_NAME           , DatabaseDataType.STRING,        10, Boolean.FALSE);
            table.addColumn(TransactionTransmissionNetworkServiceDatabaseConstants.TRANSACTION_TRANSMISSION_HASH_RECEIVER_PUBLIC_KEY_COLUMN_NAME   , DatabaseDataType.STRING,       100, Boolean.FALSE);
            table.addColumn(TransactionTransmissionNetworkServiceDatabaseConstants.TRANSACTION_TRANSMISSION_HASH_RECEIVER_TYPE_COLUMN_NAME         , DatabaseDataType.STRING,        10, Boolean.FALSE);
            table.addColumn(TransactionTransmissionNetworkServiceDatabaseConstants.TRANSACTION_TRANSMISSION_HASH_CONTRACT_ID_COLUMN_NAME           , DatabaseDataType.STRING,       100, Boolean.FALSE);
            table.addColumn(TransactionTransmissionNetworkServiceDatabaseConstants.TRANSACTION_TRANSMISSION_HASH_NEGOTIATION_ID_COLUMN_NAME        , DatabaseDataType.STRING,        10, Boolean.FALSE);
            table.addColumn(TransactionTransmissionNetworkServiceDatabaseConstants.TRANSACTION_TRANSMISSION_HASH_TRANSACTION_TYPE_COLUMN_NAME      , DatabaseDataType.STRING,        10, Boolean.FALSE);
            ...
            table.addColumn(TransactionTransmissionNetworkServiceDatabaseConstants.TRANSACTION_TRANSMISSION_HASH_STATE_COLUMN_NAME                 , DatabaseDataType.STRING,       100, Boolean.FALSE);
            table.addColumn(TransactionTransmissionNetworkServiceDatabaseConstants.TRANSACTION_TRANSMISSION_HASH_PENDING_FLAG_COLUMN_NAME          , DatabaseDataType.STRING,         5, Boolean.FALSE);
            table.addColumn(TransactionTransmissionNetworkServiceDatabaseConstants.TRANSACTION_TRANSMISSION_HASH_REMOTE_BUSINESS_TRANSACTION       , DatabaseDataType.STRING,        10, Boolean.FALSE);
