...
public class GetSenderIdTest {
    ...
    public void getSenderId() throws Exception {
        ...
        when(businessTransactionMetadataRecord.getSenderId()).thenReturn("1");
        assertThat(businessTransactionMetadataRecord.getSenderId()).isNotNull();
    }
