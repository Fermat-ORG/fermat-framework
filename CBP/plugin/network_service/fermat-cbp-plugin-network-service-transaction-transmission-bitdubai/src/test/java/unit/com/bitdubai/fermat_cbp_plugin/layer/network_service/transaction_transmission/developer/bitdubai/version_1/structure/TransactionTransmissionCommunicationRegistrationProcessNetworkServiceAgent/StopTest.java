...
public class StopTest {
    ...
    public void Stop_AgentStops_TheThreadIsStoppedInmediately() throws Exception {
        ...
        Thread.sleep(100);
        transactionTransmissionCommunicationRegistrationProcessNetworkServiceAgent.stop();
        Thread.sleep(100);
        assertThat(transactionTransmissionCommunicationRegistrationProcessNetworkServiceAgent.getStatus()).isEqualTo(AgentStatus.STOPPED);
