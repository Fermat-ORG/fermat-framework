...
public class GetReceiverTypeTest {
    ...
    @Mock
    PlatformComponentType platformComponentType = mock(PlatformComponentType.class);
    ...
    public void getReceiverType() throws Exception{
        ...
        assertEquals(platformComponentType, businessTransactionMetadataRecord.getReceiverType());
