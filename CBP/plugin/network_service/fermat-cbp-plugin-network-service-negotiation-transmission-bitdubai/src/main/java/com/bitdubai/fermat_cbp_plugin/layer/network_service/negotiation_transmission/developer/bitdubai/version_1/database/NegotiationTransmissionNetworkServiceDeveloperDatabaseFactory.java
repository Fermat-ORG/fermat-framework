...
public final class NegotiationTransmissionNetworkServiceDeveloperDatabaseFactory {
    ...
    public final List<DeveloperDatabaseTable> getDatabaseTableList(final DeveloperObjectFactory developerObjectFactory) {
        ...
        negotiationTransmissionNetworkServiceColumns.add(NegotiationTransmissionNetworkServiceDatabaseConstants.NEGOTIATION_TRANSMISSION_NETWORK_SERVICE_NEGOTIATION_TYPE_COLUMN_NAME);
        negotiationTransmissionNetworkServiceColumns.add(NegotiationTransmissionNetworkServiceDatabaseConstants.NEGOTIATION_TRANSMISSION_NETWORK_SERVICE_NEGOTIATION_XML_COLUMN_NAME);
