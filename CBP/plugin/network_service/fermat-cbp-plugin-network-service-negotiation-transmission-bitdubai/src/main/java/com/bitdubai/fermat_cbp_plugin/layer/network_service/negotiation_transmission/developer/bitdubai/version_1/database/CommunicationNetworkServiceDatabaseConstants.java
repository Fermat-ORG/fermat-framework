...
public class CommunicationNetworkServiceDatabaseConstants {
    ...
    static final String NEGOTIATION_TRANSMISSION_NETWORK_SERVICE_PUBLIC_KEY_ACTOR_SEND_TYPE_COLUMN_NAME = "public_key_actor_send_type";
    ...
    static final String NEGOTIATION_TRANSMISSION_NETWORK_SERVICE_PUBLIC_KEY_ACTOR_RECEIVE_TYPE_COLUMN_NAME = "public_key_actor_receive_type";
    static final String NEGOTIATION_TRANSMISSION_NETWORK_SERVICE_STATE_COLUMN_NAME = "state";
