...
public class NegotiationTransmissionNetworkServiceDatabaseConstants {
    ...
    public static final String NEGOTIATION_TRANSMISSION_NETWORK_SERVICE_NEGOTIATION_TYPE_COLUMN_NAME = "negotiation_type";
    public static final String NEGOTIATION_TRANSMISSION_NETWORK_SERVICE_NEGOTIATION_XML_COLUMN_NAME = "negotiation_xml";
