 ...
 */
public class CustomerBrokerSaleDataException extends FermatException {
    ...
    public CustomerBrokerSaleDataException(String message, Exception cause, String context, String possibleReason) {
