 ...
 */
public class MissingCustomerBrokerSaleDataException extends FermatException {
    ...
    public MissingCustomerBrokerSaleDataException(String message, Exception cause, String context, String possibleReason) {
