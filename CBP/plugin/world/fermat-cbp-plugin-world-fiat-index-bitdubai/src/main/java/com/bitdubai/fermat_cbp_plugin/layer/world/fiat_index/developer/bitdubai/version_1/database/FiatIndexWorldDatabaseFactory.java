...
/**
 *  The Class  <code>com.bitdubai.fermat_cbp_plugin.layer.world.fiat_index.developer.bitdubai.version_1.database.Fiat IndexWorldDatabaseFactory</code>
 ...
 * @since Java JDK 1.7
 */
public class FiatIndexWorldDatabaseFactory implements DealsWithPluginDatabaseSystem {
     ...
     */
    public FiatIndexWorldDatabaseFactory(PluginDatabaseSystem pluginDatabaseSystem) {
    ...
    protected Database createDatabase(UUID ownerId, String databaseName) throws CantCreateDatabaseException {
        ...
        try {
             ...
             */
            table = databaseFactory.newTableFactory(ownerId, FiatIndexWorldDatabaseConstants.FIAT_INDEX_TABLE_NAME);
