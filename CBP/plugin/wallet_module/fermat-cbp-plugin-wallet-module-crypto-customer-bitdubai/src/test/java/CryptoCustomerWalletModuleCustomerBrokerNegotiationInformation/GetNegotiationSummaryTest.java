...
public class GetNegotiationSummaryTest {
    @Test
    public void getNegotiationSummaryTest() {
        ...
        when(cryptoCustomerWalletModuleCustomerBrokerNegotiationInformation.getNegotiationSummary()).thenReturn(new Map<ClauseType, String>() {
            @Override
            public int size() {
                return 0;
            }
        ...
        assertThat(cryptoCustomerWalletModuleCustomerBrokerNegotiationInformation.getNegotiationSummary()).isNotNull();
    }
}
