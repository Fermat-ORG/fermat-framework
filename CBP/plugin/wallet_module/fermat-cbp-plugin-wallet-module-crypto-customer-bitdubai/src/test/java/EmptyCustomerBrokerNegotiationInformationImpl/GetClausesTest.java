...
public class GetClausesTest {
    ...
    public void getClauses() {
        ...
        when(emptyCustomerBrokerNegotiationInformation.getClauses()).thenReturn(new Map<ClauseType, ClauseInformation>() {
            @Override
            public int size() {
                return 0;
            }
        ...
        assertThat(emptyCustomerBrokerNegotiationInformation.getClauses()).isNotNull();
    }
}
