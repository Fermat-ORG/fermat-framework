...
public class GetBrokerTest {
    ...
    public void getBroker() {
        ...
        when(emptyCustomerBrokerNegotiationInformation.getBroker()).thenReturn(new ActorIdentity() {
            @Override
        ...
        assertThat(emptyCustomerBrokerNegotiationInformation.getBroker()).isNotNull();
    }
}
