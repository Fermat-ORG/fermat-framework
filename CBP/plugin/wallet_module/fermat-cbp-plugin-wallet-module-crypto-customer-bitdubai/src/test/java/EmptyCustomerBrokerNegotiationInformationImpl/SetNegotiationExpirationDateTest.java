...
public class SetNegotiationExpirationDateTest {
    @Test
    public void setNegotiationExpirationDate() {
        ...
        doCallRealMethod().when(emptyCustomerBrokerNegotiationInformation).setNegotiationExpirationDate(Mockito.any(long.class));
    }
}
