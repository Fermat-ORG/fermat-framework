...
public class GetCustomerTest {
    ...
    public void getCustomer() {
        ...
        when(emptyCustomerBrokerNegotiationInformation.getCustomer()).thenReturn(new ActorIdentity() {
            @Override
        ...
        assertThat(emptyCustomerBrokerNegotiationInformation.getCustomer()).isNotNull();
    }
}
