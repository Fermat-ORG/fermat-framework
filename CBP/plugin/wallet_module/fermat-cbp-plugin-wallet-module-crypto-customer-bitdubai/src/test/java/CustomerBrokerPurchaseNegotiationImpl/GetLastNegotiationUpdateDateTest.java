...
public class GetLastNegotiationUpdateDateTest {
    ...
    public void getLastNegotiationUpdateDate() {
        ...
        when(customerBrokerPurchaseNegotiation.getLastNegotiationUpdateDate()).thenReturn(10L);
        assertThat(customerBrokerPurchaseNegotiation.getLastNegotiationUpdateDate()).isNotNull();
    }
}
