...
public class GetNearExpirationDatetimeTest {
    @Test
    public void getNearExpirationDatetime() {
        CustomerBrokerPurchaseNegotiationImpl customerBrokerPurchaseNegotiation = mock(CustomerBrokerPurchaseNegotiationImpl.class);
        when(customerBrokerPurchaseNegotiation.getNearExpirationDatetime()).thenReturn(true);
        assertThat(customerBrokerPurchaseNegotiation.getNearExpirationDatetime()).isNotNull();
    }
}
