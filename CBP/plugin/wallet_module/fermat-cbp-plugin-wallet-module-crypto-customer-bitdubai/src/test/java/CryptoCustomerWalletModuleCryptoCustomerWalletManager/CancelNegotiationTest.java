...
public class CancelNegotiationTest {
    @Test
    public void cancelNegotiation() throws CouldNotCancelNegotiationException{
        ...
        doCallRealMethod().when(cryptoCustomerWalletModuleCryptoCustomerWalletManager).cancelNegotiation(Mockito.any(CustomerBrokerNegotiationInformation.class), Mockito.any(String.class));
    }
}
