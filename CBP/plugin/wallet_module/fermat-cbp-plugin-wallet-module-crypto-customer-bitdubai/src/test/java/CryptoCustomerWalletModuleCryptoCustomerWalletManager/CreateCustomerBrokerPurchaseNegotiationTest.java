...
public class CreateCustomerBrokerPurchaseNegotiationTest {
    @Test
    public void createCustomerBrokerPurchaseNegotiation() throws CantCreateCustomerBrokerPurchaseNegotiationException {
        ...
        doCallRealMethod().when(cryptoCustomerWalletModuleCryptoCustomerWalletManager).createCustomerBrokerPurchaseNegotiation(Mockito.any(CustomerBrokerNegotiationInformation.class));
    }
}
