...
public class NewEmptyNegotiationBankAccountTest {
    @Test
    public void newEmptyNegotiationBankAccount() throws CantCreateBankAccountPurchaseException {
        ...
        doCallRealMethod().when(cryptoCustomerWalletModuleCryptoCustomerWalletManager).newEmptyNegotiationBankAccount(Mockito.any(String.class), Mockito.any(FiatCurrency.class));
    }
}
