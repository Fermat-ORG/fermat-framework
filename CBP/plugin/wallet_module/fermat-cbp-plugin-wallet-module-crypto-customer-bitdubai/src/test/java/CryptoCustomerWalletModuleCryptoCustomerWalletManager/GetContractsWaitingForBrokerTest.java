...
public class GetContractsWaitingForBrokerTest {
    @Test
    public void getContractsWaitingForBroker() throws CantGetContractsWaitingForBrokerException {
        ...
        doCallRealMethod().when(cryptoCustomerWalletModuleCryptoCustomerWalletManager).getContractsWaitingForBroker(Mockito.any(Integer.class), Mockito.any(Integer.class));
    }
}
