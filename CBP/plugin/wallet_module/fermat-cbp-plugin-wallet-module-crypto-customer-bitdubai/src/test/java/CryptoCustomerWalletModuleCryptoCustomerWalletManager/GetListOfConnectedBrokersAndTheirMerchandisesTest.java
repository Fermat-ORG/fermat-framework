...
public class GetListOfConnectedBrokersAndTheirMerchandisesTest {
    @Test
    public void getListOfConnectedBrokerAndTheirMerchandises() throws CantGetCryptoBrokerListException, CantGetListActorExtraDataException {
        ...
        doCallRealMethod().when(cryptoCustomerWalletModuleCryptoCustomerWalletManager).getListOfConnectedBrokersAndTheirMerchandises();
    }
}
