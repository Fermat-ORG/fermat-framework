...
public class GetContractsHistoryTest {
    @Test
    public void getContractsHistory() throws CantGetContractHistoryException, CantGetListCustomerBrokerContractPurchaseException {
        ...
        doCallRealMethod().when(cryptoCustomerWalletModuleCryptoCustomerWalletManager).getContractsHistory(Mockito.any(ContractStatus.class), Mockito.any(Integer.class), Mockito.any(Integer.class));
