...
public class GetListOfBrokerMerchandisesExchangeRateTest {
    @Test
    public void getListOfBrokerMerchandisesExchangeRate() {
        ...
        doCallRealMethod().when(cryptoCustomerWalletModuleCryptoCustomerWalletManager).getListOfBrokerMerchandisesExchangeRate(Mockito.any(String.class), Mockito.any(FermatEnum.class));
    }
}
