...
public class UpdateBankAccountTest {
    @Test
    public void updateBankAccount() throws CantUpdateBankAccountPurchaseException {
        ...
        doCallRealMethod().when(cryptoCustomerWalletModuleCryptoCustomerWalletManager).updateBankAccount(Mockito.any(NegotiationBankAccount.class));
    }
}
