 ...
 * @since Java JDK 1.7
 */
public class CustomerAckOnlineMerchandiseBusinessTransactionDeveloperDatabaseFactory implements
    ...
    public void initializeDatabase() throws CantInitializeCustomerAckOnlineMerchandiseBusinessTransactionDatabaseException {
        try {
            ...
            try {
                   ...
                   */
                database = customerAckOnlineMerchandiseBusinessTransactionDatabaseFactory.createDatabase(pluginId, pluginId.toString());
