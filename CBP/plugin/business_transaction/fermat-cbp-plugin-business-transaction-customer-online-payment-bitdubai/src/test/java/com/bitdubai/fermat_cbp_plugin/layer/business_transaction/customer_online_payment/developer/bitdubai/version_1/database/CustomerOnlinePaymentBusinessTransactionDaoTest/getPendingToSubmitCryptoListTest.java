...
public class getPendingToSubmitCryptoListTest {
    ...
    @Test
    public void getPendingToSubmitCryptoListTestTest_Should_Equal_Test() throws Exception {
        ...
        assertEquals("Test", customerOnlinePaymentBusinessTransactionDao.getPendingToSubmitCryptoList().get(0).toString());
    }
