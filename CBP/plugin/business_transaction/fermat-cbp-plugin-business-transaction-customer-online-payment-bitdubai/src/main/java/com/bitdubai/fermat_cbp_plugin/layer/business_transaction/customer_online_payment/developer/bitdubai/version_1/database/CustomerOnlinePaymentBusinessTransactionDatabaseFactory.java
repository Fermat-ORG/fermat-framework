...
public class CustomerOnlinePaymentBusinessTransactionDatabaseFactory implements DealsWithPluginDatabaseSystem {
    ...
    public Database createDatabase(UUID ownerId, String databaseName) throws CantCreateDatabaseException {
        ...
        try {
            ...
            table.addColumn(CustomerOnlinePaymentBusinessTransactionDatabaseConstants.ONLINE_PAYMENT_BLOCKCHAIN_NETWORK_TYPE, DatabaseDataType.STRING, 10, Boolean.FALSE);
