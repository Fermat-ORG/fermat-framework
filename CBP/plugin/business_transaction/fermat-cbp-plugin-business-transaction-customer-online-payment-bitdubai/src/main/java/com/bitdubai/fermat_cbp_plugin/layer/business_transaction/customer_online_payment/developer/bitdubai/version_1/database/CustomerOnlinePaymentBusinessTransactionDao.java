...
public class CustomerOnlinePaymentBusinessTransactionDao {
    ...
    public List<BusinessTransactionRecord> getPendingToSubmitCryptoStatusList() throws
        ...
        try {
            ...
            throw new CantGetContractListException(CantCreateDatabaseException.DEFAULT_MESSAGE, exception, "Getting value from getPendingToSubmitCryptoStatusList", "");
        } catch (Exception exception) {
            throw new UnexpectedResultReturnedFromDatabaseException(exception,
                    "Unexpected error",
                    "Check the cause");
    ...
    public List<BusinessTransactionRecord> getPendingToSubmitConfirmList() throws
        ...
        try {
            ...
            throw new CantGetContractListException("Error", exception, "Getting value from PendingToSubmitConfirmList", "");
        } catch (Exception exception) {
            throw new UnexpectedResultReturnedFromDatabaseException(exception,
                    "Unexpected error",
                    "Check the cause");
