...
/**
 * The Class <code>com.bitdubai.fermat_cbp_plugin.layer.business_transaction.cash_money_restock.developer.bitdubai.version_1.database.BussinessTransactionBankMoneyRestockDatabaseConstants.java
...
public class BussinessTransactionBankMoneyRestockDatabaseConstants {
    /**
    ...
    static final String BANK_MONEY_RESTOCK_PUBLIC_KEY_ACTOR_COLUMN_NAME      = "public_key_actor";
    static final String BANK_MONEY_RESTOCK_FIAT_CURRENCY_COLUMN_NAME         = "fiat_currency";
    static final String BANK_MONEY_RESTOCK_CBP_WALLET_PUBLIC_KEY_COLUMN_NAME = "cbp_wallet_public_key";
