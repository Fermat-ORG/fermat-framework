 ...
 */
public class IncomingNewContractStatusUpdateEventHandler extends AbstractCustomerOfflinePaymentEventHandler {
    @Override
    public void handleEvent(FermatEvent fermatEvent) throws FermatException {
        if (this.customerOfflinePaymentRecorderService.getStatus() == ServiceStatus.STARTED) {

            try {
                this.customerOfflinePaymentRecorderService.incomingNewContractStatusUpdateEventHandler((IncomingNewContractStatusUpdate) fermatEvent);
