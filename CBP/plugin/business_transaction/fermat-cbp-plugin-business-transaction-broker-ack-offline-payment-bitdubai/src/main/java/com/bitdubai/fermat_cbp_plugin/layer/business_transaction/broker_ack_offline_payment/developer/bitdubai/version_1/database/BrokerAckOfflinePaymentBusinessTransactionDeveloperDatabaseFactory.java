 ...
 * @since Java JDK 1.7
 */
public class BrokerAckOfflinePaymentBusinessTransactionDeveloperDatabaseFactory implements
    ...
    public void initializeDatabase() throws CantInitializeBrokerAckOfflinePaymentBusinessTransactionDatabaseException {
        try {
            ...
            try {
                   ...
                   */
                database = brokerAckOfflinePaymentBusinessTransactionDatabaseFactory.createDatabase(pluginId, pluginId.toString());
    ...
    public List<DeveloperDatabaseTable> getDatabaseTableList(DeveloperObjectFactory developerObjectFactory) {
        ...
        onlinePaymentColumns.add(BrokerAckOfflinePaymentBusinessTransactionDatabaseConstants.ACK_OFFLINE_PAYMENT_CUSTOMER_ALIAS);
