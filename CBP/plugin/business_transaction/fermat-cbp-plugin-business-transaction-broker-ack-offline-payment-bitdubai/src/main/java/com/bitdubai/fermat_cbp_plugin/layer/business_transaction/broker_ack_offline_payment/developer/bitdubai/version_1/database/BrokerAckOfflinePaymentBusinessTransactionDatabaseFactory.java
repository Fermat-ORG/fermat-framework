...
public class BrokerAckOfflinePaymentBusinessTransactionDatabaseFactory implements DealsWithPluginDatabaseSystem {
    ...
    public Database createDatabase(UUID ownerId, String databaseName) throws CantCreateDatabaseException {
        ...
        try {
            ...
            table.addColumn(BrokerAckOfflinePaymentBusinessTransactionDatabaseConstants.ACK_OFFLINE_PAYMENT_EXTERNAL_TRANSACTION_ID,DatabaseDataType.INTEGER, 10,Boolean.FALSE);
