 ...
 */
public class IncomingNewContractStatusUpdateEventHandler extends AbstractBrokerSubmitOfflineMerchandiseEventHandler {
    @Override
    public void handleEvent(FermatEvent fermatEvent) throws FermatException {
        if (this.brokerSubmitOfflineMerchandiseRecorderService.getStatus() == ServiceStatus.STARTED) {

            try {
                this.brokerSubmitOfflineMerchandiseRecorderService.incomingNewContractStatusUpdateEventHandler((IncomingNewContractStatusUpdate) fermatEvent);
