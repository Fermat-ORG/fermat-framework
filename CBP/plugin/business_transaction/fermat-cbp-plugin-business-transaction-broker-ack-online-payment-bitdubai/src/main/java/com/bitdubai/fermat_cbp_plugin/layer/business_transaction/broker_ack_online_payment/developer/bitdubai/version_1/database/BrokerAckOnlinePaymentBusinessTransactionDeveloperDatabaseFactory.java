 ...
 * @since Java JDK 1.7
 */
public class BrokerAckOnlinePaymentBusinessTransactionDeveloperDatabaseFactory {//implements DealsWithPluginDatabaseSystem, DealsWithPluginIdentity {
    /**
    ...
    public void initializeDatabase() throws CantInitializeBrokerAckOnlinePaymentBusinessTransactionDatabaseException {
        try {
              ...
              */
            database = this.pluginDatabaseSystem.openDatabase(pluginId, BrokerAckOnlinePaymentBusinessTransactionDatabaseConstants.DATABASE_NAME);
