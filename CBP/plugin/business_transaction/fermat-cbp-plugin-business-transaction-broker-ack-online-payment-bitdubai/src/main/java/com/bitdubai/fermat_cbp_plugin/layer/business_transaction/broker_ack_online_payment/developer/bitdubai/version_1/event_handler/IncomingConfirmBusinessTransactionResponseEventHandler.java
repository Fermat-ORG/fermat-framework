 ...
 */
public class IncomingConfirmBusinessTransactionResponseEventHandler extends AbstractBrokerAckOnlinePaymentEventHandler {
    @Override
    public void handleEvent(FermatEvent fermatEvent) throws FermatException {
        if (this.brokerAckOnlinePaymentRecorderService.getStatus() == ServiceStatus.STARTED) {

            try {
                this.brokerAckOnlinePaymentRecorderService.incomingConfirmBusinessTransactionResponseEventHandler((IncomingConfirmBusinessTransactionResponse) fermatEvent);
