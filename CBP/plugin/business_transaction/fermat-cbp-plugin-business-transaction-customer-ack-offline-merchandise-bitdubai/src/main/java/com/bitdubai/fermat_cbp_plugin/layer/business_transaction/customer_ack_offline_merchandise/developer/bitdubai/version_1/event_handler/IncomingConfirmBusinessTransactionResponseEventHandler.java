 ...
 */
public class IncomingConfirmBusinessTransactionResponseEventHandler extends AbstractCustomerAckOfflineMerchandiseEventHandler {
    @Override
    public void handleEvent(FermatEvent fermatEvent) throws FermatException {
        if (this.customerAckOfflineMerchandiseRecorderService.getStatus() == ServiceStatus.STARTED) {

            try {
                this.customerAckOfflineMerchandiseRecorderService.incomingConfirmBusinessTransactionResponseEventHandler((IncomingConfirmBusinessTransactionResponse) fermatEvent);
