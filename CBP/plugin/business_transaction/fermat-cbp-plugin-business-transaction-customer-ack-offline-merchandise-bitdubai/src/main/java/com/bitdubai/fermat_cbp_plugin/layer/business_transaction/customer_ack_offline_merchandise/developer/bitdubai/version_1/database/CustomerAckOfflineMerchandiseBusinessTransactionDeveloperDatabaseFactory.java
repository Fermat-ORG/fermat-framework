 ...
 * @since Java JDK 1.7
 */
public class CustomerAckOfflineMerchandiseBusinessTransactionDeveloperDatabaseFactory {//implements DealsWithPluginDatabaseSystem, DealsWithPluginIdentity {
    /**
    ...
    public void initializeDatabase() throws CantInitializeCustomerAckOfflineMerchandiseBusinessTransactionDatabaseException {
        try {
            ...
            try {
                   ...
                   */
                database = customerAckOfflineMerchandiseBusinessTransactionDatabaseFactory.createDatabase(pluginId, CustomerAckOfflineMerchandiseBusinessTransactionDatabaseConstants.DATABASE_NAME);
    ...
    public List<DeveloperDatabase> getDatabaseList(DeveloperObjectFactory developerObjectFactory) {
        ...
        databases.add(developerObjectFactory.getNewDeveloperDatabase(CustomerAckOfflineMerchandiseBusinessTransactionDatabaseConstants.DATABASE_NAME, this.pluginId.toString()));
        return databases;
    }
