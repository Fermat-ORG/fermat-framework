 ...
 */
public class IncomingConfirmBusinessTransactionResponseEventHandler extends AbstractBrokerSubmitOnlineMerchandiseEventHandler {
    @Override
    public void handleEvent(FermatEvent fermatEvent) throws FermatException {
        if (this.brokerSubmitOnlineMerchandiseRecorderService.getStatus() == ServiceStatus.STARTED) {

            try {
                this.brokerSubmitOnlineMerchandiseRecorderService.incomingConfirmBusinessTransactionResponse((IncomingConfirmBusinessTransactionResponse) fermatEvent);
