...
public class ConstructionTest {
    ...
    public void Construction_ValidParameters_NewObjectCreated() {
        ...
        StockTransactionCashMoneyRestockFactory stockTransactionCashMoneyRestockFactory = new StockTransactionCashMoneyRestockFactory(
                this.pluginDatabaseSystem,
                this.pluginId
        );
        assertThat(stockTransactionCashMoneyRestockFactory).isNotNull();
    }
}
