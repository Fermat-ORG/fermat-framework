...
public class StockTransactionCashMoneyRestockManager implements
    ...
    public void createTransactionRestock(String publicKeyActor, FiatCurrency fiatCurrency, String cbpWalletPublicKey, String cshWalletPublicKey, String cashReference, float amount, String memo, float priceReference, OriginTransaction originTransaction) throws CantCreateCashMoneyRestockException {
        ...
        try {
            saveCashMoneyRestockTransactionData(cashMoneyRestockTransaction);
    ...
    private void saveCashMoneyRestockTransactionData(CashMoneyTransaction cashMoneyTransaction) throws DatabaseOperationException, MissingCashMoneyRestockDataException {
