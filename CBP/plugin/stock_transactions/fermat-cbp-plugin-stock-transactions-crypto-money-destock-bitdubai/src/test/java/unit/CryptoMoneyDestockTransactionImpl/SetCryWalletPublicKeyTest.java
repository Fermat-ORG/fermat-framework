...
public class SetCryWalletPublicKeyTest {

    @Test
    public void setCryWalletPublicKey() {
        ...
        doCallRealMethod().when(cryptoMoneyDestockTransaction).setCryWalletPublicKey(Mockito.any(String.class));
    }
