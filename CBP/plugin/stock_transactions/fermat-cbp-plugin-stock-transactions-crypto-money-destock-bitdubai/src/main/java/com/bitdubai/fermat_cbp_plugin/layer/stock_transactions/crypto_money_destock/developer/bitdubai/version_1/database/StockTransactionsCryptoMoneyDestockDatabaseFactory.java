...
public class StockTransactionsCryptoMoneyDestockDatabaseFactory {
    ...
    public Database createDatabase(UUID ownerId, String databaseName) throws CantCreateDatabaseException {
        ...
        try {
            ...
            table.addColumn(StockTransactionsCrpytoMoneyDestockDatabaseConstants.CRYPTO_MONEY_DESTOCK_AMOUNT_COLUMN_NAME,                DatabaseDataType.REAL, 0, Boolean.FALSE);
            ...
            table.addColumn(StockTransactionsCrpytoMoneyDestockDatabaseConstants.CRYPTO_MONEY_DESTOCK_PRICE_REFERENCE_COLUMN_NAME,       DatabaseDataType.REAL, 0, Boolean.FALSE);
