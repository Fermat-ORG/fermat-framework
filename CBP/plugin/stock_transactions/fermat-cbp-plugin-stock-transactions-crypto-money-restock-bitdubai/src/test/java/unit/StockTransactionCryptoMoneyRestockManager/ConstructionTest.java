...
public class ConstructionTest {
    ...
    public void Construction_ValidParameters_NewObjectCreated(){
        ...
        StockTransactionCryptoMoneyRestockManager stockTransactionCryptoMoneyRestockManager = new StockTransactionCryptoMoneyRestockManager(
                this.pluginDatabaseSystem,
                this.pluginId,
                this.errorManager
        );
        assertThat(stockTransactionCryptoMoneyRestockManager).isNotNull();
    }
}
