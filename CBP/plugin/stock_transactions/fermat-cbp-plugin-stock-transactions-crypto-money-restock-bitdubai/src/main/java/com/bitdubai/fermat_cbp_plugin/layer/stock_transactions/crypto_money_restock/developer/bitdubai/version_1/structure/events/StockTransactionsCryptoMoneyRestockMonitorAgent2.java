 ...
 */
public class StockTransactionsCryptoMoneyRestockMonitorAgent2 extends AbstractAgent {
    ...
    public StockTransactionsCryptoMoneyRestockMonitorAgent2(long sleepTime,
                                                            TimeUnit timeUnit,
                                                            long initDelayTime,
            ...
            for (CryptoMoneyTransaction cryptoMoneyTransaction : stockTransactionCryptoMoneyRestockFactory.getCryptoMoneyTransactionList(null)) {
                ...
                switch (cryptoMoneyTransaction.getTransactionStatus()) {
                    ...
                    case INIT_TRANSACTION:
                        ...
                        CryptoHoldTransactionParametersWrapper cryptoTransactionParametersWrapper =
                                new CryptoHoldTransactionParametersWrapper(
                                        ...
                                        cryptoMoneyTransaction.getFee(),
                                        cryptoMoneyTransaction.getFeeOrigin());
