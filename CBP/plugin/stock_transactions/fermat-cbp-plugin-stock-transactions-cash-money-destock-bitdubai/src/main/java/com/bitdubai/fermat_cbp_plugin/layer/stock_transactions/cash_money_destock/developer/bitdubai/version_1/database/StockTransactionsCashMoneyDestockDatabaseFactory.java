...
public class StockTransactionsCashMoneyDestockDatabaseFactory {
    ...
    public Database createDatabase(UUID ownerId, String databaseName) throws CantCreateDatabaseException {
        ...
        try {
            ...
            table.addColumn(StockTransactionsCashMoneyDestockDatabaseConstants.CASH_MONEY_DESTOCK_TRANSACTION_ID_COLUMN_NAME,        DatabaseDataType.STRING, 50, Boolean.TRUE);
            table.addColumn(StockTransactionsCashMoneyDestockDatabaseConstants.CASH_MONEY_DESTOCK_PUBLIC_KEY_ACTOR_COLUMN_NAME,      DatabaseDataType.STRING, 255, Boolean.FALSE);
            table.addColumn(StockTransactionsCashMoneyDestockDatabaseConstants.CASH_MONEY_DESTOCK_FIAT_CURRENCY_COLUMN_NAME,         DatabaseDataType.STRING, 15, Boolean.FALSE);
            table.addColumn(StockTransactionsCashMoneyDestockDatabaseConstants.CASH_MONEY_DESTOCK_CBP_WALLET_PUBLIC_KEY_COLUMN_NAME, DatabaseDataType.STRING, 255, Boolean.FALSE);
            ...
            table.addColumn(StockTransactionsCashMoneyDestockDatabaseConstants.CASH_MONEY_DESTOCK_ORIGIN_TRANSACTION_ID_COLUMN_NAME,    DatabaseDataType.STRING, 255, Boolean.FALSE);
