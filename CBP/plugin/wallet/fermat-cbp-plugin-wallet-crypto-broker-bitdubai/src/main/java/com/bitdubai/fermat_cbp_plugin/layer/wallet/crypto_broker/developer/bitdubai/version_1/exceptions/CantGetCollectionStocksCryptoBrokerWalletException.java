 ...
 */
public class CantGetCollectionStocksCryptoBrokerWalletException extends FermatException {
     ...
     */
    public CantGetCollectionStocksCryptoBrokerWalletException(String message, Exception cause, String context, String possibleReason) {
