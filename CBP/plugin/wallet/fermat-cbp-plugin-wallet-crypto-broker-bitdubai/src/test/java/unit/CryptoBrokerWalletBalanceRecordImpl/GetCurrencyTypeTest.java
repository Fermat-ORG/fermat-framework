...
public class GetCurrencyTypeTest {
    ...
    public void getCurrencyType(){
        ...
        when(cryptoBrokerWalletBalanceRecord.getCurrencyType()).thenReturn(CurrencyType.CRYPTO_MONEY);
        assertThat(cryptoBrokerWalletBalanceRecord.getCurrencyType()).isNotNull();
    }
