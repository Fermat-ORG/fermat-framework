...
public class GetMarketRateTest {
    ...
    public void getMarketRate() throws CantGetCryptoBrokerMarketRateException {
        ...
        when(cryptoBrokerWallet.getMarketRate(Mockito.any(FermatEnum.class), Mockito.any(FiatCurrency.class), Mockito.any(CurrencyType.class))).thenReturn(new FiatIndex() {
            @Override
        ...
        assertThat(cryptoBrokerWallet.getMarketRate(Mockito.any(FermatEnum.class), Mockito.any(FiatCurrency.class), Mockito.any(CurrencyType.class))).isNotNull();
    }
