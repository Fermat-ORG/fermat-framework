...
public class SaveCryptoBrokerWalletProviderSettingTest {

    @Test
    public void saveCryptoBrokerWalletProviderSetting() throws CantSaveCryptoBrokerWalletSettingException {
        ...
        doCallRealMethod().when(cryptoBrokerWalletSetting).saveCryptoBrokerWalletProviderSetting(Mockito.any(CryptoBrokerWalletProviderSetting.class));
    }
