...
public class GetCurrencyTypeTest {
    ...
    public void getCurrencyType(){
        ...
        when(cryptoBrokerStockTransactionRecord.getCurrencyType()).thenReturn(CurrencyType.CRYPTO_MONEY);
        assertThat(cryptoBrokerStockTransactionRecord.getCurrencyType()).isNotNull();
    }
