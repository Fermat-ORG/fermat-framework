...
public class CancelNegotiationPurchaseTest {
    ...
    @Test
    public void cancelNegotiation() throws Exception {
        ...
        doCallRealMethod().when(customerBrokerUpdateManagerImpl).cancelNegotiation(customerBrokerPurchaseNegotiation);
