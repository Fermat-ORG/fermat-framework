...
public class SendCancelPurchaseNegotiationTranasctionTest {
    ...
    public void sendPurchaseNegotiationTranasction() throws Exception {
        ...
        doCallRealMethod().when(customerBrokerUpdatePurchaseNegotiationTransaction).SendCancelPurchaseNegotiationTranasction(customerBrokerPurchaseNegotiation);
