package unit.com.bitdubai.fermat_cbp_plugin.layer.negotiation_transaction.customer_broker_new.developer.bitdubai.version_1.structure.CustomerBrokerNewImpl;
...
public class ConstructionTest {
    ...
    private CustomerBrokerNewImpl testObj1;

    @Before
    public void setUp() {
        testObj1 = new CustomerBrokerNewImpl(
                transactionId,
                negotiationId,
                publicKeyBroker,
                publicKeyCustomer,
