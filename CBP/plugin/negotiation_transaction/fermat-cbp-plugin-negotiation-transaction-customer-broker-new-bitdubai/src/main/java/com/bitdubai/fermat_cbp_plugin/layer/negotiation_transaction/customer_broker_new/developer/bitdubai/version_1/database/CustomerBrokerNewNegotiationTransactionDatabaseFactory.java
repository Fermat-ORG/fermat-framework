...
public class CustomerBrokerNewNegotiationTransactionDatabaseFactory implements DealsWithPluginDatabaseSystem {
    ...
    public Database createDatabase(UUID ownerId, String databaseName) throws CantCreateDatabaseException {
        ...
        try {
            ...
            table.addColumn(CustomerBrokerNewNegotiationTransactionDatabaseConstants.CUSTOMER_BROKER_NEW_SEND_TRANSACTION_COLUMN_NAME, DatabaseDataType.STRING, 0, Boolean.FALSE);
            table.addColumn(CustomerBrokerNewNegotiationTransactionDatabaseConstants.CUSTOMER_BROKER_NEW_CONFIRM_TRANSACTION_COLUMN_NAME, DatabaseDataType.STRING, 0, Boolean.FALSE);
