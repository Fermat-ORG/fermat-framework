 ...
 */
public class CryptoCustomerActorExtraDataNotStartedException extends FermatException {

    private static final String DEFAULT_MESSAGE = "CRYPTO BROKER ACTOR EXTRA DATA NOT STARTED EXCEPTION";

    public CryptoCustomerActorExtraDataNotStartedException(String message, Exception cause, String context, String possibleReason) {
        super(message, cause, context, possibleReason);
    }

    public CryptoCustomerActorExtraDataNotStartedException(Exception cause, String context, String possibleReason) {
        this(DEFAULT_MESSAGE, cause, context, possibleReason);
    }

    public CryptoCustomerActorExtraDataNotStartedException(String context, String possibleReason) {
