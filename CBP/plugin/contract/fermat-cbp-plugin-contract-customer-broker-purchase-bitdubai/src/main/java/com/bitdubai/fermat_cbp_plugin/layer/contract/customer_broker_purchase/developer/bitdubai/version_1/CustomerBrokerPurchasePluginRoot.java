...
public class CustomerBrokerPurchasePluginRoot implements DealsWithErrors, DealsWithLogger, DealsWithPluginDatabaseSystem, LogManagerForDevelopers, Service, Plugin {
    ...
    public void start() throws CantStartPluginException {
        ...
        /*
        try {
            this.customerBrokerPurchaseContractDao = new CustomerBrokerPurchaseContractDao(pluginDatabaseSystem);
            this.customerBrokerPurchaseContractDao.initialize(pluginId);
        } catch (CantInitializeCustomerBrokerPurchaseContractDaoException cantInitializeCustomerBrokerPurchaseContractDaoException) {
