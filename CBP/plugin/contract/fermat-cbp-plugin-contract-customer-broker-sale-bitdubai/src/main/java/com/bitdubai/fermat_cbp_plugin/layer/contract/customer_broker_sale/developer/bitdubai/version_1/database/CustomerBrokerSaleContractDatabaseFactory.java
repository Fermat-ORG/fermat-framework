...
public class CustomerBrokerSaleContractDatabaseFactory implements DealsWithPluginDatabaseSystem {
    ...
    protected Database createDatabase(UUID ownerId, String databaseName) throws CantCreateDatabaseException {
        ...
        try {
            ...
            table.addColumn(CustomerBrokerSaleContractDatabaseConstants.CONTRACTS_SALE_CUSTOMER_PUBLIC_KEY_COLUMN_NAME, DatabaseDataType.STRING, 100, Boolean.FALSE);
            table.addColumn(CustomerBrokerSaleContractDatabaseConstants.CONTRACTS_SALE_BROKER_PUBLIC_KEY_COLUMN_NAME, DatabaseDataType.STRING, 100, Boolean.FALSE);
            table.addColumn(CustomerBrokerSaleContractDatabaseConstants.CONTRACTS_SALE_DATA_TIME_COLUMN_NAME, DatabaseDataType.LONG_INTEGER, 100, Boolean.FALSE);
            ...
            table.addColumn(CustomerBrokerSaleContractDatabaseConstants.CLAUSE_CONTRACT_CLAUSE_ID_COLUMN_NAME, DatabaseDataType.STRING, 100, Boolean.TRUE);
            ...
            table.addColumn(CustomerBrokerSaleContractDatabaseConstants.CLAUSE_CONTRACT_EXECUTION_ORDER_COLUMN_NAME, DatabaseDataType.INTEGER, 11, Boolean.FALSE);
            ...
            table.addColumn(CustomerBrokerSaleContractDatabaseConstants.CLAUSE_STATUS_LOG_LOG_ID_COLUMN_NAME, DatabaseDataType.STRING, 100, Boolean.TRUE);
            table.addColumn(CustomerBrokerSaleContractDatabaseConstants.CLAUSE_STATUS_LOG_CLAUSE_ID_COLUMN_NAME, DatabaseDataType.STRING, 100, Boolean.FALSE);
            ...
            table.addColumn(CustomerBrokerSaleContractDatabaseConstants.CLAUSE_STATUS_LOG_DATA_TIME_COLUMN_NAME, DatabaseDataType.LONG_INTEGER, 100, Boolean.FALSE);
            table.addColumn(CustomerBrokerSaleContractDatabaseConstants.CLAUSE_STATUS_LOG_CHANGE_BY_COLUMN_NAME, DatabaseDataType.STRING, 20, Boolean.FALSE);
