 ...
 */
public final class CryptoCustomerActorNetworkServiceSearchTest extends CryptoCustomerSearch {

    private final CryptoCustomerActorNetworkServicePluginRootTest pluginRoot;
    private final ErrorManager                   errorManager                  ;
    private final PluginVersionReference         pluginVersionReference        ;

    public CryptoCustomerActorNetworkServiceSearchTest(final CryptoCustomerActorNetworkServicePluginRootTest pluginRoot,
