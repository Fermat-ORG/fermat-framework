package com.bitdubai.fermat_cbp_core.layer.wallet.crypto_broker;

import com.bitdubai.fermat_api.layer.all_definition.common.system.utils.PluginReference;
import com.bitdubai.fermat_api.layer.all_definition.enums.Plugins;
import com.bitdubai.fermat_cbp_plugin.layer.wallet.crypto_broker.developer.bitdubai.DeveloperBitDubai;
...
public class CryptoBrokerPluginSubsystem extends AbstractPluginSubsystem {
    ...
    public CryptoBrokerPluginSubsystem() {
        super(new PluginReference(Plugins.CRYPTO_BROKER_WALLET));
    }
