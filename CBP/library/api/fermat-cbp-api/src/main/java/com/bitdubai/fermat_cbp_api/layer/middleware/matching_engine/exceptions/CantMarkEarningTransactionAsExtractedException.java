...
public class CantMarkEarningTransactionAsExtractedException extends FermatException {
     ...
     */
    public CantMarkEarningTransactionAsExtractedException(String message, Exception cause, String context, String possibleReason) {
        super(message, cause, context, possibleReason);
    }


    public CantMarkEarningTransactionAsExtractedException(Exception cause, String context, String possibleReason) {
