...
public interface CustomerBrokerSale {
    /**
     * The method <code>getTransactionId</code> returns the transaction id of the customer broker sale
     *
    ...
    /**
     * The method <code>setTransactionId</code> sets the transaction id of the customer broker sale
     *
     * @param transactionId
     */
    ...
    /**
     * The method <code>getContractTransactionId</code> returns the contract transaction id of the customer broker sale
     *
    ...
    /**
     * The method <code>setContractTransactionId</code> sets the contract transaction id of the customer broker sale
     *
    ...
    /**
     * The method <code>getTimestamp</code> returns the contract timestamp of the customer broker sale
     *
    ...
    /**
     * The method <code>getPurchaseStatus</code> returns the purchase status of the customer broker sale
     *
    ...
    /**
     * The method <code>getContractStatus</code> returns the contract status of the customer broker sale
     *
    ...
    /**
     * The method <code>setTransactionStatus</code> sets the transaction status of the customer broker sale
     *
    ...
    /**
     * The method <code>getTransactionType</code> returns the transaction type of the customer broker sale
     *
