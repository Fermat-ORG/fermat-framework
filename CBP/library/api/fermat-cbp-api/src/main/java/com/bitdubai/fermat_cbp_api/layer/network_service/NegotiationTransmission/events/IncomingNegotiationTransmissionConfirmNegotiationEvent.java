 ...
 */
public class IncomingNegotiationTransmissionConfirmNegotiationEvent extends AbstractCBPFermatEvent {
    PlatformComponentType destinationPlatformComponentType;

    public IncomingNegotiationTransmissionConfirmNegotiationEvent(EventType eventType) {
        super(eventType);
    }
