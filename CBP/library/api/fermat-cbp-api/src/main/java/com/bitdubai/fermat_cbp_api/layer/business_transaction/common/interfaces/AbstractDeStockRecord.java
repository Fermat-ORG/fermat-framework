...
public class AbstractDeStockRecord {
    ...
    public BigDecimal parseLongToBigDecimal(long longAmount){
    ...
    public String generateMemo(String contractHash){
        return "DeStock transaction generated by Broker Submit business transaction from" +
                " contract "+contractHash;
    }

    public String abstractToString() {
        return "AbstractDeStockRecord{" +
