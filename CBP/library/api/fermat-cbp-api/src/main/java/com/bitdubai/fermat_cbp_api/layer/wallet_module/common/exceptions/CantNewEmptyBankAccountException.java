 ...
 */
public class CantNewEmptyBankAccountException extends FermatException {
     ...
     */
    public CantNewEmptyBankAccountException(String message, Exception cause, String context, String possibleReason) {
     ...
     * @param cause   the exception that triggered the throwing of the current exception, if there are no other exceptions to be declared here, the cause should be null
     */
    public CantNewEmptyBankAccountException(String message, Exception cause) {
        super(message, cause, "", "");
    }
     ...
     * @param cause the exception that triggered the throwing of the current exception, if there are no other exceptions to be declared here, the cause should be null
     */
    public CantNewEmptyBankAccountException(Exception cause) {
