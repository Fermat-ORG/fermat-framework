 ...
 */
public class ContractMerchandiseReceptionDetail extends ContractDetail {
    ...
    public ContractMerchandiseReceptionDetail(int contractStep, ContractStatus contractStatus, ContractDetailType contractDetailType,
