 ...
 */
public class IdentityDialog extends FermatDialog<ReferenceAppFermatSession<CryptoCustomerWalletModuleManager>, ResourceProviderManager>
...
//    private ImageView dialogBanner;
    ...
    public IdentityDialog(Activity activity, ReferenceAppFermatSession<CryptoCustomerWalletModuleManager> fermatSession, ResourceProviderManager resources) {
        super(activity, fermatSession, resources);

        titleString         = R.string.ccw_identity_dialog_title_btc;
        descriptionString   = R.string.ccw_identity_dialog_description_btc;
        description2String  = R.string.ccw_identity_dialog_description2_btc;
        hintStringResource  = R.string.ccw_identity_dialog_hint;
        editTextValue = null;
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.ccw_text_dialog_done_btn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FermatTextView dialogTitle = (FermatTextView) findViewById(R.id.ccw_text_dialog_title);
        dialogTitle.setText(titleString);

        FermatTextView dialogDescription = (FermatTextView) findViewById(R.id.ccw_text_dialog_description);
        dialogDescription.setText(descriptionString);

        FermatTextView dialogDescription2 = (FermatTextView) findViewById(R.id.ccw_text_dialog_description2);
        dialogDescription2.setText(description2String);

        FermatButton acceptBtn = (FermatButton) findViewById(R.id.ccw_text_dialog_done_btn);
    ...
    protected int setLayoutId() {
        return R.layout.ccw_identity_dialog;
    }
