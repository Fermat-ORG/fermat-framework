...
public class AddNoteViewHolder extends FermatViewHolder implements View.OnClickListener {
    ...
    public AddNoteViewHolder(View itemView){
        ...
        Button cancelNoteButton = (Button) itemView.findViewById(R.id.ccw_open_negotiation_cancel_note);
        cancelNoteButton.setOnClickListener(this);

        Button saveNoteButton = (Button) itemView.findViewById(R.id.ccw_open_negotiation_save_note);
