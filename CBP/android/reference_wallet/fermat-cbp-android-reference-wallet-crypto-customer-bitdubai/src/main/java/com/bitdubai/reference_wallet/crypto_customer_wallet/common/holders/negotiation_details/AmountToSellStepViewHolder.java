...
public class AmountToSellStepViewHolder extends StepViewHolder
    ...
    public AmountToSellStepViewHolder(RecyclerView.Adapter adapter, View itemView, CryptoBrokerWalletManager walletManager) {
        ...
        sellingText = (TextView) itemView.findViewById(R.id.ccw_selling_text);
        sellingValue = (EditText) itemView.findViewById(R.id.ccw_selling_value);
        currencyToSellTextValue = (TextView) itemView.findViewById(R.id.ccw_currency_to_sell);
        youWillReceiveText = (TextView) itemView.findViewById(R.id.ccw_you_will_receive_text);
        youWillReceiveTextValue = (TextView) itemView.findViewById(R.id.ccw_you_will_receive_text_value);
