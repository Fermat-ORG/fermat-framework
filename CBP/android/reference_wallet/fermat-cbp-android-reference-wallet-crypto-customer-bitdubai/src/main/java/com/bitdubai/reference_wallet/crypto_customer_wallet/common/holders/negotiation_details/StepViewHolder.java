...
public abstract class StepViewHolder extends FermatViewHolder {
    ...
    public StepItemGetter stepItemGetter;

    public StepViewHolder(View itemView, StepItemGetter adapter) {
        super(itemView);

        this.stepItemGetter = adapter;
    ...
    private void configClauseViews(View itemView) {
        titleTextView = (TextView) itemView.findViewById(R.id.ccw_card_view_title);
        clauseNumberImageView = (ImageView) itemView.findViewById(R.id.ccw_clause_number);

        confirmButton = (Button) itemView.findViewById(R.id.ccw_confirm_button);
    ...
    public void bind(int stepNumber) {
        ...
        NegotiationStep step = stepItemGetter.getDataSetItem(itemPosition);
    ...
    public void setStatus(NegotiationStepStatus stepStatus) {
        ...
        switch (stepStatus) {
            ...
            case CONFIRM:
                containerCardView.setCardBackgroundColor(getColor(R.color.ccw_card_background_status_confirm));
