...
public class AmountToBuyViewHolder extends ClauseViewHolder implements View.OnClickListener {
    ...
    public AmountToBuyViewHolder(View itemView) {
        ...
        currencyToBuyTextValue  = (TextView) itemView.findViewById(R.id.cbw_currency_to_buy);
        buyingText              = (TextView) itemView.findViewById(R.id.cbw_buying_text);
        buyingValue             = (FermatButton) itemView.findViewById(R.id.cbw_buying_value);
