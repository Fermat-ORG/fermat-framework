...
//            differenceTextView.setText(String.format("+ %s %s", diff, currencyCode));
            differenceTextView.setText(new StringBuilder().append("+ ").append(diff).append(" ").append(currencyCode).toString());
            differenceTextView.setTextColor(Color.parseColor("#39ab89"));
        } else if (amount < 0) {
//            differenceTextView.setText(String.format("%s %s", diff, currencyCode));
            differenceTextView.setText(new StringBuilder().append(diff).append(" ").append(currencyCode).toString());
            differenceTextView.setTextColor(Color.parseColor("#d14846"));
        } else {
//            differenceTextView.setText(String.format("0.0 %s", currencyCode));
            differenceTextView.setText(new StringBuilder().append("0.0 ").append(currencyCode).toString());
