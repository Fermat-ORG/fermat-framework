...
import com.bitdubai.sub_app.crypto_broker_community.common.Views.RoundedDrawable;
 ...
 */
public class RegisterUserFragment extends FermatFragment {
    ...
    public static RegisterUserFragment newInstance() {
        RegisterUserFragment f = new RegisterUserFragment();
        Bundle b = new Bundle();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            errorManager = cryptoBrokerCommunitySubAppSession.getErrorManager();
        }catch (Exception e){
            e.printStackTrace();
        }
...
//        FT.commit();
     ...
     * @param walletSession
     */
    public void setCryptoBrokerCommunitySubAppSession(CryptoBrokerCommunitySubAppSession walletSession) {
        this.cryptoBrokerCommunitySubAppSession = walletSession;
    }
