...
public class GeolocationDialog extends FermatDialog<ReferenceAppFermatSession, ResourceProviderManager>
    ...
    public GeolocationDialog(Activity activity,
                             ReferenceAppFermatSession<CryptoBrokerCommunitySubAppModuleManager> appSession,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            recyclerView = (RecyclerView) findViewById(R.id.cbc_geolocation_recycler_view);
            noDataLabel = (TextView) findViewById(R.id.cbc_no_data_geo);
            searchInput = (EditText) findViewById(R.id.cbc_geolocation_input);
            progressBar = (ProgressBar) findViewById(R.id.cbc_geolocation_progress_bar);
            ImageView closeButton = (ImageView) findViewById(R.id.cbc_close_geolocation_dialog);
