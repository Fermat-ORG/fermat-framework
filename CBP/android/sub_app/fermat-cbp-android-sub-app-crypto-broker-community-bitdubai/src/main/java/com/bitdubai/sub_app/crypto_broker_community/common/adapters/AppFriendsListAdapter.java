...
import com.bitdubai.sub_app.crypto_broker_community.common.holders.AppFriendsListHolder;
 ...
 * @version 1.0.0
 */
public class AppFriendsListAdapter extends FermatAdapter<CryptoBrokerCommunityInformation, AppFriendsListHolder> {

    public AppFriendsListAdapter(Context context, List<CryptoBrokerCommunityInformation> dataSet) {
    ...
    @Override
    protected void bindHolder(AppFriendsListHolder holder, CryptoBrokerCommunityInformation data, int position) {
