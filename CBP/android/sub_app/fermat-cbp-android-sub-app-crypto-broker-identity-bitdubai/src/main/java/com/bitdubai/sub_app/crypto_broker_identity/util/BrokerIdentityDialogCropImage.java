 ...
 */
public class BrokerIdentityDialogCropImage extends FermatDialog implements View.OnClickListener{
    ...
    Bitmap image;
    Bitmap croppedImage;
    public BrokerIdentityDialogCropImage(Context activity, FermatSession referenceAppFermatSession, ResourceProviderManager resources, Bitmap image) {
    ...
    protected int setLayoutId() {
        return R.layout.cbi_dialog_crop_image;
    }
