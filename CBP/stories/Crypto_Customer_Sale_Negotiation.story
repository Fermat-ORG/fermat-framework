...
Escenario: El Crypto Broker recibe una Solicitud de Negociacion de Compra
  ...
  Entonces el Crypto Broker Purchase Request Plugin recibira mediante el Crypto Broker Network Service Plugin la "Buy Negotiation Request"
    Y el Crypto Broker Wallet Module Plugin gestionara la informacion recibida por el Crypto Broker Purchase Request plugin
    Y el Crypto Broker Wallet Module Plugin procesara la Crypto Broker Wallet escogida por el Crypto Broker
    Y el Crypto Broker Wallet Plugin crear una "Sale Negotiation Contract" acordando el "Type of Merchandise" solicitada
Permutacion:
...
     Y el Crypto Broker Wallet Module Plugin debe solicitar al Crypto Broker Purchase Request Plugin que envie un mensaje al Crypto Customer a través del Crypto Customer Network Service Plugin con la Información del "Contract"
     Y el Crypto Broker Wallet Module Plugin debe añadir a una lista de pendientes de las negociaciones de venta en el Crypto Broker Wallet
...
|Fiat Money           |Fiat Money Buy Negotiation Contract    |Cash on HY     |Fiat Money
|                     |                                       |Crypto         |
...
   Entonces el Crypto Broker Wallet Module Plugin actualizara con la nueva información el "Sale Negotiation Contract"
     Y el Crypto Broker Wallet Module Plugin debe solicitar al Crypto Broker Purchase Request Plugin que envie un mensaje al Crypto Customer a través del Crypto Customer Network Service Plugin con la información actualizada del Contrato al Crypto Customer
     Y el Crypto Broker Reference Wallet Android debe ser visible la informacion dentro del Crypto Broker Wallet
     Y el Crypto Broker Wallet Module Plugin debe agregar un registro en el Log de transacciones de la "Sale Negotiation Contract"
...
     Y el Crypto Broker Reference Wallet Android debe hacer visible el "Business Transaction" dentro de la Crypto Broker Wallet como continuación de la Negociación
     Y el Crypto Broker Wallet Module Plugin debe agregar un registro en el Log de transacciones de la "Sale Negotiation Contract"
Permutacion:
