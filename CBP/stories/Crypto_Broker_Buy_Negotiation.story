...
Using the Crypto Customer Wallet
  And the Crypto Customer Wallet Module
...
Scenario: The Crypto Customer initiates a Buy Request
  Given I have set conection whit a Crypto Broker in the Crypto Broker Actor
...
Scenario: The Crypto Customer creates a Buy Request
  ...
  Then the Crypto Customer Wallet Module should create a new Crypto Broker Buy Request using the Crypto Broker Purchase Request
    And the Crypto Broker Purchase Request should mark the "Request" as IN_PROCESS
    And it should send a message with the Crypto Broker Buy Request through the Crypto Broker Network Service to the Crypto Broker
    And the Crypto Customer Wallet should put the Crypto Broker Buy Request in the list of Pending Buy Requests 
...
Scenario: The Crypto Broker accepts the Buy Request
  ...
  When the Crypto Customer Network Service receive the message
  Then it should notify the Crypto Broker Purchase Request with the acceptance of the Crypto Broker Buy Request
    And the Crypto Broker Purchase Request should mark the "Request" as ACCEPTED
    And it should notify the Crypto Customer Wallet Module
    And the Crypto Customer Wallet Module should create a "Buy Negotiation Contract" for the "Type of Merchandise"
    And the Crypto Customer Wallet should update the list of Crypto Broker Buy Requests as correspond
Permutations:
...
Scenario: The Crypto Broker postpone the Buy Request
  ...
  When the Crypto Customer Network Service receive the message
  Then it should notify the Crypto Broker Purchase Request with the postpone of "Request"
    And the Crypto Broker Purchase Request should mark the "Request" as POSTPONED
    And the Crypto Customer Wallet should update the list of Crypto Broker Buy Requests as correspond
...
Scenario: The Crypto Broker provides additional information to a Buy Negotiation
  ...
  When the Crypto Customer Network Service receives the message
