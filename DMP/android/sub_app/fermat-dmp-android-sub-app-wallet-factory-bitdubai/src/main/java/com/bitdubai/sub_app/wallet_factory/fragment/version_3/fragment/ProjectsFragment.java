...
public  class ProjectsFragment extends Fragment {
    ...
    public class ExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        List<WalletFactoryProject> lstWalletFactoryProject;
        ...
        public ExpandableListAdapter(List<WalletFactoryProject> lstWalletFactoryProject, String[][] transactions) {
            this.lstWalletFactoryProject = lstWalletFactoryProject;
            this.transactions = transactions;
            inf = LayoutInflater.from(getActivity());
        }
