...
public class AllFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    public void setSession(SubAppsSession session) {
        this.session = (WalletStoreSubAppSession) session;
    }
    ...
    public void onCreate(Bundle savedInstance) {
        ...
        } catch (CantGetRefinedCatalogException ex) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new AppListAdapter(getActivity(), R.layout.wallet_store_activity_store_front_grid_item, mlist);
