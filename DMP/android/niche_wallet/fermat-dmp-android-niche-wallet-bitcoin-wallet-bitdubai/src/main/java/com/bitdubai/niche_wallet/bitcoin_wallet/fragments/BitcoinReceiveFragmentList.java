 ...
 */
public class BitcoinReceiveFragmentList extends Fragment {
    ...
    public static BitcoinReceiveFragmentList newInstance(int position) {
        BitcoinReceiveFragmentList f = new BitcoinReceiveFragmentList();
        Bundle b = new Bundle();
