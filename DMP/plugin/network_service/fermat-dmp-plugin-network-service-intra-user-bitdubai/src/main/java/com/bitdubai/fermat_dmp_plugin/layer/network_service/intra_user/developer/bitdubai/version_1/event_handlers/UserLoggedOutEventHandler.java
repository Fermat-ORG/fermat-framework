...
/**
 * The Class <code>com.bitdubai.fermat_ccp_plugin.layer.network_service.intra_user.developer.bitdubai.version_1.event_handlers.UserLoggedOutEventHandler</code> have
 ...
 * @since Java JDK 1.7
 */
public class UserLoggedOutEventHandler implements FermatEventHandler {
    ...
    public void handleEvent(FermatEvent fermatEvent) throws FermatException {
        ...
        if (((Service) this.intraUserManager).getStatus() == ServiceStatus.STARTED) {
             ...
             */
            //((IntraUserNetworkServicePluginRoot) this.intraUserManager).logIn(((IntraUserLoggedOutEvent) fermatEvent).getIntraUserId());
