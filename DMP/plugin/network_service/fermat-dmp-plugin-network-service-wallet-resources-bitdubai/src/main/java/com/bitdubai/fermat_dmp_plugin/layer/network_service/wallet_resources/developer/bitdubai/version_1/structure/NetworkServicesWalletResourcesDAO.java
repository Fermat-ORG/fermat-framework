...
import com.bitdubai.fermat_dmp_plugin.layer.network_service.wallet_resources.developer.bitdubai.version_1.exceptions.CantGetRepositoryPathRecordException;
...
public class NetworkServicesWalletResourcesDAO {
    ...
    private Repository getRepository(String repositoryName,UUID skinId) throws CantGetRepositoryPathRecordException, RepositoryNotFoundException {

        DatabaseTableRecord databaseTableRecord= getRepositoryDatabaseTableRecord(repositoryName,skinId);
        String pathToRepo = databaseTableRecord.getStringValue(NetworkserviceswalletresourcesDatabaseConstants.REPOSITORIES_PATHTOREPO_COLUMN_NAME);
        String navigationStructureVersion = databaseTableRecord.getStringValue(NetworkserviceswalletresourcesDatabaseConstants.REPOSITORIES_NAVIGATION_STRUCTURE_VERSION_COLUMN_NAME);
    ...
    private DatabaseTable getRepositoriesTable(){
        return database.getTable(NetworkserviceswalletresourcesDatabaseConstants.REPOSITORIES_TABLE_NAME);
    }
    ...
    public void createRepository(Repository repository,UUID skinId) throws CantCreateRepositoryException {
        ...
        if (repository == null && repository.getPath() != null && repository.getSkinName() != null && repository.getNavigationStructureVersion() != null){
        ...
        try {
            ...
            entityRecord.setUUIDValue(NetworkserviceswalletresourcesDatabaseConstants.REPOSITORIES_SKINID_COLUMN_NAME, skinId);
            ...
            entityRecord.setStringValue(NetworkserviceswalletresourcesDatabaseConstants.REPOSITORIES_PATHTOREPO_COLUMN_NAME, repository.getPath());
    ...
    public void delete(UUID skinId,String repositoryName) throws CantDeleteRepositoryException, ProjectNotFoundException, RepositoryNotFoundException {
    ...
    private DatabaseTableRecord getRepositoryDatabaseTableRecord(DatabaseTable repositoryTable,UUID skinId,String repositoryName) throws CantLoadTableToMemoryException, RepositoryNotFoundException {
        repositoryTable.setUUIDFilter(NetworkserviceswalletresourcesDatabaseConstants.REPOSITORIES_SKINID_COLUMN_NAME, skinId, DatabaseFilterType.EQUAL);
        repositoryTable.setStringFilter(NetworkserviceswalletresourcesDatabaseConstants.REPOSITORIES_NAME_COLUMN_NAME, repositoryName, DatabaseFilterType.EQUAL);
