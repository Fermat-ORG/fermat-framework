package com.bitdubai.fermat_ccp_plugin.layer.identity.publisher.publisher.bitdubai.version_1.database;
...
/**
 *  The Class  <code>com.bitdubai.fermat_pip_plugin.layer.identity.developer.developer.bitdubai.version_1.structure.PublisherIdentityDatabaseFactory</code>
 ...
 * @since Java JDK 1.7
 */
public class PublisherIdentityDatabaseFactory implements DealsWithPluginDatabaseSystem {
     ...
     */
    public PublisherIdentityDatabaseFactory(PluginDatabaseSystem pluginDatabaseSystem) {
    ...
    public Database createDatabase(UUID ownerId, String databaseName) throws CantCreateDatabaseException {
        ...
        try {
            ...
            table = databaseFactory.newTableFactory(ownerId, PublisherIdentityDatabaseConstants.PUBLISHER_TABLE_NAME);
