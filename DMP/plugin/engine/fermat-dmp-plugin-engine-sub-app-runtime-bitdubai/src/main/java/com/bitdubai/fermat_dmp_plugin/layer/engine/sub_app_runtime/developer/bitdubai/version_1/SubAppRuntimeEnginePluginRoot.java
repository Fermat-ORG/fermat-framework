...
//            runtimeActivity.setBackActivity(Activities.DAP_SUB_APP_REDEEM_POINT_IDENTITY_CREATE_IDENTITY);
    ...
    private void createAssetUserCommunitySubAppNavigationStructure() {
        ...
        runtimeMenuItem = new MenuItem();
        runtimeMenuItem.setLabel("Settings");
        runtimeMenuItem.setLinkToActivity(Activities.DAP_SUB_APP_ASSET_USER_COMMUNITY_SETTINGS);
        runtimeMenuItem.setAppLinkPublicKey(communityUserPublicKey);
        runtimeSideMenu.addMenuItem(runtimeMenuItem);
        ...
        runtimeActivity = new Activity();
        runtimeActivity.setType(Activities.DAP_ASSET_USER_COMMUNITY_CONNECTION_LIST_OTHER_PROFILE);
        runtimeActivity.setActivityType(Activities.DAP_ASSET_USER_COMMUNITY_CONNECTION_LIST_OTHER_PROFILE.getCode());
        runtimeActivity.setBackActivity(Activities.DAP_ASSET_USER_COMMUNITY_CONNECTIONS_LIST);
        runtimeActivity.setBackPublicKey(communityUserPublicKey);
        runtimeActivity.setColor("#FF0B46F0");
        ...
        runtimeActivity = new Activity();
        runtimeActivity.setType(Activities.DAP_SUB_APP_ASSET_USER_COMMUNITY_SETTINGS);
        runtimeActivity.setActivityType(Activities.DAP_SUB_APP_ASSET_USER_COMMUNITY_SETTINGS.getCode());
        runtimeActivity.setBackActivity(Activities.DAP_ASSET_USER_COMMUNITY_ACTIVITY_MAIN);
        runtimeActivity.setBackPublicKey(communityUserPublicKey);
        runtimeActivity.setColor("#FF0B46F0");
    ...
    private void createRedeemPointCommunitySubAppNavigationStructure() {
        ...
        runtimeMenuItem = new MenuItem();
        runtimeMenuItem.setLabel("Settings");
        runtimeMenuItem.setLinkToActivity(Activities.DAP_SUB_APP_REDEEM_POINT_COMMUNITY_SETTINGS);
        runtimeMenuItem.setAppLinkPublicKey(communityRedeemPointPublicKey);
        runtimeSideMenu.addMenuItem(runtimeMenuItem);
        ...
        runtimeActivity = new Activity();
        runtimeActivity.setType(Activities.DAP_SUB_APP_REDEEM_POINT_COMMUNITY_SETTINGS);
        runtimeActivity.setActivityType(Activities.DAP_SUB_APP_REDEEM_POINT_COMMUNITY_SETTINGS.getCode());
        runtimeActivity.setBackActivity(Activities.DAP_ASSET_REDEEM_POINT_COMMUNITY_ACTIVITY_MAIN);
        runtimeActivity.setBackPublicKey(communityRedeemPointPublicKey);
        runtimeActivity.setColor("#FF0B46F0");
