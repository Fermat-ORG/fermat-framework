 ...
 */
public class CreateIntraUserTest {
    ...
    public void setUpMockitoRules()  throws Exception{
        ...
        when(mockIntraUserIdentityManager.createNewIntraUser(intraUserAlias,null)).thenReturn(mockIntraUserIdentity);
    ...
    public void createIntraUserTest_CreateOk_throwsCouldNotCreateIntraUserException() throws Exception{
        ...
        testIntraUser=testIntraUserModulePluginRoot.createIntraUser(intraUserAlias, null);
    ...
    @Test
    public void createIntraUserTest_GeneralException_throwsCouldNotCreateIntraUserException() throws Exception{
