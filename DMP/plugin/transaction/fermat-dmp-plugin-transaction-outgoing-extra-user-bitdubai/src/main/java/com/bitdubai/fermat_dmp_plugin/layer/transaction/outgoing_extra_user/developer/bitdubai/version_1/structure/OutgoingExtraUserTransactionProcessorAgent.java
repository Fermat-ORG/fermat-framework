 ...
 */
public class OutgoingExtraUserTransactionProcessorAgent extends FermatAgent implements TransactionAgent {
        ...
        */
        ...
        for(TransactionWrapper transaction : transactionList){
            ...
            try {
                ...
                TransactionHandler.handleTransaction(transaction, cryptoVaultManager, cryptoStatus, bitcoinWalletWallet, this.dao,this.errorManager);
