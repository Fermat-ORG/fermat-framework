 ...
 */
public class IncomingCryptoOnCryptoNetworkWaitingTransferenceIntraUserEventHandler implements EventHandler {
    IncomingIntraUserEventRecorderService incomingIntraUserEventRecorderService;

    public IncomingCryptoOnCryptoNetworkWaitingTransferenceIntraUserEventHandler(IncomingIntraUserEventRecorderService incomingIntraUserEventRecorderService){
