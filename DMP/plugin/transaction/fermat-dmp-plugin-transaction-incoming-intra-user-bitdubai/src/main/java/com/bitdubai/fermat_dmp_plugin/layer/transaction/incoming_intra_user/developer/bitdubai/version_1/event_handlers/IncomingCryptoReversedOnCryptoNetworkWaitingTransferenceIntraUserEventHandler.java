...
public class IncomingCryptoReversedOnCryptoNetworkWaitingTransferenceIntraUserEventHandler implements FermatEventHandler {
    ...
    public IncomingCryptoReversedOnCryptoNetworkWaitingTransferenceIntraUserEventHandler(IncomingIntraUserEventRecorderService incomingIntraUserEventRecorderService){
