...
public class IncomingIntraUserRelayAgent {
    ...
    public void start() throws CantStartIncomingIntraUserRelayAgentException {
        ...
        try {
            ...
            throw new CantStartIncomingIntraUserRelayAgentException(CantStartIncomingIntraUserRelayAgentException.DEFAULT_MESSAGE, FermatException.wrapException(exception), null, "You should inspect the cause");
        }
    }
    ...
    private static class RelayAgent implements Runnable  {
        ...
        private IncomingIntraUserTransactionHandler transactionHandler;
        ...
        private void initialize () {
            this.transactionHandler = new IncomingIntraUserTransactionHandler(this.eventManager,this.bitcoinWalletManager,this.cryptoAddressBookManager);
        }
