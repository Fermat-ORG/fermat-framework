...
import com.bitdubai.fermat_dmp_plugin.layer.transaction.incoming_intra_user.developer.bitdubai.version_1.util.IncomingIntraUserTransactionExecutorFactory;
...
public class IncomingIntraUserTransactionHandler {
    ...
    public void handleTransaction(TransactionCompleteInformation transaction) throws CantGetCryptoAddressBookRecordException, CantLoadWalletException, IncomingIntraUserCantExecuteTransactionException {
        try {
            try {
                ...
                IncomingIntraUserTransactionExecutorFactory executorFactory = new IncomingIntraUserTransactionExecutorFactory(this.bitcoinWalletManager, this.cryptoAddressBookManager);
        ...
        } catch (IncomingIntraUserCantExecuteTransactionException | CantGetCryptoAddressBookRecordException | CantLoadWalletException e){
            throw e;
