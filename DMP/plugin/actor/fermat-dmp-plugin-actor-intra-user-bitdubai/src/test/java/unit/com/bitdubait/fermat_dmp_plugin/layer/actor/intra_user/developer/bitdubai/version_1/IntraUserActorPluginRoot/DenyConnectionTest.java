...
public class DenyConnectionTest extends TestCase
{
    ...
    @Test
    public void denyConnectionTest_UpdateStatusOk_ThrowsCantDenyConnectionException() throws Exception {

        catchException(testIntraUserActorPluginRoot).denyConnection(intraUserLoggedPublicKey, intraUserPublicKey);
        assertThat(caughtException()).isNull();
    }


    @Test
    public void denyConnectionTest_UpdateStatusError_throwsCantDenyConnectionException() throws Exception {
        ...
        assertThat(caughtException())
                .isNotNull()
                .isInstanceOf(CantDenyConnectionException.class);
