...
public class AskIntraUserForAcceptanceTest extends TestCase
{
    ...
    @Test
    public void askIntraUserForAcceptanceTest_CreatedOk_ThrowsCantCreateIntraUserException() throws Exception {

        catchException(testIntraUserActorPluginRoot).askIntraUserForAcceptance(intraUserLoggedPublicKey, intraUserAlias, intraUserPublicKey, intraUserImageProfile);
        assertThat(caughtException()).isNull();
    }


   @Test
    public void askIntraUserForAcceptanceTest_CreateError_throwsCantCreateIntraUserException() throws Exception {
