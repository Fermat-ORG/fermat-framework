...
public class DisconnectIntraUserTest extends TestCase
{
    ...
    @Test
    public void disconnectIntraUserTest_UpdateStatusOk_ThrowsCantDisconnectIntraUserException() throws Exception {

        catchException(testIntraUserActorPluginRoot).disconnectIntraUser(intraUserLoggedPublicKey, intraUserPublicKey);
        assertThat(caughtException()).isNull();
    }


    @Test
    public void disconnectIntraUserTest_UpdateStatusError_throwsCantDisconnectIntraUserException() throws Exception {
        ...
        assertThat(caughtException())
                .isNotNull()
                .isInstanceOf(CantDisconnectIntraUserException.class);
