...
public class ReceivingIntraUserRequestConnectionTest extends TestCase
{
    ...
    public void receivingIntraUserRequestConnectionTest_GetListOk_ThrowsCantCreateIntraUserException() throws Exception {
        ...
        catchException(testIntraUserActorPluginRoot).receivingIntraUserRequestConnection(intraUserLoggedPublicKey, intraUserAlias, intraUserPublicKey, intraUserImageProfile);
