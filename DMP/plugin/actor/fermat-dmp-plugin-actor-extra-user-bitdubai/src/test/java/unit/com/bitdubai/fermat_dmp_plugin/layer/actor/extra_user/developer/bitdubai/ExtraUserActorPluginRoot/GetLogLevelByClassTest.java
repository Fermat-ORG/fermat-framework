package unit.com.bitdubai.fermat_ccp_plugin.layer.actor.extra_user.developer.bitdubai.ExtraUserActorPluginRoot;
...
public class GetLogLevelByClassTest {
    ...
    public void getLogLevelByClassTest() throws CantStartPluginException {
        ...
        assertThat(pluginRoot.getLogLevelByClass("com.bitdubai.fermat_ccp_plugin.layer.actor.extra_user.developer.bitdubai.version_1.ExtraUserActorPluginRoot")).isNull();
    }
}
