...
public class CexioProvider implements CryptoIndexProvider {
    public String getUrlAPI(String pair) {return "https://cex.io/api/ticker/"+pair;}
    public String getUrlAPIHistorical(String pair) {return "https://cex.io/api/trade_history/"+pair;}
    @Override
    ...
    public double getHistoricalExchangeRate(CryptoCurrency cryptoCurrency, FiatCurrency fiatCurrency, long time) throws FiatCurrencyNotSupportedException, CryptoCurrencyNotSupportedException, CantGetHistoricalExchangeRateException, HistoricalExchangeRateNotFoundException {
        ...
        try {
            ...
            new CantGetJsonObjectException(CantGetJsonObjectException.DEFAULT_MESSAGE,e,"Crypto Index Cexio Provider","Cant Get JsonObject Exception");
        } catch (CantGetBufferedReaderException e) {
            new CantGetBufferedReaderException(CantGetBufferedReaderException.DEFAULT_MESSAGE,e,"Crypto Index Cexio Provider","Cant Get BufferedReader Exception");
        } catch (CantGetInputStreamException e) {
            new CantGetInputStreamException(CantGetInputStreamException.DEFAULT_MESSAGE,e,"Crypto Index Cexio Provider","Cant Get InputStream Exception");
        }catch (Exception e){
        new CantGetHistoricalExchangeRateException(CantGetHistoricalExchangeRateException.DEFAULT_MESSAGE,e,"Crypto Index CexioProvider ","Cant Ge tHistorical ExchangeRate Exception");
    }
