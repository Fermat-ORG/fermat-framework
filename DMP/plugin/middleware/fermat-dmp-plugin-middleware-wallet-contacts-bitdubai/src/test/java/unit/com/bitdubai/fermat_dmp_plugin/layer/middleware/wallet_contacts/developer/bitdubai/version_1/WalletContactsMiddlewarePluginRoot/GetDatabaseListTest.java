...
private WalletContactsMiddlewarePluginRoot pluginRoot;
        ...
        public void getDatabaseListTest() throws Exception {
            ...
            List<DeveloperDatabase> developerDatabaseList = pluginRoot.getDatabaseList(developerObjectFactory);

            assertThat(developerDatabaseList).isInstanceOf(List.class);
