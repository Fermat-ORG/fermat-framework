...
/**
 * The Class <code>com.bitdubai.fermat_dmp_plugin.layer.middleware.wallet_publisher.developer.bitdubai.version_1.structure.MiddlewareInformationPublishedComponent</code> is the
 ...
 * @since Java JDK 1.7
 */
public class DetailVersionMiddlewareInformationPublishedComponent implements InformationPublishedComponent {
     ...
     * Constructor
     */
    public DetailVersionMiddlewareInformationPublishedComponent(){
        super();
    }
    ...
    /**
     * (non-Javadoc)
     * @see InformationPublishedComponent#getCatalogId()
     */
    @Override
