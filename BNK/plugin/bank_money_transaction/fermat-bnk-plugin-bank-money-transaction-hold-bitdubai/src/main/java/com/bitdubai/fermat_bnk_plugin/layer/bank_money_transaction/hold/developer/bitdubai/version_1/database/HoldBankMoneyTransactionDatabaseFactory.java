...
public class HoldBankMoneyTransactionDatabaseFactory implements DealsWithPluginDatabaseSystem {
    ...
    protected Database createDatabase(UUID ownerId, String databaseName) throws CantCreateDatabaseException {
        ...
        try {
            ...
            table.addColumn(HoldBankMoneyTransactionDatabaseConstants.HOLD_ACCOUNT_NUMBER_COLUMN_NAME, DatabaseDataType.LONG_INTEGER, 0, Boolean.FALSE);
            ...
            table.addColumn(HoldBankMoneyTransactionDatabaseConstants.HOLD_TIMESTAMP_COLUMN_NAME, DatabaseDataType.LONG_INTEGER, 0, Boolean.FALSE);
