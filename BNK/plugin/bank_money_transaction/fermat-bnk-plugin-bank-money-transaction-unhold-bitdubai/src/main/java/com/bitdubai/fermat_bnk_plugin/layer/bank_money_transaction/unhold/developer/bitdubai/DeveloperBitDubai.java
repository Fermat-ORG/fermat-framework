package com.bitdubai.fermat_bnk_plugin.layer.bank_money_transaction.unhold.developer.bitdubai;
...
public class DeveloperBitDubai extends AbstractPluginDeveloper implements PluginLicensor {
    ...
    public void start() throws CantStartPluginDeveloperException {
        try {
            ...
            this.registerVersion(new UnholdBankMoneyTransactionPluginRoot());
