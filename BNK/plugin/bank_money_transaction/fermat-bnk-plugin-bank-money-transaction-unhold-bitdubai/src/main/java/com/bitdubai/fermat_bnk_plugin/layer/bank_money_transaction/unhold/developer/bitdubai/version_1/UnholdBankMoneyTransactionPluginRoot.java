...
public class UnholdBankMoneyTransactionPluginRoot extends AbstractPlugin implements DatabaseManagerForDevelopers,UnholdManager {
    ...
    public void start() throws CantStartPluginException {
        ...
        processorAgent = new UnholdBankMoneyTransactionProcessorAgent(errorManager, unholdTransactionManager);
    ...
    public List<DeveloperDatabaseTableRecord> getDatabaseTableContent(DeveloperObjectFactory developerObjectFactory, DeveloperDatabase developerDatabase, DeveloperDatabaseTable developerDatabaseTable) {
        ...
        try {
            ...
            FermatException e = new CantInitializeUnholdBankMoneyTransactionDatabaseException("Database cannot be initialized", cantInitializeException, "CashMoneyTransactionHoldPluginRoot", "");
