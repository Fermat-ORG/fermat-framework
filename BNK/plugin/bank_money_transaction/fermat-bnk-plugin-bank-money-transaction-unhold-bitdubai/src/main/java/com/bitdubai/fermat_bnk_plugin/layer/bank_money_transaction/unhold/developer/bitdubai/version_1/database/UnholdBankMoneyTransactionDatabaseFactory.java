...
public class UnholdBankMoneyTransactionDatabaseFactory implements DealsWithPluginDatabaseSystem {
    ...
    protected Database createDatabase(UUID ownerId, String databaseName) throws CantCreateDatabaseException {
        ...
        try {
            ...
            table.addColumn(UnholdBankMoneyTransactionDatabaseConstants.UNHOLD_ACCOUNT_NUMBER_COLUMN_NAME, DatabaseDataType.LONG_INTEGER, 0, Boolean.FALSE);
            ...
            table.addColumn(UnholdBankMoneyTransactionDatabaseConstants.UNHOLD_TIMESTAMP_COLUMN_NAME, DatabaseDataType.LONG_INTEGER, 0, Boolean.FALSE);
