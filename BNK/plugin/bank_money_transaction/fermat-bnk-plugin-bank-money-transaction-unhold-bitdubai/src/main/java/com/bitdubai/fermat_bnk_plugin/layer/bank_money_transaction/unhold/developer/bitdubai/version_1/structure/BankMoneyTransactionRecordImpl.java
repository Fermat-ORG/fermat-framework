...
public class BankMoneyTransactionRecordImpl implements BankMoneyTransactionRecord {
    ...
    public BankMoneyTransactionRecordImpl(UnholdBankMoneyTransactionPluginRoot pluginRoot,UUID bankTransactionId, String balanceType, String transactionType, float amount, String cashCurrencyType, String bankOperationType, String bankDocumentReference, String bankName, String bankAccountNumber, String bankAccountType, long runningBookBalance, long runningAvailableBalance, long timeStamp, String memo, String status) {
