...
.  a Plug-in Framework for developing and running distributed financial applications and wallets (view link:https://github.com/bitDubai/fermat/blob/master/fermat-book/book-glossary.asciidoc#wallet[wallet definition]). +
