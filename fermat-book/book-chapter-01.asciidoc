...
the _Fermat Core Platform_ is the part of the system which initilizes the entire set of modules, starting every plugin and putting them to run. This creates the interconection that let all the services to be offered as being integral part of one unified system.
The basic services ::
