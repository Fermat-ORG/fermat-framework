...
At first hand, it serves as a digital registration in a wallet component of an end user's available stock of money in bank notes that he needs to keep track of for future  reference. This tends to build a traceability of these funds when participating in future transactions.  
