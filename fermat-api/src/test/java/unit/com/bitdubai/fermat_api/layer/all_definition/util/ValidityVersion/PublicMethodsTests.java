...
public class PublicMethodsTests {
    ...
    public void isValidInPlatformTest() throws InvalidParameterException {
        ...
        VersionCompatibility validityVersion = new VersionCompatibility(new Version("0.2.0"), new Version(2,0,0));
        Assert.assertTrue(validityVersion.isValidInPlatform());


        validityVersion = new VersionCompatibility(new Version("1.2.0"), new Version(2,0,0));
    ...
    public void invalidaValidityVersionsTest() throws InvalidParameterException {
        ...
        VersionCompatibility validityVersion = new VersionCompatibility(new Version("3.2.0"), new Version(2,0,0));
    }

    public void isValidInObjectVersionTest() throws InvalidParameterException {

        VersionCompatibility validityVersion = new VersionCompatibility(new Version("1.2.0"), new Version(2,0,0));
