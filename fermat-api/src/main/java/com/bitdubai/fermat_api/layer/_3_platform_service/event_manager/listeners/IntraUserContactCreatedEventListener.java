 ...
 */
public class IntraUserContactCreatedEventListener implements EventListener {
    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public IntraUserContactCreatedEventListener(EventType eventType, EventMonitor eventMonitor){
