...
import com.bitdubai.fermat_api.layer.dmp_middleware.wallet_contacts.exceptions.CantAddCryptoAddressException;
import com.bitdubai.fermat_api.layer.dmp_middleware.wallet_contacts.exceptions.CantCreateWalletContactException;
import com.bitdubai.fermat_api.layer.dmp_middleware.wallet_contacts.exceptions.CantDeleteCryptoAddressException;
...
public interface WalletContactsRegistry {
     ...
     *
     * @throws CantAddCryptoAddressException if something goes wrong.
    ...
    void addCryptoAddressToWalletContact(UUID          contactId,
                                         CryptoAddress cryptoAddress) throws CantAddCryptoAddressException, WalletContactNotFoundException;
    ...
    void deleteCryptoAddressToWalletContact(UUID          contactId,
                                            CryptoAddress cryptoAddress) throws CantDeleteCryptoAddressException, WalletContactNotFoundException;
