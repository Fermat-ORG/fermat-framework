...
public enum FiatCurrency {
    ...
    public static FiatCurrency getByCode(String code) throws InvalidParameterException {
        ...
        switch (code) {
            ...
            default: throw new InvalidParameterException(InvalidParameterException.DEFAULT_MESSAGE, null, "Code Received: " + code, "This Code Is Not Valid for the FiatCurrency enum");
