 ...
 */
public class IncomingCryptoIdentifiedEventListener implements EventListener {

    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public IncomingCryptoIdentifiedEventListener(EventType eventType, EventMonitor eventMonitor){
