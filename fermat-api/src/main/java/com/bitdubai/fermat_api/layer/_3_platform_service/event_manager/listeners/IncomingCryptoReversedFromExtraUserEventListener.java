 ...
 */
public class IncomingCryptoReversedFromExtraUserEventListener implements EventListener {

    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public IncomingCryptoReversedFromExtraUserEventListener(EventType eventType, EventMonitor eventMonitor){
