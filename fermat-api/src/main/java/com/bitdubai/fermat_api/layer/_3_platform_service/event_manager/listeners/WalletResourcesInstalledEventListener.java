 ...
 */
public class WalletResourcesInstalledEventListener implements EventListener {

    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public WalletResourcesInstalledEventListener(EventType eventType, EventMonitor eventMonitor){
