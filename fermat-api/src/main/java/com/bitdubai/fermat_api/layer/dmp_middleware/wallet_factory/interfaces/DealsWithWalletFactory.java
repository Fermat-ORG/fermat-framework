 ...
 * indicates that the plugin needs the functionality of a WalletDescriptorFactoryProjectManager
 * <p/>
 *
...
public interface DealsWithWalletFactory {
     ...
     */
    void setWalletDescriptorFactoryProjectManager(WalletDescriptorFactoryProjectManager walletDescriptorFactoryProjectManager);
}
