...
public enum WalletsPublicKeys implements FermatEnum {
    ...
    public static WalletsPublicKeys getByCode(String code) throws InvalidParameterException {
        ...
        switch (code){
            //TODO BNK Platform
            case "banking_wallet":          return BNK_BANKING_WALLET           ;
            //TODO CSH Platform
            case "cash_wallet":             return CSH_MONEY_WALLET             ;
            //TODO CBP Platform
            case "crypto_broker_wallet":    return CBP_CRYPTO_BROKER_WALLET     ;
            case "crypto_customer_wallet":  return CBP_CRYPTO_CUSTOMER_WALLET   ;
            //TODO CCP Platform
            case "reference_wallet":        return CCP_REFERENCE_WALLET         ;
            case "loss_protected_wallet":   return CCP_LOSS_PROTECTED_WALLET    ;
            case "fermat_wallet":           return CCP_FERMAT_WALLET            ;
            //TODO DAP Platform
