...
public enum EventType {
    ...
    INCOMING_EXTRA_USER_ON_CRYPTO_NETWORK("IEUOCN"),
    INCOMING_EXTRA_USER_ON_BLOCKCHAIN("IEUOCN"),
    INCOMING_EXTRA_USER_REVERSED_ON_CRYPTO_NETWORK("IEUROCN"),
    INCOMING_EXTRA_USER_REVERSED_ON_BLOCKCHAIN("IEUROCN");
    ...
    public static EventType getByCode(String code) throws InvalidParameterException {
        ...
        switch (code) {
            ...
            case "IUCC":
                return EventType.INTRA_USER_DISCONNECTION_REQUEST_RECEIVED;
            case "IUCA":
                return EventType. INTRA_USER_CONNECTION_ACCEPTED;
            case "IURCR":
                return EventType. INTRA_USER_REQUESTED_CONNECTION_RECEIVED ;
            case "IURCRN":
                return EventType.INTRA_USER_REQUESTED_CONNECTION_RECEIVED_NOTIFICATION;
            case "IUCD":
                return EventType.INTRA_USER_CONNECTION_DENIED;
            case "IUCAN":
                return EventType.INTRA_USER_CONNECTION_ACCEPTED_NOTIFICATION;
            case "IURC":
                return EventType.INTRA_USER_REQUESTED_CONNECTION;
            case "IUCRRN":
                return EventType.INTRA_USER_CONNECTION_REQUEST_RECEIVED_NOTIFICATION;
