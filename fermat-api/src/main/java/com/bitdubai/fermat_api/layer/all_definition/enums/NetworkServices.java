...
public enum NetworkServices {
    ...
    public static NetworkServices getByCode(String code) throws InvalidParameterException {
        ...
        switch (code){
            ...
            case "TEMPLATE":
                return NetworkServices.TEMPLATE;
            case "UNDEF":
                return NetworkServices.UNDEFINED;
            case "BNOTES":
                return NetworkServices.BANK_NOTES;
            case "CRYPTADD":
                return NetworkServices.CRYPTO_ADDRESSES;
            case "IUS":
                return NetworkServices.INTRA_USER;
            case "MONEY":
                return NetworkServices.MONEY;
            case "WALLCOMM":
                return NetworkServices.WALLET_COMMUNITY;
            case "WALLRES":
                return NetworkServices.WALLET_RESOURCES;
            case "WALLSTO":
                return NetworkServices.WALLET_STORE;
            default:
