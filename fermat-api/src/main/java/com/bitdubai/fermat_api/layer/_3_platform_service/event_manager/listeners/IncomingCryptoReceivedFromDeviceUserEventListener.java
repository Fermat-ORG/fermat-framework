 ...
 */
public class IncomingCryptoReceivedFromDeviceUserEventListener implements EventListener {

    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public IncomingCryptoReceivedFromDeviceUserEventListener(EventType eventType, EventMonitor eventMonitor){
