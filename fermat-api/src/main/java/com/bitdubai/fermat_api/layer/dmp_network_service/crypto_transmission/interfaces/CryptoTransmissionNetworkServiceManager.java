...
import com.bitdubai.fermat_api.layer.dmp_network_service.crypto_transmission.enums.CryptoTransmissionState;
...
public interface CryptoTransmissionNetworkServiceManager extends TransactionProtocolManager<FermatCryptoTransaction> {
     ...
     */
    public CryptoTransmissionState getState(UUID identifier);
