...
public enum ScreenOrientation {
    ...
    public static ScreenOrientation getByCode(String code) throws InvalidParameterException {
        ...
        switch (code) {
            ...
            default:
                throw new InvalidParameterException(InvalidParameterException.DEFAULT_MESSAGE, null, "Code Received: " + code, "This Code Is Not Valid for the ScreenOrientation enum");
