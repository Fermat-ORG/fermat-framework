...
public enum SubAppsPublicKeys implements FermatEnum {
    ...
    CHT_CHAT_IDENTITY           ("sub_app_cht_identity_chat"),
    ...
    public static SubAppsPublicKeys getByCode(String code) throws InvalidParameterException {
        ...
        switch (code){
            ...
            case "sub_app_cht_identity_chat":             return CHT_CHAT_IDENTITY  ;
            //TODO CBP Platform
            ...
            //TODO CWP Platform
            case "public_key_factory":                      return CWP_FACTORY              ;
            case "public_key_publisher":                    return CWP_PUBLISHER            ;
            case "public_key_wallet_manager":               return CWP_MANAGER              ;
            case "public_key_runtime":                      return CWP_RUNTIME              ;
            case "public_key_shell":                        return CWP_SHEL_LOGIN           ;
            case "public_key_store":                        return CWP_STORE                ;
            //TODO DAP Platform
