 ...
 */
public class IncomingCryptoReceptionConfirmedFromDeviceUserEventListener implements EventListener {

    EventMonitor eventMonitor;
    private EventType eventType;
    private EventHandler eventHandler;

    public IncomingCryptoReceptionConfirmedFromDeviceUserEventListener(EventType eventType, EventMonitor eventMonitor){
