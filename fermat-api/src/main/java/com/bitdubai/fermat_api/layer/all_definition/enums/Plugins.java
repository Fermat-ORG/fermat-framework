...
public enum Plugins implements FermatEnum {
    ...
    public static Plugins getByKey(String code) throws InvalidParameterException {
        switch (code) {
            ...
            case "BCCPCPRNS":
                return BITDUBAI_CCP_CRYPTO_PAYMENT_REQUEST_NETWORK_SERVICE;
            case "BCCPCTNS":
                return BITDUBAI_CCP_CRYPTO_TRANSMISSION_NETWORK_SERVICE;
            case "BCCPIWUA":
                return BITDUBAI_CCP_INTRA_WALLET_USER_ACTOR;
            case "BCCPIUI":
                return BITDUBAI_CCP_INTRA_WALLET_USER_IDENTITY;
            case "BCCPWCM":
                return BITDUBAI_CCP_WALLET_CONTACTS_MIDDLEWARE;
            case "BCCPCPR":
                return BITDUBAI_CCP_CRYPTO_PAYMENT_REQUEST;
            case "BCCPOIAT":
                return BITDUBAI_CCP_OUTGOING_INTRA_ACTOR_TRANSACTION;
            case "BCTNS":
                return BITDUBAI_CCP_CRYPTO_CRYPTO_TRANSMISSION_NETWORK_SERVICE;
