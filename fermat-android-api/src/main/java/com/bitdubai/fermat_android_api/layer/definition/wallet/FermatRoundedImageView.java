...
public class FermatRoundedImageView extends ImageView {
    ...
    public static Bitmap getCroppedBitmap(Bitmap bmp, int radius) {
        ...
        canvas.drawBitmap(getRoundedRectBitmap(bmp, 32), rectSrc, rectSrc, paint);
    ...
    public static Bitmap getRoundedRectBitmap(Bitmap bitmap, int pixels) {
        ...
        try {
            returnBitmap = Bitmap.createBitmap(bitmap.getWidth(), bitmap.getHeight(), Bitmap.Config.ARGB_8888);
