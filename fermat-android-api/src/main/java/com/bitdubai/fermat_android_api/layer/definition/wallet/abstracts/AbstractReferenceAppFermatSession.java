 ...
 */
public abstract class AbstractReferenceAppFermatSession<A extends FermatApp,M extends ModuleManager,R extends ResourceProviderManager> implements ReferenceAppFermatSession<A,M> {
    ...
    protected AbstractReferenceAppFermatSession() {
        this.data = new HashMap<>();
    }
