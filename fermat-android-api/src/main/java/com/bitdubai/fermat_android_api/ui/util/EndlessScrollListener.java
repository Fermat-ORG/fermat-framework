...
/**
 * A {@link RecyclerView.OnScrollListener} to manage infinite scroll in recycler view based
 * <a href="https://guides.codepath.com/android/Endless-Scrolling-with-AdapterViews-and-RecyclerView">this article</a>
 * <p/>
 * Created by Nelson Ramirez (nelsonalfo@gmail.com) on 22/06/16.
 */
public class EndlessScrollListener extends RecyclerView.OnScrollListener {
    ...
    public void onScrolled(RecyclerView view, int dx, int dy) {
        ...
        // If we do need to reload some more data, we execute onLoadMoreData to fetch the data.
        // threshold should reflect how many total columns there are too
        if (!loading && (lastVisibleItemPosition + visibleThreshold) > totalItemCount) {
            currentPage++;
            if (onLoadMoreDataListener != null)
                onLoadMoreDataListener.onLoadMoreData(currentPage, totalItemCount);
            loading = true;
        }
    }
