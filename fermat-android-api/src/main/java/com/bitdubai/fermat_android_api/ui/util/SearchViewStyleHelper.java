...
public class SearchViewStyleHelper {
    ...
    public static SearchViewStyleHelper on(final Menu menu, final int id) {
        return new SearchViewStyleHelper(menu, id);
    }

    public static SearchViewStyleHelper on(final SearchView searchView) {
        return new SearchViewStyleHelper(searchView);
    }
    ...
    private SearchViewStyleHelper(final Menu menu, final int id) {
        this((SearchView) menu.findItem(id).getActionView());
    }

    private SearchViewStyleHelper(final SearchView searchView) {
    ...
    public SearchViewStyleHelper setSearchPlateDrawableId(final int id) {
    ...
    public SearchViewStyleHelper setSubmitAreaDrawableId(final int id) {
    ...
    public SearchViewStyleHelper setSearchPlateTint(final int color) {
        final View view = getView(SEARCH_PLATE);
        if (view != null) {
    ...
    public SearchViewStyleHelper setSubmitAreaTint(final int color) {
        final View view = getView(SUBMIT_AREA);
        if (view != null) {
            final Drawable background = view.getBackground();
            if (background != null) {
    ...
    public SearchViewStyleHelper setGoBtnImageResource(final int resId) {
    ...
    public SearchViewStyleHelper setSearchButtonImageResource(final int resId) {
    ...
    public SearchViewStyleHelper setTextColor(final int color) {
    ...
    public SearchViewStyleHelper setHintTextColor(final int color) {
        final AutoCompleteTextView editText = getView(SEARCH_SRC_TEXT);
        if (editText != null) {
    ...
    public SearchViewStyleHelper setSearchHintDrawable(final int id, final String... hint) {
        return setSearchHintDrawable(mSearchView.getContext().getResources().getDrawable(id), hint);
    }

    public SearchViewStyleHelper setSearchHintDrawable(final Drawable drawable, final String... hint) {
        try {
    ...
    public SearchViewStyleHelper setCursorResId(final int drawableId) {
        final AutoCompleteTextView editText = getView(SEARCH_SRC_TEXT);
        if (editText != null) {
            try {
    ...
    public SearchViewStyleHelper setCursorColor(final int color) {
        final AutoCompleteTextView editText = getView(SEARCH_SRC_TEXT);
        if (editText != null) {
            try {
    ...
    public SearchViewStyleHelper setCloseBtnImageResource(final int resId) {
    ...
    public SearchViewStyleHelper setVoiceBtnImageResource(final int resId) {
    ...
    public SearchViewStyleHelper setCommitIcon(final int drawableId) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            try {
