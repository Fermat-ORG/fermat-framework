 ...
 */
public class CashMoneyWalletFragmentFactory extends FermatWalletFragmentFactory<CashMoneyWalletSession, WalletSettings, CashMoneyWalletFragmentsEnumType> {
    @Override
