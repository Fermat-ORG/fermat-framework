...
import com.bitdubai.fermat_csh_plugin.layer.cash_money_transaction.withdrawal.developer.bitdubai.version_1.CashMoneyTransactionWithdrawalPluginRoot;
...
public class CashMoneyTransactionWithdrawalManager implements CashWithdrawalTransactionManager {
    ...
    private final CashMoneyTransactionWithdrawalPluginRoot pluginRoot;
    ...
    public CashMoneyTransactionWithdrawalManager(final CashMoneyWalletManager cashMoneyWalletManager, final PluginDatabaseSystem pluginDatabaseSystem,
                                                 final UUID pluginId, final CashMoneyTransactionWithdrawalPluginRoot pluginRoot) throws CantStartPluginException {
        this.pluginDatabaseSystem = pluginDatabaseSystem;
        this.pluginId = pluginId;
        this.pluginRoot = pluginRoot;
        this.cashMoneyWalletManager = cashMoneyWalletManager;

        this.dao = new WithdrawalCashMoneyTransactionDao(pluginDatabaseSystem, pluginId, pluginRoot);
        try {
            dao.initialize();
