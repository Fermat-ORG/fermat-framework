...
public class WithdrawalCashMoneyTransactionDao {
    ...
    public WithdrawalCashMoneyTransactionDao(final PluginDatabaseSystem pluginDatabaseSystem, final UUID pluginId, final CashMoneyTransactionWithdrawalPluginRoot pluginRoot) {
