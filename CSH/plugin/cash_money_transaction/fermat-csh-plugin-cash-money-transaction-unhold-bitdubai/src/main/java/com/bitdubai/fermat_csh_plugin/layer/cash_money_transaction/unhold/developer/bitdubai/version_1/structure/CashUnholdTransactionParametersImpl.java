...
public class CashUnholdTransactionParametersImpl implements CashUnholdTransactionParameters {
    ...
    public CashUnholdTransactionParametersImpl(UUID transactionId, String publicKeyWallet, String publicKeyActor, float amount, FiatCurrency currency, String memo)
    {
