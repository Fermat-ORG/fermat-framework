 ...
 */
public class IncomingCryptoReceptionConfirmedFromIntraUserEventListener implements FermatEventListener {

    FermatEventMonitor fermatEventMonitor;
    private EventType eventType;
    private FermatEventHandler fermatEventHandler;

    public IncomingCryptoReceptionConfirmedFromIntraUserEventListener(EventType eventType, FermatEventMonitor fermatEventMonitor){
