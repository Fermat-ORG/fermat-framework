 ...
 */
public class IncomingCryptoIdentifiedEventListener implements FermatEventListener {

    FermatEventMonitor fermatEventMonitor;
    private EventType eventType;
    private FermatEventHandler fermatEventHandler;

    public IncomingCryptoIdentifiedEventListener(EventType eventType, FermatEventMonitor fermatEventMonitor){
