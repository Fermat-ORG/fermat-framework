...
public class IntraUserLoggedInEvent extends AbstractFermatEvent {
     ...
     * @param eventType
     */
    public IntraUserLoggedInEvent(com.bitdubai.fermat_pip_api.layer.platform_service.event_manager.enums.EventType eventType){
        super(eventType);
    }
     ...
     * @param intraUserId
     */
    public IntraUserLoggedInEvent(com.bitdubai.fermat_pip_api.layer.platform_service.event_manager.enums.EventType eventType, UUID intraUserId) {
        super(eventType);
