 ...
 */
public class IncomingCryptoReversedFromExtraUserEventListener implements FermatEventListener {

    FermatEventMonitor fermatEventMonitor;
    private EventType eventType;
    private FermatEventHandler fermatEventHandler;

    public IncomingCryptoReversedFromExtraUserEventListener(EventType eventType, FermatEventMonitor fermatEventMonitor){
