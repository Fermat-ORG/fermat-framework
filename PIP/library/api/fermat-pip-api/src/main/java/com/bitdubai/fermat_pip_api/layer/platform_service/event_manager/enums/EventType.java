...
import com.bitdubai.fermat_pip_api.layer.platform_service.event_manager.listeners.OutgoingDraftTransactionFinishedNotificationEventListener;
...
//    },
    ...
    OUTGOING_DRAFT_TRANSACTION_FINISHED("ODTF") {
        @Override
        public FermatEventListener getNewListener(FermatEventMonitor fermatEventMonitor) {
            return new OutgoingDraftTransactionFinishedNotificationEventListener(this, fermatEventMonitor);
        }
