 ...
 */
public class ReviewNegotiationEventListener implements FermatEventListener{

    FermatEventMonitor fermatEventMonitor;
    private EventType eventType;
    private FermatEventHandler fermatEventHandler;

    public ReviewNegotiationEventListener(EventType eventType, FermatEventMonitor fermatEventMonitor){
