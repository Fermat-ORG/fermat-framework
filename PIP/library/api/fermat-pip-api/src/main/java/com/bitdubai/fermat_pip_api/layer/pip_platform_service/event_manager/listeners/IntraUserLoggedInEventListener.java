 ...
 */
public class IntraUserLoggedInEventListener implements FermatEventListener {

    FermatEventMonitor fermatEventMonitor;
    private EventType eventType;
    private FermatEventHandler fermatEventHandler;

    public IntraUserLoggedInEventListener(EventType eventType, FermatEventMonitor fermatEventMonitor){
