 ...
 * @since Java JDK 1.7
 */
public class CantGetLogToolException extends FermatException {
    public static final String DEFAULT_MESSAGE = "THE DEVELOPER LOGTOOL HAS TRIGGERED AN EXCEPTION";

    public CantGetLogToolException(final String message, final Exception cause, final String context, final String possibleReason) {
