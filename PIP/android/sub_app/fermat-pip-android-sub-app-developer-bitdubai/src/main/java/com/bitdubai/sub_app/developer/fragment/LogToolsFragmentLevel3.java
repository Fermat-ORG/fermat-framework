 ...
 * @version 1.0
 */
public class LogToolsFragmentLevel3 extends AbstractFermatFragment<ReferenceAppFermatSession<ToolManager>, ResourceProviderManager> {
    ...
    public static LogToolsFragmentLevel3 newInstance() {
        return new LogToolsFragmentLevel3();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            toolManager = appSession.getModuleManager();//.getLogTool();
            ...
            if (convertView == null) {
                ...
                holder.imageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        LogToolsFragmentLevel3 frg = null;
                        frg = (LogToolsFragmentLevel3) getFragmentManager().findFragmentByTag("fragmento2");
