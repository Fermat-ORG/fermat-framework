package com.bitdubai.fermat_pip_plugin.layer.identity_designer.developer.bitdubai.version_1.database;
...
/**
 * The Class <code>com.bitdubai.fermat_pip_plugin.layer.identity_designer.developer.bitdubai.version_1.database.IdentityDesignerDatabaseFactory</code>
...
public class IdentityDesignerDatabaseFactory implements DealsWithErrors, DealsWithPluginDatabaseSystem {
    ...
    public Database createDatabase(UUID pluginId) throws CantCreateDatabaseException {
        ...
        try {
            ...
            database = this.pluginDatabaseSystem.createDatabase(pluginId, IdentityDesignerDatabaseConstants.DESIGNER_DB_NAME);
...
//            ((DatabaseFactory) database).createTable(table);
            ...
            String context = "Designer Identity DataBase Factory: " + cantCreateDatabaseException.getContext();
            String possibleReason = "The exception is thrown the Create Database Designer Identity 'this.platformDatabaseSystem.createDatabase(\"TranslatorIdentity\")'" + cantCreateDatabaseException.getPossibleReason();
            ...
            String context = "Create Table Designer Identity" + cantCreateTableException.getContext();
            String possibleReason = "The exception is generated when creating the table Designer Identity  ((DatabaseFactory) database).createTable(table) " + cantCreateTableException.getPossibleReason();
