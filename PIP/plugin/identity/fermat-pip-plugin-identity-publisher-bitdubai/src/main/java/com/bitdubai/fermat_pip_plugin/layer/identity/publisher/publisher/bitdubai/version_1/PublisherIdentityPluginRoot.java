...
package com.bitdubai.fermat_pip_plugin.layer.identity.publisher.publisher.bitdubai.version_1;
...
import com.bitdubai.fermat_pip_plugin.layer.identity.publisher.publisher.bitdubai.version_1.developerUtils.PublisherIdentityDeveloperDataBaseFactory;
import com.bitdubai.fermat_pip_plugin.layer.identity.publisher.publisher.bitdubai.version_1.exceptions.CantDeliverDatabaseException;
import com.bitdubai.fermat_pip_plugin.layer.identity.publisher.publisher.bitdubai.version_1.exceptions.CantInitializePublisherIdentityDatabaseException;
import com.bitdubai.fermat_pip_plugin.layer.identity.publisher.publisher.bitdubai.version_1.structure.PublisherIdentityDao;
import com.bitdubai.fermat_pip_plugin.layer.identity.publisher.publisher.bitdubai.version_1.structure.PublisherIdentityDatabaseConstants;
import com.bitdubai.fermat_pip_plugin.layer.identity.publisher.publisher.bitdubai.version_1.structure.PublisherIdentityDatabaseFactory;
...
public class PublisherIdentityPluginRoot implements DealsWithDeviceUser, DealsWithErrors, DatabaseManagerForDevelopers, DealsWithLogger, DealsWithPluginDatabaseSystem, DealsWithPluginFileSystem, LogManagerForDevelopers, Service, PublisherIdentityManager, Plugin {
    ...
    public List<PublisherIdentity> getPublishersFromCurrentDeviceUser() throws CantGetUserPublisherIdentitiesException {
        ...
        try {
            ...
            // Check values.
            if (this.dao == null) {
                throw new com.bitdubai.fermat_pip_api.layer.pip_identity.publisher.exceptions.CantGetUserPublisherIdentitiesException("Cant get developers from current device user, Dao object is null.", "Plugin Identity", "Cant get developers from current device user, Dao object is null.");
            }
    ...
    public List<String> getClassesFullPath() {
        ...
        returnedClasses.add("com.bitdubai.fermat_pip_plugin.layer.identity.publisher.publisher.bitdubai.version_1.PublisherIdentityPluginRoot");
        returnedClasses.add("com.bitdubai.fermat_pip_plugin.layer.identity.publisher.publisher.bitdubai.version_1.structure.PublisherIdentityDao");
        returnedClasses.add("com.bitdubai.fermat_pip_plugin.layer.identity.publisher.publisher.bitdubai.version_1.structure.PublisherIdentityDatabaseConstants");
        returnedClasses.add("com.bitdubai.fermat_pip_plugin.layer.identity.publisher.publisher.bitdubai.version_1.structure.PublisherIdentityDatabaseFactory");
        /**
         * I return the values.
         */
