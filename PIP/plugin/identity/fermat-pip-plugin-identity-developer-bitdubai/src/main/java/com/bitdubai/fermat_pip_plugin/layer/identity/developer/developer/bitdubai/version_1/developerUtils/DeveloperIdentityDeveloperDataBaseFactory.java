...
package com.bitdubai.fermat_pip_plugin.layer.identity.developer.developer.bitdubai.version_1.developerUtils;
...
public class DeveloperIdentityDeveloperDataBaseFactory {
    String pluginId;
    String databaseName;

    public DeveloperIdentityDeveloperDataBaseFactory(String pluginId, String databaseNAme) {
    ...
    public static List<DeveloperDatabaseTable> getDatabaseTableList(DeveloperObjectFactory developerObjectFactory) {
        ...
        developerIdentityTableColumns.add("developer_public_key");
        developerIdentityTableColumns.add("developer_private_key");
        developerIdentityTableColumns.add("device_user_public_key");
        developerIdentityTableColumns.add("developer_alias");
