...
public class UninstallSkinForSubAppTest {
    ...
    public void setUpDataBase() throws Exception {
        ...
        String path = "subApp_resources/bitDubai/wallet_factory/skins/default/medium/";
    ...
    public void testUninstallSkinForSubApp_FileNotFoundException() throws Exception{
        ...
        catchException(subAppResourcesInstallationNetworkServicePluginRoot).uninstallSkinForSubApp(UUID.randomUUID(),"subAppPublicKey");
