...
public class GetLanguageFileTest {
    ...
    public void testGetLanguageFile_FileNotFound() throws Exception{
        ...
        catchException(subAppResourcesInstallationNetworkServicePluginRoot).getLanguageFile(any(UUID.class), walletPublicKey, anyString());
        assertThat(caughtException()).isInstanceOf(CantGetLanguageFileException.class);
    }
}
