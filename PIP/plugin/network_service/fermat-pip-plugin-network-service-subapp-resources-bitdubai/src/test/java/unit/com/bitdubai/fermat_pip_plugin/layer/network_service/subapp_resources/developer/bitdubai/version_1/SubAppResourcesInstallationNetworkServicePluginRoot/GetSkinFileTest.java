...
public class GetSkinFileTest {
    ...
    public void testGetSkinFile_FileFound() throws Exception{
        ...
        catchException(subAppResourcesInstallationNetworkServicePluginRoot).getSkinFile(skinId.randomUUID(), "walletPublicKey");
        assertThat(caughtException()).isNull();
    }
    @Test
    public void testGetSkinFile_FileNotFound() throws Exception{
        subAppResourcesInstallationNetworkServicePluginRoot.start();
        catchException(subAppResourcesInstallationNetworkServicePluginRoot).getSkinFile(null, null);
