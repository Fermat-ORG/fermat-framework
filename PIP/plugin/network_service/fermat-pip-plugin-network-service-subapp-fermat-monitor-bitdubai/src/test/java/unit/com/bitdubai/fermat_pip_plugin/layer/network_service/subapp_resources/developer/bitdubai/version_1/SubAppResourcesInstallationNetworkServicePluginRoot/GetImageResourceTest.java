...
//import com.bitdubai.fermat_pip_plugin.layer.network_service.subapp_resources.developer.bitdubai.version_1.SubAppFermatMonitorNetworkServicePluginRoot;
...
//
//    @Mock
//    AbstractAddon mockedAbstractAddon;
//
//
//    /**
...
//
//    SubAppFermatMonitorNetworkServicePluginRoot subAppResourcesNetworkServicePluginRoot;
//    private SubAppResourcesInstallationNetworkServiceDAO subAppResourcesDAO;
//
//    @Before
//    public void setUp() throws Exception {
//        subAppResourcesNetworkServicePluginRoot = new SubAppFermatMonitorNetworkServicePluginRoot();
//
//        when(mockedAbstractAddon.getAddonVersionReference()).thenReturn(new AddonVersionReference(Platforms.OPERATIVE_SYSTEM_API, Layers.SYSTEM, Addons.PLUGIN_FILE_SYSTEM, Developers.BITDUBAI, new Version()));
//        subAppResourcesNetworkServicePluginRoot.assignAddonReference(mockedAbstractAddon);
//
//        when(mockedAbstractAddon.getAddonVersionReference()).thenReturn(new AddonVersionReference(Platforms.OPERATIVE_SYSTEM_API, Layers.SYSTEM, Addons.PLUGIN_DATABASE_SYSTEM, Developers.BITDUBAI, new Version()));
//        subAppResourcesNetworkServicePluginRoot.assignAddonReference(mockedAbstractAddon);
//
//        when(mockedAbstractAddon.getAddonVersionReference()).thenReturn(new AddonVersionReference(Platforms.OPERATIVE_SYSTEM_API, Layers.SYSTEM, Addons.PLUGIN_FILE_SYSTEM, Developers.BITDUBAI, new Version()));
//        subAppResourcesNetworkServicePluginRoot.assignAddonReference(mockedAbstractAddon);
...
//       catchException(subAppResourcesNetworkServicePluginRoot).getImageResource("", UUID.randomUUID(), "");
...
//        subAppResourcesNetworkServicePluginRoot.start();
//        catchException(subAppResourcesNetworkServicePluginRoot).getImageResource(null,null,null);
