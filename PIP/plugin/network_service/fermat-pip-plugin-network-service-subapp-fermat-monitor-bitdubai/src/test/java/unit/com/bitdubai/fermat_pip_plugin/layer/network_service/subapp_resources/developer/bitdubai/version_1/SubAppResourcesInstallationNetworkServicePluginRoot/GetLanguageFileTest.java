...
public class GetLanguageFileTest {
    ...
    public void testGetLanguageFile_FileFound() throws Exception{
        ...
        catchException(subAppResourcesNetworkServicePluginRoot).getLanguageFile(UUID.randomUUID(), "walletPublicKey", "en.xml");
    ...
    public void testGetLanguageFile_FileNotFound() throws Exception{
        subAppResourcesNetworkServicePluginRoot.start();
        catchException(subAppResourcesNetworkServicePluginRoot).getLanguageFile(null, null,null);
        System.out.println(CatchException.<Exception>caughtException());
