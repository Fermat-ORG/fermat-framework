...
public enum FanCommunityFragmentsEnumType implements
    ...
    ART_SUB_APP_FAN_COMMUNITY_CONNECTION_OTHER_PROFILE("ARTSAFCCOP"),
    ART_SUB_APP_FAN_COMMUNITY_CONNECTION_WORLD("ARTSAFCCW"),
    ART_SUB_APP_FAN_COMMUNITY_CONNECTION_FRIEND_LIST("ARTSAFCCFL"),
            ;
