...
public class FanCommunityPluginRoot extends AbstractModule<FanCommunitySettings, ActiveActorIdentityInformation> {
    ...
    @NeededPluginReference(platform = Platforms.ART_PLATFORM,         layer = Layers.ACTOR_NETWORK_SERVICE, plugin = Plugins.ACTOR_NETWORK_SERVICE_FANATIC   )
    ...
    public void start() throws CantStartPluginException {
        try{
            ...
            initPluginManager();
            System.out.println("############ ART Fan Community Finish");
        } catch (Exception e) {
            ...
            throw new CantStartPluginException(
                    ...
                    e, "Cant start Sub App Fan Community Module plugin.",
                    null);
        }
        /**
         * nothing left to do.
