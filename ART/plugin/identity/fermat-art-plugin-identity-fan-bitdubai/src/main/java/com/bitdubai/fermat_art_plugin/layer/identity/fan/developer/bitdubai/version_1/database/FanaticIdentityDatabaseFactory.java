 ...
 */
public class FanaticIdentityDatabaseFactory implements DealsWithErrors, DealsWithPluginDatabaseSystem {
    ...
    public FanaticIdentityDatabaseFactory(PluginDatabaseSystem pluginDatabaseSystem) {
    ...
    public Database createDatabase(UUID pluginId) throws CantCreateDatabaseException {
         ...
         */
        try {
            database = this.pluginDatabaseSystem.createDatabase(pluginId, FanaticIdentityDatabaseConstants.FANATIC_IDENTITY_DB_NAME);
            /**
            ...
            table = databaseFactory.newTableFactory(FanaticIdentityDatabaseConstants.FANATIC_IDENTITY_TABLE_NAME);

            table.addColumn(FanaticIdentityDatabaseConstants.FANATIC_IDENTITY_PUBLIC_KEY_COLUMN_NAME, DatabaseDataType.STRING, 150, false);
