...
public class FanaticIdentityDeveloperDatabaseFactory {//implements DealsWithPluginDatabaseSystem, DealsWithPluginIdentity {
     ...
     * @param pluginId
     */
    public FanaticIdentityDeveloperDatabaseFactory(PluginDatabaseSystem pluginDatabaseSystem, UUID pluginId) {
...
//    }
     ...
     */
    public void initializeDatabase() throws CantInitializeFanaticIdentityDatabaseException {
        try {

             /*
              * Open new database connection
              */
            database = this.pluginDatabaseSystem.openDatabase(pluginId, FanaticIdentityDatabaseConstants.FANATIC_IDENTITY_DB_NAME);
            ...
            throw new CantInitializeFanaticIdentityDatabaseException(cantOpenDatabaseException.getMessage());
              ...
              */
            FanaticIdentityDatabaseFactory assetIssuerIdentityDatabaseFactory = new FanaticIdentityDatabaseFactory(pluginDatabaseSystem);
    ...
    public List<DeveloperDatabase> getDatabaseList(DeveloperObjectFactory developerObjectFactory) {
        ...
        databases.add(developerObjectFactory.getNewDeveloperDatabase(FanaticIdentityDatabaseConstants.FANATIC_IDENTITY_DB_NAME, this.pluginId.toString()));
        return databases;
    }
    ...
    public List<DeveloperDatabaseTable> getDatabaseTableList(DeveloperObjectFactory developerObjectFactory) {
        ...
        ArtistUserColumns.add(FanaticIdentityDatabaseConstants.FANATIC_IDENTITY_PUBLIC_KEY_COLUMN_NAME);
         ...
         */
        DeveloperDatabaseTable assetUserTable = developerObjectFactory.getNewDeveloperDatabaseTable(FanaticIdentityDatabaseConstants.FANATIC_IDENTITY_TABLE_NAME, ArtistUserColumns);
