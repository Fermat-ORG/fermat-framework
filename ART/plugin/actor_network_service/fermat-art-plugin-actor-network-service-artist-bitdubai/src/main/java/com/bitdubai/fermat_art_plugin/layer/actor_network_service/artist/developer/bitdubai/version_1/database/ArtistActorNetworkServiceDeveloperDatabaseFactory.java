...
/**
 * The Class <code>com.bitdubai.fermat_cbp_plugin.layer.actor_network_service.crypto_broker.developer.bitdubai.version_1.database.ArtistActorNetworkServiceDeveloperDatabaseFactory</code> have
...
public final class ArtistActorNetworkServiceDeveloperDatabaseFactory {
     ...
     * @param pluginId
     */
    public ArtistActorNetworkServiceDeveloperDatabaseFactory(final PluginDatabaseSystem pluginDatabaseSystem,
                                                             final UUID pluginId) {
    ...
    public void initializeDatabase(final String tableId) throws CantInitializeDatabaseException {
        ...
        switch (tableId) {
            ...
            case ArtistActorNetworkServiceDatabaseConstants.ARTIST_ACTOR_NETWORK_SERVICE_DATABASE_NAME:
                ...
                try {
                    ...
                    final ArtistActorNetworkServiceDatabaseFactory artistActorNetworkServiceDatabaseFactory = new ArtistActorNetworkServiceDatabaseFactory(pluginDatabaseSystem);

                    try {

                        database = artistActorNetworkServiceDatabaseFactory.createDatabase(pluginId, tableId);
    ...
    public List<DeveloperDatabaseTable> getDatabaseTableList(final DeveloperObjectFactory developerObjectFactory,
        ...
        switch (developerDatabase.getId()) {
            ...
            case ArtistActorNetworkServiceDatabaseConstants.ARTIST_ACTOR_NETWORK_SERVICE_DATABASE_NAME:
                ...
                connectionNewsColumns.add(ArtistActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_REQUEST_ID_COLUMN_NAME            );
                connectionNewsColumns.add(ArtistActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_SENDER_PUBLIC_KEY_COLUMN_NAME     );
                connectionNewsColumns.add(ArtistActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_SENDER_ACTOR_TYPE_COLUMN_NAME     );
                connectionNewsColumns.add(ArtistActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_SENDER_ALIAS_COLUMN_NAME          );
                connectionNewsColumns.add(ArtistActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_DESTINATION_PUBLIC_KEY_COLUMN_NAME);
                connectionNewsColumns.add(ArtistActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_DESTINATION_ACTOR_TYPE_COLUMN_NAME);
                 ...
                 */
                DeveloperDatabaseTable connectionNewsTable = developerObjectFactory.getNewDeveloperDatabaseTable(ArtistActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_TABLE_NAME, connectionNewsColumns);
