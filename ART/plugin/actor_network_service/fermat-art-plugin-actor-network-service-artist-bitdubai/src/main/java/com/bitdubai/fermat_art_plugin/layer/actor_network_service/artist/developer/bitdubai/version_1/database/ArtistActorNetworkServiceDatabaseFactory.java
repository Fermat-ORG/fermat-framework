 ...
 * @since Java JDK 1.7
 */
public final class ArtistActorNetworkServiceDatabaseFactory {
     ...
     */
    public ArtistActorNetworkServiceDatabaseFactory(final PluginDatabaseSystem pluginDatabaseSystem) {
    ...
    protected Database createDatabase(final UUID   ownerId     ,
        ...
        try {
             ...
             */
            table = databaseFactory.newTableFactory(ownerId, ArtistActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_TABLE_NAME);

            table.addColumn(ArtistActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_REQUEST_ID_COLUMN_NAME            , DatabaseDataType.STRING      ,  36, Boolean.TRUE );
            table.addColumn(ArtistActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_SENDER_PUBLIC_KEY_COLUMN_NAME     , DatabaseDataType.STRING      , 130, Boolean.FALSE);
            ...
            table.addColumn(ArtistActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_REQUEST_SENT_COUNT_COLUMN_NAME    , DatabaseDataType.INTEGER     ,  10, Boolean.FALSE);
