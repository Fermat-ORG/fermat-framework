...
//                        senderPhrase,
    ...
    private ArtistActorNetworkServiceRecord buildUserNetworkServiceRecord(DatabaseTableRecord record) throws InvalidParameterException {
        try {
            ...
            artistActorNetworkServiceRecord.changeDescriptor(NotificationDescriptor.getByCode(record.getStringValue(ArtistActorNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_DESCRIPTOR_COLUMN_NAME)));
            ...
            artistActorNetworkServiceRecord.changeState(ProtocolState.getByCode(record.getStringValue(ArtistActorNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_PROTOCOL_STATE_COLUMN_NAME)));
