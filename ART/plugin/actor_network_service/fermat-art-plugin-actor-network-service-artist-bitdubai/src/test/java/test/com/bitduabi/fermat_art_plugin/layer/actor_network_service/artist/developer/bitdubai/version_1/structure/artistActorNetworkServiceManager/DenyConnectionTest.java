...
public class DenyConnectionTest {
    ...
    @Test
    public void denyConnectionTest() throws CantDenyConnectionRequestException, ConnectionRequestNotFoundException {
        ...
        doCallRealMethod().when(artistActorNetworkServiceManager).denyConnection(requestId);
