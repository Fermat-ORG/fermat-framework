...
public class DisconnectConnectionTest {
    ...
    @Test
    public void disconnectConnectionTest() throws CantDisconnectException, ConnectionRequestNotFoundException {

        ArtistActorNetworkServiceDao artistActorNetworkServiceDao = PowerMockito.mock(ArtistActorNetworkServiceDao.class);

        doCallRealMethod().when(artistActorNetworkServiceDao).disconnectConnection(requestId,
                                                                                    state);
    }
