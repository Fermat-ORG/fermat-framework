...
public class CreateConnectionRequestTest {
    ...
    final ArtistConnectionInformation artistConnectionInformation = null;
    ...
    public void createConnectionRequestTest() throws CantRequestConnectionException {
        ...
        doCallRealMethod().when(artistActorNetworkServiceDao).createConnectionRequest(artistConnectionInformation,
                                                                                        state,
                                                                                        type,
                                                                                        action);
    }
