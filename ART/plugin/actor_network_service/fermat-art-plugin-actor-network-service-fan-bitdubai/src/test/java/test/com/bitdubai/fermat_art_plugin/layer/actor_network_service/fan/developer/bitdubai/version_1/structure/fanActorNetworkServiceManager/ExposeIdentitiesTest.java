...
public class ExposeIdentitiesTest {
    ...
    public void exposeIdentitiesTest () throws CantExposeIdentitiesException {
        ...
        final Collection<FanExposingData> artistExposingDataList = new Collection<FanExposingData>() {
            @Override
            public int size() {
                return 0;
            }
        ...
        doCallRealMethod().when(fanActorNetworkServiceManager).exposeIdentities(artistExposingDataList);
