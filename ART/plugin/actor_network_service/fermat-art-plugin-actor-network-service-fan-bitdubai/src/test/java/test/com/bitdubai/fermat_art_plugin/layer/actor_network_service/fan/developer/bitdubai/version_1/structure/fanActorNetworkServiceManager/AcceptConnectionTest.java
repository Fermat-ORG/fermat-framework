...
public class AcceptConnectionTest {
    ...
    @Test
    public void acceptConnectionTest () throws ConnectionRequestNotFoundException, CantAcceptConnectionRequestException {
        ...
        doCallRealMethod().when(fanActorNetworkServiceManager).acceptConnection(requestId);
