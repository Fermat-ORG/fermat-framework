 ...
 */
public enum ARTConnectionState implements FermatEnum {
    ...
    ARTConnectionState(final String code) {
        this.code = code;
    }
    ...
    public static ARTConnectionState getByCode(final String code) throws InvalidParameterException {
        ...
        switch (code) {
            ...
            default: throw new InvalidParameterException(
                    "Code Received: " + code,
                    "The code received is not valid for the ARTConnectionState Enum"
            );
        }
    }
}
