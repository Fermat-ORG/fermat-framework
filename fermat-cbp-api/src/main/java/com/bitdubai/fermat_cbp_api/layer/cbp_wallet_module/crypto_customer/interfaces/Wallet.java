...
public interface Wallet {
     ...
     */
    List<RequestAndContractBasicInformation> getAllRequestsAndContracts() throws CantGetContractInformationListException, CantGetRequestListException;
     ...
     */
    List<RequestAndContractBasicInformation> getListOfRequestsAndContracts(int max, int offset) throws CantGetContractInformationListException, CantGetRequestListException;
     ...
     * @return
     */
    List<RequestAndContractBasicInformation> getListOfRequestsAndContractsWaitingForMyResponse(int max, int offset) throws CantGetContractInformationListException, CantGetRequestListException;
     ...
     * @return
     */
    List<RequestAndContractBasicInformation> getListOfRequestsAndContractsWaitingForBrokerResponse(int max, int offset) throws CantGetContractInformationListException, CantGetRequestListException;

    /**
     * @param contractId the ID of the Contract
     * @return all the details of a contract
     */
    ContractInformation getContractDetails(String contractId) throws CantGetContractInformationDetailsException;
     ...
     */
    void updateContractInformation(ContractInformation information) throws CouldNotUpdateContractInformationException;
