...
import com.bitdubai.fermat_cbp_api.layer.cbp_contract.customer_broker_bank_money_sale.exceptions.CantupdateStatusCustomerBrokerBankMoneySaleException;
...
public interface CustomerBrokerBankMoneySaleManager {
    ...
    void updateStatusCustomerBrokerBankMoneySale(final UUID ContractId) throws CantupdateStatusCustomerBrokerBankMoneySaleException;
