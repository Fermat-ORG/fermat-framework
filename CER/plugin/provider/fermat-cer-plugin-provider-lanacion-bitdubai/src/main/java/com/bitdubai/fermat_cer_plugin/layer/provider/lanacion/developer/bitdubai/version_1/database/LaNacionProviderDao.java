    ...
    public void initialize() throws CantInitializeLaNacionProviderDatabaseException {
        try {
            ...
            try {
                ...
                errorManager.reportUnexpectedPluginException(Plugins.BITDUBAI_CER_PROVIDER_LANACION, UnexpectedPluginExceptionSeverity.DISABLES_THIS_PLUGIN, cantCreateDatabaseException);
            ...
            errorManager.reportUnexpectedPluginException(Plugins.BITDUBAI_CER_PROVIDER_LANACION, UnexpectedPluginExceptionSeverity.DISABLES_THIS_PLUGIN, cantOpenDatabaseException);
