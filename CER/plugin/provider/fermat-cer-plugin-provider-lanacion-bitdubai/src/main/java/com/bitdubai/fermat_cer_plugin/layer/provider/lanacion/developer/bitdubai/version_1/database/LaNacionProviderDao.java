...
public class LaNacionProviderDao {
    ...
    public void initialize() throws CantInitializeLaNacionProviderDatabaseException {
        try {
            ...
            try {
                ...
                throw new CantInitializeLaNacionProviderDatabaseException("Database could not be opened", cantCreateDatabaseException, new StringBuilder().append("Database Name: ").append(LaNacionProviderDatabaseConstants.QUERY_HISTORY_TABLE_NAME).toString(), "");
            }
        } catch (CantOpenDatabaseException cantOpenDatabaseException) {
            pluginRoot.reportError(UnexpectedPluginExceptionSeverity.DISABLES_THIS_PLUGIN, cantOpenDatabaseException);
            throw new CantInitializeLaNacionProviderDatabaseException("Database could not be opened", cantOpenDatabaseException, new StringBuilder().append("Database Name: ").append(LaNacionProviderDatabaseConstants.QUERY_HISTORY_TABLE_NAME).toString(), "");
        } catch (Exception e) {
            pluginRoot.reportError(UnexpectedPluginExceptionSeverity.DISABLES_THIS_PLUGIN, e);
            throw new CantInitializeLaNacionProviderDatabaseException("Database could not be opened", FermatException.wrapException(e), new StringBuilder().append("Database Name: ").append(LaNacionProviderDatabaseConstants.QUERY_HISTORY_TABLE_NAME).toString(), "");
        }
    }
    ...
    private ExchangeRate constructExchangeRateFromRecord(DatabaseTableRecord record) throws CantCreateExchangeRateException {
        ...
        try {
            ...
            throw new CantCreateExchangeRateException(e.getMessage(), e, "LaNacion provider plugin", new StringBuilder().append("Invalid From Currency value stored in table").append(LaNacionProviderDatabaseConstants.QUERY_HISTORY_TABLE_NAME).append(" for id ").append(id).toString());
        }
        ...
        try {
            ...
            throw new CantCreateExchangeRateException(e.getMessage(), e, "LaNacion provider plugin", new StringBuilder().append("Invalid To Currency value stored in table").append(LaNacionProviderDatabaseConstants.QUERY_HISTORY_TABLE_NAME).append(" for id ").append(id).toString());
        }
