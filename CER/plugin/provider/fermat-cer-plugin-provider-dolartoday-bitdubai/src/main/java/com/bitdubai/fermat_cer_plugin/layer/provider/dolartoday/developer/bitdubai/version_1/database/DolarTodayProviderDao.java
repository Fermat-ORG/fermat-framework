...
public class DolarTodayProviderDao {
    ...
    private ExchangeRate constructExchangeRateFromRecord(DatabaseTableRecord record) throws CantCreateExchangeRateException {
        ...
        try {
            ...
            throw new CantCreateExchangeRateException(e.getMessage(), e, "Dolartoday provider plugin", "Invalid From Currency value stored in table" + DolarTodayProviderDatabaseConstants.QUERY_HISTORY_TABLE_NAME + " for id " + id);
        }
        ...
        try {
            ...
            throw new CantCreateExchangeRateException(e.getMessage(), e, "Dolartoday provider plugin", "Invalid To Currency value stored in table" + DolarTodayProviderDatabaseConstants.QUERY_HISTORY_TABLE_NAME + " for id " + id);
        }
