...
public class DolarTodayProviderDao {
    ...
    private final ProviderDolarTodayPluginRoot pluginRoot;
    private final PluginDatabaseSystem pluginDatabaseSystem;
    private final UUID pluginId;

    private Database database;

    public DolarTodayProviderDao(final PluginDatabaseSystem pluginDatabaseSystem, final UUID pluginId, final ProviderDolarTodayPluginRoot pluginRoot) {
    ...
    public void initialize() throws CantInitializeDolarTodayProviderDatabaseException {
        try {
            ...
            try {
                ...
                throw new CantInitializeDolarTodayProviderDatabaseException("Database could not be opened", cantCreateDatabaseException, new StringBuilder().append("Database Name: ").append(DolarTodayProviderDatabaseConstants.QUERY_HISTORY_TABLE_NAME).toString(), "");
            }
        } catch (CantOpenDatabaseException cantOpenDatabaseException) {
            pluginRoot.reportError(UnexpectedPluginExceptionSeverity.DISABLES_THIS_PLUGIN, cantOpenDatabaseException);
            throw new CantInitializeDolarTodayProviderDatabaseException("Database could not be opened", cantOpenDatabaseException, new StringBuilder().append("Database Name: ").append(DolarTodayProviderDatabaseConstants.QUERY_HISTORY_TABLE_NAME).toString(), "");
        } catch (Exception e) {
            pluginRoot.reportError(UnexpectedPluginExceptionSeverity.DISABLES_THIS_PLUGIN, e);
            throw new CantInitializeDolarTodayProviderDatabaseException("Database could not be opened", FermatException.wrapException(e), new StringBuilder().append("Database Name: ").append(DolarTodayProviderDatabaseConstants.QUERY_HISTORY_TABLE_NAME).toString(), "");
        }
    }
    ...
    private ExchangeRate constructExchangeRateFromRecord(DatabaseTableRecord record) throws CantCreateExchangeRateException {
        ...
        try {
            ...
            throw new CantCreateExchangeRateException(e.getMessage(), e, "Dolartoday provider plugin", new StringBuilder().append("Invalid From Currency value stored in table").append(DolarTodayProviderDatabaseConstants.QUERY_HISTORY_TABLE_NAME).append(" for id ").append(id).toString());
        }
        ...
        try {
            ...
            throw new CantCreateExchangeRateException(e.getMessage(), e, "Dolartoday provider plugin", new StringBuilder().append("Invalid To Currency value stored in table").append(DolarTodayProviderDatabaseConstants.QUERY_HISTORY_TABLE_NAME).append(" for id ").append(id).toString());
        }
