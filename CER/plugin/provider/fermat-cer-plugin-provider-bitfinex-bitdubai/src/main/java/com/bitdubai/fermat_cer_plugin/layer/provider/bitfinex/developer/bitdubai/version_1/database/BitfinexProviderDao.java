...
public class BitfinexProviderDao {
    ...
    private ExchangeRate constructExchangeRateFromRecord(DatabaseTableRecord record) throws CantCreateExchangeRateException {
        ...
        try {
            ...
            throw new CantCreateExchangeRateException(e.getMessage(), e, "Bitfinex provider plugin", "Invalid From Currency value stored in table" + BitfinexProviderDatabaseConstants.CURRENT_EXCHANGE_RATES_TABLE_NAME + " for id " + id);
        }
        ...
        try {
            ...
            throw new CantCreateExchangeRateException(e.getMessage(), e, "Bitfinex provider plugin", "Invalid To Currency value stored in table" + BitfinexProviderDatabaseConstants.CURRENT_EXCHANGE_RATES_TABLE_NAME + " for id " + id);
        }
