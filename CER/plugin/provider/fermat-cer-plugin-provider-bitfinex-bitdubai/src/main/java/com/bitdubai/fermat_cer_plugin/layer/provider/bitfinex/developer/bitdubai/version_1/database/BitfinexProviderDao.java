...
import com.bitdubai.fermat_cer_plugin.layer.provider.bitfinex.developer.bitdubai.version_1.ProviderBitfinexPluginRoot;
...
public class BitfinexProviderDao {
    ...
    private final ProviderBitfinexPluginRoot pluginRoot;
    private final PluginDatabaseSystem pluginDatabaseSystem;
    private final UUID pluginId;

    private Database database;

    public BitfinexProviderDao(final PluginDatabaseSystem pluginDatabaseSystem, final UUID pluginId, final ProviderBitfinexPluginRoot pluginRoot) {
    ...
    public void initialize() throws CantInitializeBitfinexProviderDatabaseException {
        try {
            ...
            try {
                ...
                throw new CantInitializeBitfinexProviderDatabaseException("Database could not be opened", cantCreateDatabaseException, new StringBuilder().append("Database Name: ").append(BitfinexProviderDatabaseConstants.CURRENT_EXCHANGE_RATES_TABLE_NAME).toString(), "");
            }
        } catch (CantOpenDatabaseException cantOpenDatabaseException) {
            pluginRoot.reportError(UnexpectedPluginExceptionSeverity.DISABLES_THIS_PLUGIN, cantOpenDatabaseException);
            throw new CantInitializeBitfinexProviderDatabaseException("Database could not be opened", cantOpenDatabaseException, new StringBuilder().append("Database Name: ").append(BitfinexProviderDatabaseConstants.CURRENT_EXCHANGE_RATES_TABLE_NAME).toString(), "");
        } catch (Exception e) {
            pluginRoot.reportError(UnexpectedPluginExceptionSeverity.DISABLES_THIS_PLUGIN, e);
            throw new CantInitializeBitfinexProviderDatabaseException("Database could not be opened", FermatException.wrapException(e), new StringBuilder().append("Database Name: ").append(BitfinexProviderDatabaseConstants.CURRENT_EXCHANGE_RATES_TABLE_NAME).toString(), "");
        }
    }
    ...
    private ExchangeRate constructExchangeRateFromRecord(DatabaseTableRecord record) throws CantCreateExchangeRateException {
        ...
        try {
            ...
            throw new CantCreateExchangeRateException(e.getMessage(), e, "Bitfinex provider plugin", new StringBuilder().append("Invalid From Currency value stored in table").append(BitfinexProviderDatabaseConstants.CURRENT_EXCHANGE_RATES_TABLE_NAME).append(" for id ").append(id).toString());
        }
        ...
        try {
            ...
            throw new CantCreateExchangeRateException(e.getMessage(), e, "Bitfinex provider plugin", new StringBuilder().append("Invalid To Currency value stored in table").append(BitfinexProviderDatabaseConstants.CURRENT_EXCHANGE_RATES_TABLE_NAME).append(" for id ").append(id).toString());
        }
