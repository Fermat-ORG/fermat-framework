package com.bitdubai.fermat_cer_plugin.layer.provider.bitfinex.developer.bitdubai.version_1;
...
public class ProviderBitfinexPluginRoot extends AbstractPlugin implements DatabaseManagerForDevelopers, CurrencyExchangeRateProviderManager {
    ...
    private BitfinexProviderDao dao;
     ...
     */
    public ProviderBitfinexPluginRoot() {
    ...
    public void start() throws CantStartPluginException {
        System.out.println("PROVIDERBITFINEX - PluginRoot START");
    ...
    public List<DeveloperDatabase> getDatabaseList(DeveloperObjectFactory developerObjectFactory) {
        BitfinexProviderDeveloperDatabaseFactory factory = new BitfinexProviderDeveloperDatabaseFactory(pluginDatabaseSystem, pluginId);
