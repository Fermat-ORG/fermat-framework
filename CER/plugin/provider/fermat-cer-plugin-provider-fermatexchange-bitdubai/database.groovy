...
String pluginName = "FermatExchange"
...
databaseTables << [
        ...
        columns: [
                ["ID", "TEXT", "100", "true"],
                ["From Currency", "TEXT", "100", "false"],
                ["To Currency", "TEXT", "100", "false"],
                ["Sale Price", "TEXT", "100", "false"],
                ["Purchase Price", "TEXT", "100", "false"],
                ["Timestamp", "INTEGER", "100", "false"]
