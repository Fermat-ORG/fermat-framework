...
/**
 * The Class <code>com.bitdubai.fermat_cer_plugin.layer.provider.europeancentralbank.developer.bitdubai.version_1.database.EuropeanCentralBankProviderDeveloperDatabaseFactory</code> have
...
public class EuropeanCentralBankProviderDeveloperDatabaseFactory {//implements DealsWithPluginDatabaseSystem, DealsWithPluginIdentity {
     ...
     * @param pluginId
     */
    public EuropeanCentralBankProviderDeveloperDatabaseFactory(PluginDatabaseSystem pluginDatabaseSystem, UUID pluginId) {
     ...
     *
     * @throws CantInitializeEuropeanCentralBankProviderDatabaseException
     */
    public void initializeDatabase() throws CantInitializeEuropeanCentralBankProviderDatabaseException {
        try {
            ...
            database = this.pluginDatabaseSystem.openDatabase(pluginId, pluginId.toString());
              ...
              */
            throw new CantInitializeEuropeanCentralBankProviderDatabaseException(cantOpenDatabaseException.getMessage());
            ...
            try {
                ...
                database = europeanCentralBankProviderDatabaseFactory.createDatabase(pluginId, pluginId.toString());
                   ...
                   */
                throw new CantInitializeEuropeanCentralBankProviderDatabaseException(cantCreateDatabaseException.getMessage());
            }
        }
    }
    ...
    public List<DeveloperDatabaseTable> getDatabaseTableList(DeveloperObjectFactory developerObjectFactory) {
        ...
        providerInfoColumns.add(EuropeanCentralBankProviderDatabaseConstants.PROVIDER_INFO_ID_COLUMN_NAME);
        providerInfoColumns.add(EuropeanCentralBankProviderDatabaseConstants.PROVIDER_INFO_NAME_COLUMN_NAME);
        /**
         * Table Provider Info addition.
         */
        DeveloperDatabaseTable providerInfoTable = developerObjectFactory.getNewDeveloperDatabaseTable(EuropeanCentralBankProviderDatabaseConstants.PROVIDER_INFO_TABLE_NAME, providerInfoColumns);
