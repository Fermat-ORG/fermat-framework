...
/**
 *  The Class  <code>com.bitdubai.fermat_cer_plugin.layer.provider.bitcoinvenezuela.developer.bitdubai.version_1.database.BitcoinVenezuelaProviderDatabaseFactory</code>
 ...
 * @since Java JDK 1.7
 */
public class BitcoinVenezuelaProviderDatabaseFactory implements DealsWithPluginDatabaseSystem {
     ...
     */
    public BitcoinVenezuelaProviderDatabaseFactory(PluginDatabaseSystem pluginDatabaseSystem) {
    ...
    protected Database createDatabase(UUID ownerId, String databaseName) throws CantCreateDatabaseException {
        ...
        try {
            ...
            table.addColumn(BitcoinVenezuelaProviderDatabaseConstants.QUERY_HISTORY_SALE_PRICE_COLUMN_NAME, DatabaseDataType.MONEY, 100, Boolean.FALSE);
            table.addColumn(BitcoinVenezuelaProviderDatabaseConstants.QUERY_HISTORY_PURCHASE_PRICE_COLUMN_NAME, DatabaseDataType.MONEY, 100, Boolean.FALSE);
