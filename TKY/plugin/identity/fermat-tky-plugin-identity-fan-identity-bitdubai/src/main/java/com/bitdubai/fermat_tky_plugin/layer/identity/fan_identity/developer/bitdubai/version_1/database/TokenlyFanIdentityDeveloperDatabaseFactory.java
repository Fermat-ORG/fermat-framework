...
public class TokenlyFanIdentityDeveloperDatabaseFactory implements DealsWithPluginDatabaseSystem, DealsWithPluginIdentity {
    ...
    public List<DeveloperDatabaseTable> getDatabaseTableList(DeveloperObjectFactory developerObjectFactory) {
        ...
        ArtistUserColumns.add(TokenlyFanIdentityDatabaseConstants.TOKENLY_FAN_IDENTITY_ALIAS_COLUMN_NAME);
        ArtistUserColumns.add(TokenlyFanIdentityDatabaseConstants.TOKENLY_FAN_IDENTITY_EXTERNAL_USER_NAME_COLUMN_NAME);
        ArtistUserColumns.add(TokenlyFanIdentityDatabaseConstants.TOKENLY_FAN_IDENTITY_EXTERNAL_ACCESS_TOKEN_COLUMN_NAME);
