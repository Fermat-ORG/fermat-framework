 ...
 */
public class GetArtistAcceptConnectionsTypeTest {
    @Mock
    ArtistAcceptConnectionsType artistAcceptConnectionsType;
    @Test
    public void getArtistAcceptConnectionsTypeTest(){
        TokenlyArtistIdentityImp tokenlyArtistIdentityImp = Mockito.mock(TokenlyArtistIdentityImp.class);
        when(tokenlyArtistIdentityImp.getArtistAcceptConnectionsType()).thenReturn(artistAcceptConnectionsType);
    }
