...
public class MenuButton
    ...
    CircleShape firstPoint;
    CircleShape secondPoint;
    CircleShape thirdPoint;
    ...
    private View buildView(Context context) {
        ...
        container = (LinearLayout) view.getChildAt(0);
        ViewManager.replaceView(container.getChildAt(0), firstPoint);
        ViewManager.replaceView(container.getChildAt(1), secondPoint);
        ViewManager.replaceView(container.getChildAt(2), thirdPoint);
