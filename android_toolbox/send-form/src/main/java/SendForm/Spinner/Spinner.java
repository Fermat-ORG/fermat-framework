...
public class Spinner
    ...
    private void initializeViews() {
        ...
        LinearLayout view = (LinearLayout) inflater.inflate(R.layout.material_spinner_layout_sendform, this, true);
    ...
    private View buildView(Context context) {
        ...
        FrameLayout view = (FrameLayout) inflater.inflate(R.layout.material_spinner_layout_sendform, null);
    ...
    /**
     * Set spinner mode
     * @param mode - mode of field (text, action_button, simple)
     */
