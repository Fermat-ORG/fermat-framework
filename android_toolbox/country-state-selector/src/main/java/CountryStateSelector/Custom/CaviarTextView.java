package CountryStateSelector.Custom;
...
public class CaviarTextView
    ...
    public void parseAttributes(Context context, AttributeSet attrs) {
        ...
        TypefaceEnumType typefaceType = TypefaceEnumType.values()[values.getInt(R.styleable.CaviarTextView_typeface, TypefaceEnumType.ROBOTO_BOLD.ordinal())];
    ...
    public void setDefaultTypeface(Context context) {
        Typeface typeface = Typeface.createFromAsset(context.getAssets(), typefaceMap.get(TypefaceEnumType.ROBOTO_REGULAR));
        if (typeface != null)
            setTypeface(typeface);
    }
}
