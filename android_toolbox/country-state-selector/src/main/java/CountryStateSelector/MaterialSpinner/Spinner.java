...
public class Spinner
    ...
    boolean isItemSelectedDrawableSet = false;
    ...
    private void parseAttributes(AttributeSet attributes) {
        ...
        if(itemSelectedDrawable != R.drawable.test_gradient)
    ...
    private void initializeViews() {
        ...
        LinearLayout view = (LinearLayout) inflater.inflate(R.layout.material_spinner_layout_countryselector, this, true);
    ...
    private View buildView(Context context) {
        ...
        FrameLayout view = (FrameLayout) inflater.inflate(R.layout.material_spinner_layout_countryselector, null);
