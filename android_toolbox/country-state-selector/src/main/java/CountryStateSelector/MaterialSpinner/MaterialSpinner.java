...
import CountryStateSelector.Custom.CaviarTextView;
import CountryStateSelector.Utility.TypefaceEnumType;
...
public class MaterialSpinner
    ...
    private static OnDismissListener listener = null;
    ...
    public interface OnDismissListener {
        void onDismiss(String item);
    }

    public static class MaterialSpinnerOnDismissListener {

        public void setListener(OnDismissListener externalListener) {
    ...
    public void setItems(int array) {
        ...
        // Setting up white spaces to start and end of list
        String space = " ";
        popUpListItem.add(0, new PopupListItem(space));
        popUpListItem.add(new PopupListItem(space));
    ...
    public void setItems(ArrayList<String> array) {
        ...
        // Setting up white space at the end
        popUpListItem.add(0, new PopupListItem(space));
        popUpListItem.add(new PopupListItem(space));
    ...
    private void setAdapter(PopupListItemAdapter adapter) {
        if (adapter != null) {
            ...
            listView.setOnScrollListener(new AbsListView.OnScrollListener() {
                ...
                public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                    if(visibleItemCount > 0) {
                        ...
                        selectedPosition = position - verticalOffset + 1;
                        /*String selectedItem = getSelectedItem();
                        for(int i=0; i<listView.getChildCount(); i++) {
                            LinearLayout linearLayout =  (LinearLayout)listView.getChildAt(i);
                            CaviarTextView  caviarTextView = (CaviarTextView)linearLayout.getChildAt(1);
                            if(caviarTextView.getText().toString().equals(selectedItem))
            ...
            selectedPosition = verticalOffset;
            listView.setSelection(selectedPosition - 1);
        } else {
            selectedPosition = -1;
    ...
    public void onDismiss() {
        ...
        if(listener != null)
            listener.onDismiss(getSelectedItem());
    }
