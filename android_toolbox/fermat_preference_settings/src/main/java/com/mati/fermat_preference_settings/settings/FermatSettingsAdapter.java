 ...
 */
public class FermatSettingsAdapter extends FermatAdapterImproved<PreferenceSettingsItem, FermatViewHolder> {
    ...
    protected FermatSettingsAdapter(Activity context, List<PreferenceSettingsItem> dataSet) {
...
//                context.registerForContextMenu(lblMensaje);
                settingTextOpenDialogViewHolder.getTextView().setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        new SettingsDialog(context,preferenceSettingsOpenDialogText.getOptionList()).show();
                    }
                });
                break;
        }
