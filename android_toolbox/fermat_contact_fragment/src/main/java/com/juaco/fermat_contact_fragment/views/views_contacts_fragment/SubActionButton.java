...
public class SubActionButton extends LinearLayout {
    ...
    public SubActionButton(Context context, LayoutParams layoutParams, int theme, Drawable backgroundDrawable, View contentView, LayoutParams contentParams, String text) {
        ...
        LayoutParams lps2 = new LayoutParams(150,150);
        lps2.rightMargin = 40;
        ...
        LayoutParams lps_text = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
...
//        }
    ...
    /**
     * A builder for {@link com.bitdubai.reference_niche_wallet.bitcoin_wallet.common.Views.SubActionButton} in conventional Java Builder format
     */
