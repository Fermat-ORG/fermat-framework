 ...
 */
public class IncomingCryptoReversedOnBlockchainEventHandler implements EventHandler {
    /**
    ...
    public void handleEvent(PlatformEvent platformEvent) throws FermatException {
        ...
        if (this.incomingCryptoEventRecorderService.getStatus() == ServiceStatus.STARTED){
            ...
            try
            {
                this.incomingCryptoEventRecorderService.incomingCryptoWaitingTransference((IncomingCryptoReversedOnBlockchainEvent) platformEvent);
            }
