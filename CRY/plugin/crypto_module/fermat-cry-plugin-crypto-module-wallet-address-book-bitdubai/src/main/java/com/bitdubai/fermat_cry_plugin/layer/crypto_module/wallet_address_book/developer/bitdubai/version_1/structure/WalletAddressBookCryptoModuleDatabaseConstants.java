...
class WalletAddressBookCryptoModuleDatabaseConstants {
    ...
    static final String CRYPTO_WALLET_ADDRESS_BOOK_TABLE_WALLET_ID = "wallet_id";
    static final String CRYPTO_WALLET_ADDRESS_BOOK_TABLE_WALLET_TYPE = "wallet_type";
    static final String CRYPTO_WALLET_ADDRESS_BOOK_TABLE_CRYPTO_ADDRESS = "crypto_address";
    static final String CRYPTO_WALLET_ADDRESS_BOOK_TABLE_CRYPTO_CURRENCY = "crypto_currency";
    static final String CRYPTO_WALLET_ADDRESS_BOOK_TABLE_TIME_STAMP = "TimeStamp";
    static final String CRYPTO_WALLET_ADDRESS_FIRST_KEY_COLUMN_NAME = "crypto_address";
