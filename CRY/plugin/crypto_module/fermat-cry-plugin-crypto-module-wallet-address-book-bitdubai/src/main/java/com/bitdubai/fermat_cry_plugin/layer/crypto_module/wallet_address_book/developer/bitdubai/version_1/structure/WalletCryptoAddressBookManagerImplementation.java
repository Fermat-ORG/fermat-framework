...
/**
 * The class <code>com.bitdubai.fermat_cry_plugin.layer.crypto_module.wallet_address_book.developer.bitdubai.version_1.structure.WalletCryptoAddressBookManagerImplementation</code>
 ...
 * @version 1.0
 */
public class WalletCryptoAddressBookManagerImplementation implements DealsWithErrors, DealsWithPluginDatabaseSystem, DealsWithPluginIdentity, WalletCryptoAddressBookManager {
    ...
    /**
     * WalletCryptoAddressBookManager Interface member variables.
     */
    ...
    @Override
    public List<WalletCryptoAddressBook> getAllWalletCryptoAddressBookByWalletId(UUID walletId) throws CantGetWalletCryptoAddressBookException {
