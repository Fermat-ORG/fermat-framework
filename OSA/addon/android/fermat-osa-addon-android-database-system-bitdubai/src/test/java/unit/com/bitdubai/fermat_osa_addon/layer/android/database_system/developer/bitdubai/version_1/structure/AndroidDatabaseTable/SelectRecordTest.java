...
public class SelectRecordTest {
    ...
    @Test
    public void SelectRecord_normal() throws Exception{
    ...
    @Test
    public void SelectRecord_Operator_SUM() throws Exception{

        testDatabaseTable.setVarialbesResult(null);

        testTableRecord_2 = testDatabaseTable.getEmptyRecord();
        testTableRecord_2.setIntegerValue("testColumn1", 1);
        testTableRecord_2.setStringValue("testColumn2", "valor 1");

        testDatabaseTable.setSelectOperator("testColumn1", DataBaseSelectOperatorType.SUM, "suma");
    ...
    @Test
    public void SelectRecord_Operator_COUNT() throws Exception{
        ...
        testDatabaseTable.setSelectOperator("testColumn2", DataBaseSelectOperatorType.COUNT, "total");
