...
public class AndroidDatabaseAggregateFunction implements DatabaseAggregateFunction {
    ...
    public String toString() {
        return "AndroidDatabaseAggregateFunction{" +
                "column='" + column + '\'' +
                ", type=" + type +
                ", alias='" + alias + '\'' +
                '}';
    ...
    public String toSQLQuery() {
        ...
        switch (type) {
            case AVG  : strFilter.append("AVG(")
                        .append(column)
                        .append(") AS '" + alias + "'");
                break;

            case MAX: strFilter.append("MAX(")
                    .append(column)
                    .append(") AS '" + alias + "'");
                break;

            case MIN: strFilter.append("MIN(")
                    .append(column)
                    .append(") AS '" + alias + "'");
                break;

            case COUNT: strFilter.append("COUNT(")
                    .append(column)
                    .append(") AS '" + alias + "'");
                break;

            case ROUND: strFilter.append("ROUND(")
                    .append(column)
                    .append(") AS '" + alias + "'");
                break;

            case SUM  : strFilter.append("SUM(")
                    .append(column)
                    .append(") AS '" + alias + "'");
