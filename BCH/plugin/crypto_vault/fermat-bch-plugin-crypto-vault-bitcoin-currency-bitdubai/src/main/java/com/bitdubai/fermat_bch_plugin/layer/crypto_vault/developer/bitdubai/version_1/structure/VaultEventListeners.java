...
import com.bitdubai.fermat_bch_plugin.layer.crypto_vault.developer.bitdubai.version_1.exceptions.UnexpectedCryptoStatusException;
...
public class VaultEventListeners extends AbstractWalletEventListener {
    ...
    public void onCoinsReceived(Wallet wallet, Transaction tx, Coin prevBalance, Coin newBalance) {
        logManager.log(CryptoVaultBitcoinCurrencyPluginRoot.getLogLevelByClass(this.getClass().getName()), "PlatformCryptoVault information: Ney money received!!! New balance: " + newBalance.getValue(), null, null);
        /**
    ...
    public void onCoinsSent(Wallet wallet, Transaction tx, Coin prevBalance, Coin newBalance) {
        ...
        try {
            logManager.log(CryptoVaultBitcoinCurrencyPluginRoot.getLogLevelByClass(this.getClass().getName()), "Money sent.", "Prev Balance: " + prevBalance.getValue() + " New Balance:" + newBalance.getValue(), "Transaction: " + tx.toString());
        } catch (Exception e) {
            reportUnexpectedError(e);
        }
    }
    ...
    public void onTransactionConfidenceChanged(Wallet wallet,Transaction tx) {
        logManager.log(CryptoVaultBitcoinCurrencyPluginRoot.getLogLevelByClass(this.getClass().getName()), "Transaction confidence change detected!", "Transaction confidence changed. Transaction: " + tx, "Transaction confidence changed. Transaction: " + tx);
