package com.bitdubai.fermat_bch_plugin.layer.crypto_vault.developer.bitdubai.version_1.structure.events;
...
import com.bitdubai.fermat_bch_plugin.layer.crypto_vault.developer.bitdubai.version_1.utils.EventsSelector;
import com.bitdubai.fermat_bch_plugin.layer.crypto_vault.developer.bitdubai.version_1.utils.TransactionTypeAndCryptoStatus;
import com.bitdubai.fermat_pip_api.layer.platform_service.error_manager.interfaces.ErrorManager;
import com.bitdubai.fermat_pip_api.layer.platform_service.error_manager.enums.UnexpectedPluginExceptionSeverity;
import com.bitdubai.fermat_pip_api.layer.platform_service.event_manager.interfaces.EventManager;

import com.bitdubai.fermat_bch_api.layer.crypto_vault.bitcoin_vault.CryptoVaultTransactionNotificationAgent;
...
public class TransactionNotificationAgent extends FermatAgent {
    ...
    public TransactionNotificationAgent(final EventManager eventManager,
        ...
        this.agentThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                logManager.log(CryptoVaultBitcoinCurrencyPluginRoot.getLogLevelByClass(this.getClass().getName()), "Transaction Protocol Notification Agent: running...", null, null);
    ...
    private void doTheMainTask() {
        ...
        try {
            ...
            logManager.log(CryptoVaultBitcoinCurrencyPluginRoot.getLogLevelByClass(this.getClass().getName()), "Iteration number " + iteration, null, null);
            ...
            for (TransactionTypeAndCryptoStatus ttacs : list) {
                ...
                if (eventType != null) {
                    logManager.log(CryptoVaultBitcoinCurrencyPluginRoot.getLogLevelByClass(this.getClass().getName()), "Found transactions pending to be notified in " + cryptoStatus.name() + " Status! Raising " + eventType.name() + " event.", null, null);

                    raiseEvent(eventType);

                    logManager.log(CryptoVaultBitcoinCurrencyPluginRoot.getLogLevelByClass(this.getClass().getName()), "No other plugin is consuming Vault transactions.", "Transaction Protocol Notification Agent: iteration number " + iteration + " without other plugins consuming transaction.", null);
    ...
    private void raiseEvent(EventType eventType) {
        ...
        event.setSource(CryptoVaultBitcoinCurrencyPluginRoot.EVENT_SOURCE);
