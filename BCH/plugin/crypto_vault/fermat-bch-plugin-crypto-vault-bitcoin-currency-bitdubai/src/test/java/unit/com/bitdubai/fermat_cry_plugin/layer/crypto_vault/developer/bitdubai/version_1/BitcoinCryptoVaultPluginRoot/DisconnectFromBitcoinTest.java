...
import unit.com.bitdubai.fermat_bch_plugin.layer.crypto_vault.developer.bitdubai.version_1.Common.MockedPluginFileSystem;
...
public class DisconnectFromBitcoinTest {
    ...
    @Test
    public void disconnectToBitcoinTest_DisconnectedOk_ThrowsVaultNotConnectedToNetworkException() throws Exception {

        catchException(bitcoinCryptoVaultPluginRoot).disconnectFromBitcoin();
