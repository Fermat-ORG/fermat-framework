...
public class ConfirmReceptionTest  {
    ...
    @Test
    public void confirmReceptionTest_ConfirmOk_ThrowsCantConfirmTransactionException() throws Exception {

        catchException(bitcoinCryptoVault).confirmReception(UUID.randomUUID());
        assertThat(caughtException())
                .isNull();

    }

    public void confirmReceptionTest_ConfirmError_ThrowsCantConfirmTransactionException() throws Exception {
        Mockito.doReturn(null).when(mockRecords).get(0);
        catchException(bitcoinCryptoVault).confirmReception(UUID.randomUUID());
        assertThat(caughtException())
                .isNotNull().isInstanceOf(CantConfirmTransactionException.class);
