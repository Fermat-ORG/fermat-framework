package com.bitdubai.fermat_bch_plugin.layer.crypto_vault.fermat.developer.bitdubai.bitdubai.version_1.refactor.classes.transactions;
...
public class DraftTransaction {
    ...
    public static DraftTransaction deserialize(BlockchainNetworkType networkType, byte[] serializedTransaction) {
        return new DraftTransaction(new Transaction(FermatBlockchainNetworkSelector.getNetworkParameter(networkType), serializedTransaction));
    }
    ...
    public BlockchainNetworkType getNetworkType() {
        return FermatBlockchainNetworkSelector.getBlockchainNetworkType(bitcoinTransaction.getParams());
    }
