 ...
 */
public class InvalidChainNumberException extends FermatException {
    ...
    public InvalidChainNumberException(String message, Exception cause, String context, String possibleReason) {
