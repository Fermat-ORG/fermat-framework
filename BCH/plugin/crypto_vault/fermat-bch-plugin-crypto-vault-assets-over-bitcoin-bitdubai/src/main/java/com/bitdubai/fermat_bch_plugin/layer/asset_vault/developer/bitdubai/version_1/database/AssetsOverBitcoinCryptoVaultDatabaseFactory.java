...
public class AssetsOverBitcoinCryptoVaultDatabaseFactory implements DealsWithPluginDatabaseSystem {
    ...
    protected Database createDatabase(UUID ownerId, String databaseName) throws CantCreateDatabaseException {
        ...
        try {
            ...
            table.addColumn(AssetsOverBitcoinCryptoVaultDatabaseConstants.KEY_MAINTENANCE_BLOCKCHAIN_NETWORK_TYPE_COLUMN_NAME, DatabaseDataType.STRING, 30, Boolean.FALSE);
