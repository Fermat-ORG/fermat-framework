 ...
 */
public class FermatNetworkParameters extends AbstractBitcoinNetParams {
    public FermatNetworkParameters() {
        super();
        interval = INTERVAL;
        targetTimespan = TARGET_TIMESPAN;
        maxTarget = Utils.decodeCompactBits(0x207fffff);
        ...
        genesisBlock.setTime(1463452181);
        genesisBlock.setNonce(1875087468);
        id = ID_MAINNET;
        subsidyDecreaseBlockCount = 210000;
        spendableCoinbaseDepth = 100;
        String genesisHash = genesisBlock.getHashAsString();
        checkState(genesisHash.equals("24b90407b8dca388edf483b869bff3175dc459ee5fe65e10bcf9e188b0e40b45"),
                genesisHash);
        ...
        checkpoints.put(0, Sha256Hash.wrap("24b90407b8dca388edf483b869bff3175dc459ee5fe65e10bcf9e188b0e40b45"));

        dnsSeeds = new String[] {
                "52.27.68.19",        // BitcoinNode1
                "52.34.251.168",         // BitcoinNode2
                "52.32.106.35",  // BitcoinNode3
                "52.34.184.168",       // BitcoinNode4
                "52.34.0.33",            // BitcoinNode6
        };
