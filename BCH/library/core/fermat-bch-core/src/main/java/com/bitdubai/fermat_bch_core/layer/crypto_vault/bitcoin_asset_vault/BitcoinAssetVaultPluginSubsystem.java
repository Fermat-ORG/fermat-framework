package com.bitdubai.fermat_bch_core.layer.crypto_vault.bitcoin_asset_vault;
 ...
 * @since Java JDK 1.7
 */
public class BitcoinAssetVaultPluginSubsystem extends AbstractPluginSubsystem {

    public BitcoinAssetVaultPluginSubsystem() {
        super(new PluginReference(Plugins.BITCOIN_ASSET_VAULT));
    }
