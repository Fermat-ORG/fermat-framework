 ...
 */
public class CantMonitorCryptoNetworkException extends FermatException {
    public static final String DEFAULT_MESSAGE = "There was an error Monitoring the Crypto Network.";
     ...
     */
    public CantMonitorCryptoNetworkException(Exception cause, BlockchainProvider blockchainProvider, String possibleReason) {
     ...
     * @param possibleReason
     */
    public CantMonitorCryptoNetworkException(String message, Exception cause, String context, String possibleReason) {
     ...
     * @param possibleReason
     */
    public CantMonitorCryptoNetworkException(Exception cause, String context, String possibleReason) {
