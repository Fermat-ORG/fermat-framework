 ...
 */
public class FactoryDialogCropImage extends FermatDialog implements View.OnClickListener {
    ...
    public FactoryDialogCropImage(Context activity, FermatSession fermatSession, ResourceProviderManager resources, Bitmap image) {
    ...
    protected int setLayoutId() {
        return R.layout.dap_factory_dialog_crop_image;
    }
