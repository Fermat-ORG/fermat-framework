 ...
 * @version 1.0
 */
public class AssetFactorySessionReferenceApp extends AbstractReferenceAppFermatSession<InstalledSubApp, AssetFactoryModuleManager, SubAppResourcesProviderManager> {
...
//    private SubAppSettings subAppSettings;
     ...
     */
    public AssetFactorySessionReferenceApp(String publicKey, InstalledSubApp installedSubApp, ErrorManager errorManager, AssetFactoryModuleManager manager, SubAppResourcesProviderManager subAppResourcesProviderManager) {
...
//        this.manager = manager;
    ...
    public AssetFactorySessionReferenceApp() {
...
//    }
    ...
    public boolean equals(Object o) {
        ...
        AssetFactorySessionReferenceApp that = (AssetFactorySessionReferenceApp) o;
