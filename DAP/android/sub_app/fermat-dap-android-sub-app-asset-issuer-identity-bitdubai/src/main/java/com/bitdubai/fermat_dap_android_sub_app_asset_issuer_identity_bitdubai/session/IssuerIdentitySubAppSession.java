 ...
 */
public class IssuerIdentitySubAppSession implements SubAppsSession {
     ...
     */
    public IssuerIdentitySubAppSession(SubApps subApps, ErrorManager errorManager, IdentityAssetIssuerManager moduleManager) {
     ...
     * @param subApps the SubApp type
     */
    public IssuerIdentitySubAppSession(SubApps subApps) {
        this.subApps = subApps;
    }
