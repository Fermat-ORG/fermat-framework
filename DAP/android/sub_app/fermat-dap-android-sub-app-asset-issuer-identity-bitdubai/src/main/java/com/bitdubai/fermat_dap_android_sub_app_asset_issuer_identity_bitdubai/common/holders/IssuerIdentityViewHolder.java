package com.bitdubai.fermat_dap_android_sub_app_asset_issuer_identity_bitdubai.common.holders;
 ...
 */
public class IssuerIdentityViewHolder extends FermatViewHolder {

    private ImageView identityImage;
    private FermatTextView identityName;

    public IssuerIdentityViewHolder(View itemView) {
        super(itemView);
