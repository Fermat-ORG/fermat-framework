    ...
    public void onClick(View v) {
        ...
        if (i == R.id.positive_button) {
            try {
                ...
                Toast.makeText(getContext(),"Connection has been acepted" , Toast.LENGTH_LONG).show();
                dismiss();
...
//                Toast.makeText(getContext(), actorIssuer.getRecord().getName() + " " + R.string.connection_request_deny, Toast.LENGTH_LONG).show();
                Toast.makeText(getContext()," Connection has been denied" , Toast.LENGTH_LONG).show();
