package org.fermat.fermat_dap_android_sub_app_asset_issuer_community_bitdubai.navigation_drawer;
 ...
 */
public class IssuerCommunityNavigationAdapter extends FermatAdapter<MenuItem, IssuerNavigationHolder> {


    Typeface tf;

    protected IssuerCommunityNavigationAdapter(Context context) {
        super(context);
    }

    public IssuerCommunityNavigationAdapter(Context context, List<MenuItem> dataSet) {
     ...
     */
    @Override
    protected IssuerNavigationHolder createHolder(View itemView, int type) {
        return new IssuerNavigationHolder(itemView);
    }
    ...
    protected int getCardViewResource() {
        return R.layout.dap_navigation_drawer_community_issuer_content;
    }
     ...
     */
    @Override
    protected void bindHolder(IssuerNavigationHolder holder, MenuItem data, int position) {
