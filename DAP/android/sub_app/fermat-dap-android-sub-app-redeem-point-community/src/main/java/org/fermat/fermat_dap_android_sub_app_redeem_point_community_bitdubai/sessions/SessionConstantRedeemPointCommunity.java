package org.fermat.fermat_dap_android_sub_app_redeem_point_community_bitdubai.sessions;

/**
 * Created by Nerio on 19/01/16.
 */
public class SessionConstantRedeemPointCommunity {
    ...
    public static final String LOCAL_BROADCAST_CHANNEL = "sub.app.actor.redeem.community.broadcast.chanel";
    public static final String BROADCAST_CONNECTED_UPDATE = "sub.app.actor.redeem.community.broadcast.connected";
    ...
    public static final int IC_ACTION_REDEEM_COMMUNITY_HELP_UNSELECT_ALL= 603;
    ...
    public static final int IC_ACTION_REDEEM_COMMUNITY_DISCONNECT = 606;
    public static final int IC_ACTION_REDEEM_COMMUNITY_CANCEL_CONNECTING = 607;
}
