package com.bitdubai.fermat_dap_android_sub_app_asset_user_identity_bitdubai.session;
 ...
 */
public class UserIdentitySubAppSession implements SubAppsSession {
     ...
     */
    public UserIdentitySubAppSession(SubApps subApps, ErrorManager errorManager, IdentityAssetUserManager moduleManager) {
     ...
     * @param subApps the SubApp type
     */
    public UserIdentitySubAppSession(SubApps subApps) {
        this.subApps = subApps;
    }
