 ...
 */
public class SessionConstantsAssetUser {
    ...
    public static final int IC_ACTION_USER_HELP_PRESENTATION = 200;
    public static final int IC_ACTION_USER_HELP_DETAIL = 201;
    public static final int IC_ACTION_USER_HELP_REDEEM = 202;
