    ...
    private void setUpPresentation(boolean checkButton) {
        try {
            PresentationDialogDAP presentationDialog = new PresentationDialogDAP.Builder(getActivity(), appSession)
                    ...
                    .setTemplateType((moduleManager.getActiveAssetRedeemPointIdentity() == null) ? PresentationDialogDAP.TemplateType.TYPE_PRESENTATION : PresentationDialogDAP.TemplateType.TYPE_PRESENTATION_WITHOUT_IDENTITIES)
