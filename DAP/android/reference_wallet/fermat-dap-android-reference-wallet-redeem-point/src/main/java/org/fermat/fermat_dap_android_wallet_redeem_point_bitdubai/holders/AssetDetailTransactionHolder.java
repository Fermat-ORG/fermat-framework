package org.fermat.fermat_dap_android_wallet_redeem_point_bitdubai.holders;
...
public class AssetDetailTransactionHolder extends FermatViewHolder {
     ...
     * @param itemView
     */
    public AssetDetailTransactionHolder(View itemView, AssetRedeemPointWalletSubAppModule manager, Context context) {
        super(itemView);
    ...
    public void bind(final Transaction transaction) {
        ...
        String symbol;
        String confirmedStr = res.getString(R.string.dap_redeem_point_wallet_confirmed);
        String pendingStr = res.getString(R.string.dap_redeem_point_wallet_pending);
        ...
        if (balanceTypeText.getText().toString().equals(pendingStr)) {
            balanceTypeText.setTextColor(res.getColor(R.color.dap_redeem_point_wallet_blue_text));
        } else {
            balanceTypeText.setTextColor(res.getColor(R.color.dap_redeem_point_wallet_black_text));
        }
