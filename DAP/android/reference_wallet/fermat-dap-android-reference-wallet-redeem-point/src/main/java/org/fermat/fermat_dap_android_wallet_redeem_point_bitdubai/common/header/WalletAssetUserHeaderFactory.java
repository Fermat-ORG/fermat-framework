package org.fermat.fermat_dap_android_wallet_redeem_point_bitdubai.common.header;
 ...
 */
public class WalletAssetUserHeaderFactory extends HeaderFactory<WalletRedeemPointHeaderClickListener> implements HeaderFactoryInterface{
    ...
    public WalletAssetUserHeaderFactory(ViewGroup mRootView) {
        super(mRootView);
    }
    ...
    @Override
    protected WalletRedeemPointHeaderClickListener setOnClickListener() {
        return new WalletRedeemPointHeaderClickListener();
    }
