...
public class UserAppropiateListFragment extends FermatWalletListFragment<UserAppropiate> {
    ...
    private void setUpHelpAssetAppropiate(boolean checkButton) {
        try {
            PresentationDialog presentationDialog = new PresentationDialog.Builder(getActivity(), appSession)
                    ...
                    .setSubTitle("Asset Issuer Appropiate.")
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        menu.add(0, SessionConstantsAssetIssuer.IC_ACTION_ISSUER_HELP_APPROPIATE, 0, "help").setIcon(R.drawable.dap_asset_issuer_help_icon)
