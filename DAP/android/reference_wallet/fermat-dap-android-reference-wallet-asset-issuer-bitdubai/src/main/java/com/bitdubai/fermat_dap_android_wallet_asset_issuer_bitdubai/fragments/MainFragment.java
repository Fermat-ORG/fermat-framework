...
import com.bitdubai.fermat_dap_android_wallet_asset_issuer_bitdubai.common.adapters.DigitalAssetAdapter;
...
public class MainFragment extends FermatWalletFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            manager = ((AssetIssuerSession) appSession).getManager();
        } catch (Exception ex) {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        FermatWorker worker = new FermatWorker() {
            ...
            protected Object doInBackground() throws Exception {
                ...
                assetIssuerWalletList = manager.getAssetIssuerWalletBalances("walletPublicKeyTest");
