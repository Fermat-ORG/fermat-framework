...
public class IncomingAssetOnCryptoNetworkWaitingTransferenceAssetIssuerEventTest {
    ...
    public void test_OK() throws Exception {
        assetIssuingRecorderService.incomingAssetOnCryptoNetworkWaitingTransferenceAssetIssuerEvent(event);
    }
    ...
    public void test_Throws_CantSaveEventException() throws Exception {
        ...
        catchException(assetIssuingRecorderService).incomingAssetOnCryptoNetworkWaitingTransferenceAssetIssuerEvent(event);
