...
public class PersistGenesisAddressTest {
    ...
    String genesisAddress = "genesisAddress";
    ...
    public void test_OK() throws Exception {
        assetIssuingDAO.persistGenesisAddress(transactionId, genesisAddress);
    }

    @Test
    public void test_Throws_CantPersistsGenesisAddressException() throws Exception {
        doThrow(new CantUpdateRecordException("error")).when(databaseTable).updateRecord(databaseTableRecord);
        catchException(assetIssuingDAO).persistGenesisAddress(transactionId, genesisAddress);
        Exception thrown = caughtException();
        assertThat(thrown)
                .isNotNull()
                .isInstanceOf(CantPersistsGenesisAddressException.class);
