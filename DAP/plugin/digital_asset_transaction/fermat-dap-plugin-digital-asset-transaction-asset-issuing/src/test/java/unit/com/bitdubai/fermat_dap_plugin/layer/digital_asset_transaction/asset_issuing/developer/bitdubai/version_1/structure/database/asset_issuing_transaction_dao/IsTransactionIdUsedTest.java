...
public class IsTransactionIdUsedTest {
    ...
    boolean isTransactionIdUsedExpected = true;
    ...
    public void test_OK() throws Exception {
        boolean isTransactionIdUsed = assetIssuingDAO.isTransactionIdUsed(transactionId);
        assertThat(isTransactionIdUsed).isEqualTo(isTransactionIdUsedExpected);
    }
    ...
    public void test_Throws_CantCheckAssetIssuingProgressException() throws Exception {
        ...
        catchException(assetIssuingDAO).isTransactionIdUsed(transactionId);
