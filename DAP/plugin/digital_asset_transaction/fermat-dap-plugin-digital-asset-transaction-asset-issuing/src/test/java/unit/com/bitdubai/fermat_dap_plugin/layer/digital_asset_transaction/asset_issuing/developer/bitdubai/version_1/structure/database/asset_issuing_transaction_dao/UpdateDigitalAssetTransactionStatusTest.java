...
public class UpdateDigitalAssetTransactionStatusTest {
    ...
    public void test_OK() throws Exception {
        assetIssuingDAO.updateDigitalAssetTransactionStatus(transactionID, TransactionStatus.FORMING_GENESIS);
    }
    ...
    public void test_Throws_CantExecuteQueryException() throws Exception {
        ...
        catchException(assetIssuingDAO).updateDigitalAssetTransactionStatus(transactionID, TransactionStatus.FORMING_GENESIS);
