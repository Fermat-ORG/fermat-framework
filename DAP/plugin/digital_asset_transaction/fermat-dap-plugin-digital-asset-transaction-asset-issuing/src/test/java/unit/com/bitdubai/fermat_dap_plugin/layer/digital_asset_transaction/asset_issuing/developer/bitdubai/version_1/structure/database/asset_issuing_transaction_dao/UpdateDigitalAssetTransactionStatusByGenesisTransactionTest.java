...
public class UpdateDigitalAssetTransactionStatusByGenesisTransactionTest {
    ...
    public void test_OK() throws Exception {
        assetIssuingDAO.updateDigitalAssetTransactionStatusByGenesisTransaction(transactionID, TransactionStatus.FORMING_GENESIS);
    }
    ...
    public void test_Throws_CantExecuteQueryException() throws Exception {
        ...
        catchException(assetIssuingDAO).updateDigitalAssetTransactionStatusByGenesisTransaction(transactionID, TransactionStatus.FORMING_GENESIS);
