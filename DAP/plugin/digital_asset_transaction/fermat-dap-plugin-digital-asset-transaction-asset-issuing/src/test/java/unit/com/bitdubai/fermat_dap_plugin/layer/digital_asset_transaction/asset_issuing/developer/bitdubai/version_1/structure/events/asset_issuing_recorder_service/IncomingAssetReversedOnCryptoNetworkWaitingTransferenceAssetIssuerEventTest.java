...
public class IncomingAssetReversedOnCryptoNetworkWaitingTransferenceAssetIssuerEventTest {
    ...
    public void test_OK() throws Exception {
        assetIssuingRecorderService.incomingAssetReversedOnCryptoNetworkWaitingTransferenceAssetIssuerEvent(event);
    }
    ...
    public void test_Throws_CantSaveEventException() throws Exception {
        ...
        catchException(assetIssuingRecorderService).incomingAssetReversedOnCryptoNetworkWaitingTransferenceAssetIssuerEvent(event);
