...
public class GetGenesisTransactionsFromDigitalAssetsReceivedTest {
    ...
    private void mockitoRules() throws Exception {
        ...
        when(databaseTableRecord.getStringValue(AssetIssuingDatabaseConstants.ASSET_ISSUING_GENESIS_TRANSACTION_COLUMN_NAME)).thenReturn(genesisTransactionExpected);
    }

    @Test
    public void test_OK() throws Exception {
        List<String> genesisTransactions = assetIssuingDAO.getGenesisTransactionsFromDigitalAssetsReceived();
