...
import org.fermat.fermat_dap_plugin.layer.digital_asset_transaction.asset_issuing.developer.bitdubai.version_1.exceptions.CantCheckAssetIssuingProgressException;
...
public class UpdateDigitalAssetTransactionStatusByTransactionHashTest {
    ...
    TransactionStatus transactionStatus = TransactionStatus.FORMING_GENESIS;
    ...
    public void test_OK() throws Exception {
        assetIssuingDAO.updateDigitalAssetTransactionStatusByTransactionHash(transactionHash, transactionStatus);
    }
    ...
    public void test_Throws_CantCheckAssetIssuingProgressException() throws Exception {
        ...
        catchException(assetIssuingDAO).updateDigitalAssetTransactionStatusByTransactionHash(transactionHash, transactionStatus);
