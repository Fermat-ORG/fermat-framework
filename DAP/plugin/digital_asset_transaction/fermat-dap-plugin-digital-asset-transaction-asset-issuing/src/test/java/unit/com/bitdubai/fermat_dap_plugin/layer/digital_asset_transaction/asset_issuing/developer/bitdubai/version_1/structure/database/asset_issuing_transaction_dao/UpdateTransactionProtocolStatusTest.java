...
public class UpdateTransactionProtocolStatusTest {
    ...
    public void test_OK() throws Exception {
        assetIssuingDAO.updateTransactionProtocolStatus(transactionID, ProtocolStatus.NO_ACTION_REQUIRED);
    }
    ...
    public void test_Throws_CantExecuteQueryException() throws Exception {
        ...
        catchException(assetIssuingDAO).updateTransactionProtocolStatus(transactionID, ProtocolStatus.NO_ACTION_REQUIRED);
