...
public class GetIssuingStatusByPublicKeyTest {
    ...
    private void mockitoRules() throws Exception {
        ...
        when(databaseTableRecord.getStringValue(AssetIssuingDatabaseConstants.ASSET_ISSUING_ISSUING_STATUS_COLUMN_NAME)).thenReturn(issuingStatusExpected);
    }

    @Test
    public void test_OK() throws Exception {
        String issuingStatus = assetIssuingDAO.getIssuingStatusByPublicKey(publicKey);
    ...
    public void test_Throws_CantCheckAssetIssuingProgressException() throws Exception {
        ...
        catchException(assetIssuingDAO).getIssuingStatusByPublicKey(publicKey);
