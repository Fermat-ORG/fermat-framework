...
import com.bidbubai.fermat_dap_plugin.layer.digital_asset_transaction.issuer_redemption.bitdubai.version_1.structure.events.IssuerRedemptionMonitorAgent;
...
public class IssuerRedemptionDigitalAssetTransactionPluginRoot extends AbstractPlugin implements
    ...
    public void start() throws CantStartPluginException {
        ...
        try {
            ...
            IssuerRedemptionMonitorAgent issuerRedemptionMonitorAgent = new IssuerRedemptionMonitorAgent(assetIssuerWalletManager, actorAssetIssuerManager, bitcoinNetworkManager, cryptoAddressBookManager, errorManager, pluginId, pluginDatabaseSystem, AssetVaultManager, issuerAppropriationManager, walletMiddlewareManager, assetTransmissionManager);
            try {
