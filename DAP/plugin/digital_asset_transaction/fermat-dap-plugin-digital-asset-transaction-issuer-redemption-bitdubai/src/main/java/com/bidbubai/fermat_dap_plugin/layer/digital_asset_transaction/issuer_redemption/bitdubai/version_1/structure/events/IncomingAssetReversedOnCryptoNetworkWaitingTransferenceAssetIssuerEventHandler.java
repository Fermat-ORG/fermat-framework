...
public class IncomingAssetReversedOnCryptoNetworkWaitingTransferenceAssetIssuerEventHandler implements FermatEventHandler {
    ...
    public void handleEvent(FermatEvent fermatEvent) throws FermatException {
        ...
        if(this.issuerRedemptionRecorderService.getStatus()== ServiceStatus.STARTED) {
            ...
            try {
                this.issuerRedemptionRecorderService.incomingAssetReversedOnCryptoNetworkWaitingTransferenceAssetIssuerEvent((IncomingAssetReversedOnCryptoNetworkNetworkWaitingTransferenceAssetIssuerEvent) fermatEvent);
