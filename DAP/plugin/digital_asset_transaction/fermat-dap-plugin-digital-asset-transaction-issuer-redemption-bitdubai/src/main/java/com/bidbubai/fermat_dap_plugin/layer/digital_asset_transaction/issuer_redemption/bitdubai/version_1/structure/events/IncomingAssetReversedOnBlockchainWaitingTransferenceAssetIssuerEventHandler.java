...
public class IncomingAssetReversedOnBlockchainWaitingTransferenceAssetIssuerEventHandler implements FermatEventHandler {
    ...
    public void handleEvent(FermatEvent fermatEvent) throws FermatException {
        ...
        if(this.issuerRedemptionRecorderService.getStatus()== ServiceStatus.STARTED) {
            ...
            try {
                this.issuerRedemptionRecorderService.incomingAssetReversedOnBlockchainWaitingTransferenceAssetIssuerEvent((IncomingAssetReversedOnBlockchainWaitingTransferenceAssetIssuerEvent) fermatEvent);
