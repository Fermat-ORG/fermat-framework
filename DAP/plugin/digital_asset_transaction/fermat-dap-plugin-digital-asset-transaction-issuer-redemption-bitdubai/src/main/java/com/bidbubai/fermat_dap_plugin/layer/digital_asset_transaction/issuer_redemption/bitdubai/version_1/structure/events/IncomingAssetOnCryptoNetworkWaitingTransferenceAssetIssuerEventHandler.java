...
public class IncomingAssetOnCryptoNetworkWaitingTransferenceAssetIssuerEventHandler implements FermatEventHandler {
    ...
    public void handleEvent(FermatEvent fermatEvent) throws FermatException {
        ...
        if(this.issuerRedemptionRecorderService.getStatus()== ServiceStatus.STARTED) {
            ...
            try {
                this.issuerRedemptionRecorderService.incomingAssetOnCryptoNetworkWaitingTransferenceAssetIssuerEvent((IncomingAssetOnCryptoNetworkWaitingTransferenceAssetIssuerEvent) fermatEvent);
