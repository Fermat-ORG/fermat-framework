...
public class AssetRedeemPointRedemptionDatabaseFactory implements DealsWithPluginDatabaseSystem {
    ...
    public Database createDatabase(UUID ownerId) throws CantCreateDatabaseException {
        ...
        try {
            ...
            eventsRecorderTable.addColumn(AssetRedeemPointRedemptionDatabaseConstants.ASSET_RPR_EVENTS_RECORDED_ID_COLUMN_NAME, DatabaseDataType.STRING, 255, Boolean.TRUE);
            ...
            metadataTable.addColumn(AssetRedeemPointRedemptionDatabaseConstants.ASSET_RPR_METADATA_TABLE_FIRST_KEY_COLUMN, DatabaseDataType.STRING, 255, Boolean.TRUE);
