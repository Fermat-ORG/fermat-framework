...
public class IncomingAssetReversedOnBlockchainWaitingTransferenceAssetUserEventHandler implements FermatEventHandler {
    ...
    public void handleEvent(FermatEvent fermatEvent) throws FermatException {
        ...
        if(this.assetDistributionRecorderService.getStatus()== ServiceStatus.STARTED) {
            ...
            try {
                this.assetDistributionRecorderService.incomingAssetReversedOnBlockchainWaitingTransferenceAssetUserEvent((IncomingAssetReversedOnBlockchainWaitingTransferenceAssetUserEvent) fermatEvent);
