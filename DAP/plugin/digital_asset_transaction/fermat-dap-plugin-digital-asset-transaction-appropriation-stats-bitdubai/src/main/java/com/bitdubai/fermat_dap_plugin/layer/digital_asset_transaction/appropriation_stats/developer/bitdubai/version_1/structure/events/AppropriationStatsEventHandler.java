 ...
 */
public class AppropriationStatsEventHandler implements FermatEventHandler {

    //VARIABLE DECLARATION
    private AppropriationStatsRecorderService recorderService;

    //CONSTRUCTORS

    public AppropriationStatsEventHandler(AppropriationStatsRecorderService recorderService) {
