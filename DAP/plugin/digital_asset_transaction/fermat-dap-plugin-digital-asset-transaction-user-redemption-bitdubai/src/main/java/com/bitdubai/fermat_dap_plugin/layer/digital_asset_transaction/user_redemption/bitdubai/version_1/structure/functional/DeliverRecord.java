...
public class DeliverRecord {
    ...
    public DeliverRecord(String transactionId, String genesisTransaction, DigitalAssetMetadata digitalAssetMetadata, String redeemPointPublicKey, Date startTime, Date timeOut, DistributionStatus state, String genesisTransactionSent, int attemptNumber) {
