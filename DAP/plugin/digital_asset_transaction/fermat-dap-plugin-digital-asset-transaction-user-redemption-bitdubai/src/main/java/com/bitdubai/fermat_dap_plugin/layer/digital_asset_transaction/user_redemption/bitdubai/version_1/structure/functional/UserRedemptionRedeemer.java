...
public class UserRedemptionRedeemer extends AbstractDigitalAssetSwap {
    ...
    private void deliverToRemoteActor(DigitalAssetMetadata digitalAssetMetadata, ActorAssetRedeemPoint actorAssetRedeemPoint, BlockchainNetworkType networkType) throws CantSendDigitalAssetMetadataException {
        ...
        try {
            ...
            assetTransmissionNetworkServiceManager.sendDigitalAssetMetadata(new DAPMessage(new AssetMetadataContentMessage(digitalAssetMetadata), actorAssetUser, actorAssetRedeemPoint));
        } catch (CantExecuteQueryException exception) {
        ...
        } catch (UnexpectedResultReturnedFromDatabaseException | CantSetObjectException | CantStartDeliveringException exception) {
