...
public class IncomingAssetOnCryptoNetworkWaitingTransferenceAssetUserEventHandler implements FermatEventHandler {
    ...
    public void handleEvent(FermatEvent fermatEvent) throws FermatException {
        ...
        if(this.userRedemptionRecorderService.getStatus()== ServiceStatus.STARTED) {
            ...
            try {
                this.userRedemptionRecorderService.incomingAssetOnCryptoNetworkWaitingTransferenceAssetUserEvent((IncomingAssetOnCryptoNetworkWaitingTransferenceAssetUserEvent) fermatEvent);
