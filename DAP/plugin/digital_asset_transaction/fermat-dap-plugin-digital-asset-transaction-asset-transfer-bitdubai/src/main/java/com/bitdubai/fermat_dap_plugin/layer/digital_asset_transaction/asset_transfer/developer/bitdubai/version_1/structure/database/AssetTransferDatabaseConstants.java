...
public class AssetTransferDatabaseConstants {
    ...
    public static final String ASSET_TRANSFER_DATABASE = "asset_distribution_database";
    /**
     * Asset Distribution database table definition.
     */
    public static final String ASSET_TRANSFER_TABLE_NAME = "asset_distribution";
    ...
    public static final String ASSET_TRANSFER_TRANSFERENCE_STATUS_COLUMN_NAME = "distribution_status";
    ...
    public static final String ASSET_TRANSFER_TRANSFERENCE_ID_COLUMN_NAME = "distribution_id";
     ...
     */
    public static final String ASSET_TRANSFER_EVENTS_RECORDED_TABLE_NAME = "distribution_events_recorded";
