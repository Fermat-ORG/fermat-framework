...
public class UpdateDigitalAssetTransactionStatusByTransactionHashTest {
    ...
    public void test_OK() throws Exception {
        assetIssuingTransactionDao.updateDigitalAssetTransactionStatusByTransactionHash(transactionHash, transactionStatus);
    }
    ...
    public void test_Throws_CantCheckAssetIssuingProgressException() throws Exception {
        ...
        catchException(assetIssuingTransactionDao).updateDigitalAssetTransactionStatusByTransactionHash(transactionHash, transactionStatus);
