package unit.com.bitdubai.fermat_dap_plugin.layer.digital_asset_transaction.asset_issuing.developer.bitdubai.version_1.structure.events.incoming_asset_on_crypto_network_waiting_transference_asset_issuer_event;
...
import com.bitdubai.fermat_dap_plugin.layer.digital_asset_transaction.asset_issuing.developer.bitdubai.version_1.structure.events.IncomingAssetOnCryptoNetworkWaitingTransferenceAssetIssuerEventHandler;
...
public class HandleEventTest {
    IncomingAssetOnCryptoNetworkWaitingTransferenceAssetIssuerEventHandler incomingAssetOnCryptoNetworkWaitingTransferenceAssetIssuerEventHandler;
    ...
    @Mock
    IncomingAssetOnCryptoNetworkWaitingTransferenceAssetIssuerEvent event;
    ...
    public void setUp() throws Exception {
        ...
        incomingAssetOnCryptoNetworkWaitingTransferenceAssetIssuerEventHandler = new IncomingAssetOnCryptoNetworkWaitingTransferenceAssetIssuerEventHandler();
        incomingAssetOnCryptoNetworkWaitingTransferenceAssetIssuerEventHandler.setAssetIssuingRecorderService(assetIssuingRecorderService);
    ...
    public void test_OK() throws Exception {
        incomingAssetOnCryptoNetworkWaitingTransferenceAssetIssuerEventHandler.handleEvent(event);
    }
}
