...
//        when(mockExtraUserActorDatabaseFactory.createDatabase(pluginId, pluginId.toString())).thenReturn(mockDatabase);
    ...
    @Test
    public void test_DatabaseNotFoundException() throws Exception {
        DatabaseNotFoundException exception = new DatabaseNotFoundException("mensaje");
        when(pluginDatabaseSystem.openDatabase(this.pluginId, AssetIssuingTransactionDatabaseConstants.DIGITAL_ASSET_TRANSACTION_DATABASE)).thenThrow(exception);
    }

    public void test_CantOpenDatabaseException() throws Exception {

    }

    @Test
    public void test_CantCreateDatabaseException() throws Exception {

    }

    @Test
    public void test_CantSetObjectException() throws Exception {

    }

    @Test
    public void test_CantExecuteDatabaseOperationException() throws Exception {

    }

    @Test
    public void test_CantStartAgentException() throws Exception {
