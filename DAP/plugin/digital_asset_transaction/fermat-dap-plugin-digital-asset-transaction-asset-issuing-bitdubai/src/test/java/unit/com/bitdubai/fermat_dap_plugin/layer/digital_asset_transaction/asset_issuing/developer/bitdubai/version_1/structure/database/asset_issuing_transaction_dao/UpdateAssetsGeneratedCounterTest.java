...
public class UpdateAssetsGeneratedCounterTest {
    ...
    public void test_OK() throws Exception {
        assetIssuingTransactionDao.updateAssetsGeneratedCounter(assetPublicKey);
    }
    ...
    public void test_Throws_CantCheckAssetIssuingProgressException() throws Exception {
        ...
        catchException(assetIssuingTransactionDao).updateAssetsGeneratedCounter(assetPublicKey);
