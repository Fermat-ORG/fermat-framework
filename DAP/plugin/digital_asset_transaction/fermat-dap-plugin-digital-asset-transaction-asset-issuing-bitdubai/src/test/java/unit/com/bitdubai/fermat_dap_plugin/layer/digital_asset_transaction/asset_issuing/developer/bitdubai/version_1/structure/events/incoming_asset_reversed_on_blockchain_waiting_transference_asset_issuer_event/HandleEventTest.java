package unit.com.bitdubai.fermat_dap_plugin.layer.digital_asset_transaction.asset_issuing.developer.bitdubai.version_1.structure.events.incoming_asset_reversed_on_blockchain_waiting_transference_asset_issuer_event;
...
import com.bitdubai.fermat_dap_plugin.layer.digital_asset_transaction.asset_issuing.developer.bitdubai.version_1.structure.events.IncomingAssetReversedOnBlockchainWaitingTransferenceAssetIssuerEventHandler;
...
public class HandleEventTest {
    IncomingAssetReversedOnBlockchainWaitingTransferenceAssetIssuerEventHandler incomingAssetReversedOnBlockchainWaitingTransferenceAssetIssuerEventHandler;
    ...
    public void setUp() throws Exception {
        ...
        incomingAssetReversedOnBlockchainWaitingTransferenceAssetIssuerEventHandler = new IncomingAssetReversedOnBlockchainWaitingTransferenceAssetIssuerEventHandler();
        incomingAssetReversedOnBlockchainWaitingTransferenceAssetIssuerEventHandler.setAssetIssuingRecorderService(assetIssuingRecorderService);
    ...
    public void test_OK() throws Exception {
        incomingAssetReversedOnBlockchainWaitingTransferenceAssetIssuerEventHandler.handleEvent(event);
    }
}
