...
public class IsTransactionIdUsedTest {
    ...
    public void test_OK() throws Exception {
        boolean isTransactionIdUsed = assetIssuingTransactionDao.isTransactionIdUsed(transactionId);
    ...
    public void test_Throws_CantCheckAssetIssuingProgressException() throws Exception {
        ...
        catchException(assetIssuingTransactionDao).isTransactionIdUsed(transactionId);
