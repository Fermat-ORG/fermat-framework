...
public class PersistGenesisAddressTest {
    ...
    public void test_OK() throws Exception {
        assetIssuingTransactionDao.persistGenesisAddress(transactionId, genesisAddress);
    }
    ...
    public void test_Throws_CantPersistsGenesisAddressException() throws Exception {
        ...
        catchException(assetIssuingTransactionDao).persistGenesisAddress(transactionId, genesisAddress);
