package unit.com.bitdubai.fermat_dap_plugin.layer.digital_asset_transaction.asset_issuing.developer.bitdubai.version_1.structure.events.incoming_asset_reversed_on_crypto_network_waiting_transference_asset_issuer_event;
...
import com.bitdubai.fermat_dap_plugin.layer.digital_asset_transaction.asset_issuing.developer.bitdubai.version_1.structure.events.IncomingAssetReversedOnCryptoNetworkWaitingTransferenceAssetIssuerEventHandler;
...
public class HandleEventTest {
    IncomingAssetReversedOnCryptoNetworkWaitingTransferenceAssetIssuerEventHandler incomingAssetReversedOnCryptoNetworkWaitingTransferenceAssetIssuerEventHandler;
    ...
    @Mock
    IncomingAssetReversedOnCryptoNetworkNetworkWaitingTransferenceAssetIssuerEvent event;
    ...
    public void setUp() throws Exception {
        ...
        incomingAssetReversedOnCryptoNetworkWaitingTransferenceAssetIssuerEventHandler = new IncomingAssetReversedOnCryptoNetworkWaitingTransferenceAssetIssuerEventHandler();
        incomingAssetReversedOnCryptoNetworkWaitingTransferenceAssetIssuerEventHandler.setAssetIssuingRecorderService(assetIssuingRecorderService);
    ...
    public void test_OK() throws Exception {
        incomingAssetReversedOnCryptoNetworkWaitingTransferenceAssetIssuerEventHandler.handleEvent(event);
    }
}
