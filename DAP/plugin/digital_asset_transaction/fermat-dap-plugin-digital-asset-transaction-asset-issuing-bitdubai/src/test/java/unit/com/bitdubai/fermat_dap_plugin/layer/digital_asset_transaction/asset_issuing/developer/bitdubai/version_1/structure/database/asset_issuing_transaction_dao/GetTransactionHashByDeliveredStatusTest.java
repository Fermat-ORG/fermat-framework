...
public class GetTransactionHashByDeliveredStatusTest {
    ...
    private void mockitoRules() throws Exception {
        ...
        when(databaseTableRecord.getStringValue(AssetIssuingTransactionDatabaseConstants.DIGITAL_ASSET_TRANSACTION_ASSET_ISSUING_DIGITAL_ASSET_HASH_COLUMN_NAME)).thenReturn(transactionHashExpected);
    }

    @Test
    public void test_OK() throws Exception {
        List<String> transactionHashList = assetIssuingTransactionDao.getTransactionHashByDeliveredStatus();
    ...
    public void test_Throws_CantCheckAssetIssuingProgressException() throws Exception {
        ...
        catchException(assetIssuingTransactionDao).getTransactionHashByDeliveredStatus();
