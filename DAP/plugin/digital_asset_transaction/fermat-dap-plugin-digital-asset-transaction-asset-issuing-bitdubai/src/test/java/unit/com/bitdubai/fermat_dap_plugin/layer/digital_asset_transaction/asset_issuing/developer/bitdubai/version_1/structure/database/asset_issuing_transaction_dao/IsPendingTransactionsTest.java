...
public class IsPendingTransactionsTest {
    ...
    public void test_OK() throws Exception {
        boolean isPendingTransactions = assetIssuingTransactionDao.isPendingTransactions(cryptoStatus);
    ...
    public void test_Throws_CantExecuteQueryException() throws Exception {
        ...
        catchException(assetIssuingTransactionDao).isPendingTransactions(cryptoStatus);
