...
public class UpdateTransactionProtocolStatusTest {
    ...
    public void test_OK() throws Exception {
        assetIssuingTransactionDao.updateTransactionProtocolStatus(transactionID, ProtocolStatus.NO_ACTION_REQUIRED);
    }
    ...
    public void test_Throws_CantExecuteQueryException() throws Exception {
        ...
        catchException(assetIssuingTransactionDao).updateTransactionProtocolStatus(transactionID, ProtocolStatus.NO_ACTION_REQUIRED);
