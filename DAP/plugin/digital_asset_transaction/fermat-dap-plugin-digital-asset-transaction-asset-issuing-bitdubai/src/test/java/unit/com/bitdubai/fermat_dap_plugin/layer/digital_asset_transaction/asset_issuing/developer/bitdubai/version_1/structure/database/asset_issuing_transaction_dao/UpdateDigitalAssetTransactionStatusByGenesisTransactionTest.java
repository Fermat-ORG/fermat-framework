...
public class UpdateDigitalAssetTransactionStatusByGenesisTransactionTest {
    ...
    public void test_OK() throws Exception {
        assetIssuingTransactionDao.updateDigitalAssetTransactionStatusByGenesisTransaction(transactionID, TransactionStatus.FORMING_GENESIS);
    }
    ...
    public void test_Throws_CantExecuteQueryException() throws Exception {
        ...
        catchException(assetIssuingTransactionDao).updateDigitalAssetTransactionStatusByGenesisTransaction(transactionID, TransactionStatus.FORMING_GENESIS);
