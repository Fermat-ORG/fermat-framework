...
public class IncomingAssetOnBlockchainWaitingTransferenceAssetIssuerEventHandler implements FermatEventHandler {
    ...
    public void handleEvent(FermatEvent fermatEvent) throws FermatException {
        ...
        if(this.assetIssuingRecorderService.getStatus()== ServiceStatus.STARTED) {
            ...
            try {
                this.assetIssuingRecorderService.incomingAssetOnBlockchainWaitingTransferenceAssetIssuerEvent((IncomingAssetOnBlockchainWaitingTransferenceAssetIssuerEvent) fermatEvent);
