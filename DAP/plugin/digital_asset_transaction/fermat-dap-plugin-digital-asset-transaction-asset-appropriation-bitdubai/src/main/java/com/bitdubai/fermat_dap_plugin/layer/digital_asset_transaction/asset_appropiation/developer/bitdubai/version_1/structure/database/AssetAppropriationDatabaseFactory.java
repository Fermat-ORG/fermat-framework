...
public class AssetAppropriationDatabaseFactory implements DealsWithPluginDatabaseSystem {
    ...
    public Database createDatabase(UUID ownerId) throws CantCreateDatabaseException {
        ...
        try {
            ...
            eventsRecorderTable.addColumn(AssetAppropriationDatabaseConstants.ASSET_APPROPRIATION_EVENTS_RECORDED_ID_COLUMN_NAME, DatabaseDataType.STRING, 200, Boolean.TRUE);
            ...
            transactionMetadataTable.addColumn(AssetAppropriationDatabaseConstants.ASSET_APPROPRIATION_TRANSACTION_METADATA_ID_COLUMN_NAME, DatabaseDataType.STRING, 200, Boolean.TRUE);
