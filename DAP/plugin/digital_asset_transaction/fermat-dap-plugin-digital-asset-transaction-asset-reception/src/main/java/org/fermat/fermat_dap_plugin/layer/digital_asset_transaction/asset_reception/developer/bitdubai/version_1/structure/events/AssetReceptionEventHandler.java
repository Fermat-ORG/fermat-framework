 ...
 */
public class AssetReceptionEventHandler implements FermatEventHandler {

    //VARIABLE DECLARATION
    private AssetReceptionRecorderService recorderService;

    //CONSTRUCTORS


    public AssetReceptionEventHandler(AssetReceptionRecorderService recorderService) {
