 ...
 */
public class AssetRedeemPointWalletDatabaseFactory  implements DealsWithPluginDatabaseSystem {
    /**
    ...
    private DatabaseTableFactory createAssetRedeemPointWalletTableFactory(final UUID ownerId, final DatabaseFactory databaseFactory) throws InvalidOwnerIdException{
        ...
        table.addColumn(AssetWalletRedeemPointDatabaseConstant.ASSET_WALLET_REDEEM_POINT_VERIFICATION_ID_COLUMN_NAME, DatabaseDataType.STRING, 36, false);
