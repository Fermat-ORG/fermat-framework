 ...
 */
public class AssetTransmissionNetworkServicePluginRoot extends AbstractNetworkServiceBase implements DAPNetworkService {
    ...
    public void sendMessage(DAPMessage dapMessage) throws CantSendMessageException {
        ...
        dapMessageDAO = new DAPMessageDAO(dataBase, outgoingMessageDao);

        try {
            dapMessageDAO.sendMessage(dapMessage);
    ...
    public List<DAPMessage> getUnreadDAPMessagesByType(DAPMessageType type) throws CantGetDAPMessagesException {
        dapMessageDAO = new DAPMessageDAO(dataBase,null);

        try {
            return dapMessageDAO.findUnreadByType(type.getCode().toString());
    ...
    public List<DAPMessage> getUnreadDAPMessageBySubject(DAPMessageSubject subject) throws CantGetDAPMessagesException {
        ...
        try {
            return dapMessageDAO.findUnreadBySubject(subject.getCode().toString());
        } catch (CantReadRecordDataBaseException e) {
            throw new CantGetDAPMessagesException();
        }
    }
