...
public class AssetIssuerCommunitySubAppModulePluginRoot extends AbstractModule<AssetIssuerSettings, ActiveActorIdentityInformation> implements
    ...
    public static LogLevel getLogLevelByClass(String className) {
        try {
            ...
            return AssetIssuerCommunitySubAppModulePluginRoot.newLoggingLevel.get(correctedClass[0]);
        } catch (Exception e) {
            /**
...
//            logManager.log(AssetIssuerCommunitySubAppModulePluginRoot.getLogLevelByClass(this.getClass().getName()), "Asset Issuer Sup AppModule instantiation finished successfully.", null, null);
            ...
            throw new CantGetModuleManagerException(CantGetSupAppIssuerModuleException.DEFAULT_MESSAGE, FermatException.wrapException(e).toString());
        }
    }
