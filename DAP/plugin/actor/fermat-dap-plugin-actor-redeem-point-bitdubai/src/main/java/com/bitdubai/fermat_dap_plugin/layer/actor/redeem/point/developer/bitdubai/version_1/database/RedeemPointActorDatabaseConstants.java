...
public class RedeemPointActorDatabaseConstants {
    ...
    static final String REDEEM_POINT_RELATION_REDEEM_POINT_KEY_COLUMN_NAME = "redeem_point_publicKey_actor";
    static final String REDEEM_POINT_RELATION_REDEEM_POINT_NAME_COLUMN_NAME = "redeem_point_name_actor";
    static final String REDEEM_POINT_RELATION_REDEEM_POINT_STATUS_COLUMN_NAME = "redeem_point_status_actor";
    static final String REDEEM_POINT_RELATION_REDEEM_POINT_REGISTRATION_DATE_COLUMN_NAME = "redeem_point_registration_date_actor";
    static final String REDEEM_POINT_RELATION_REDEEM_POINT_MODIFIED_DATE_COLUMN_NAME = "redeem_point_modified_date_actor";

    static final String REDEEM_POINT_RELATION_ASSET_ISSUER_FIRST_KEY_COLUMN = "redeem_point_asset_issuer_publicKey_actor";
    ...
    static final String REDEEM_POINT_RELATION_ASSET_ASSET_NAME_COLUMN_NAME = "asset_user_asset_name_actor";
    static final String REDEEM_POINT_RELATION_ASSET_ASSET_ID_COLUMN_NAME = "asset_user_asset_id_actor";
    static final String REDEEM_POINT_RELATION_ASSET_ASSET_HASH_COLUMN_NAME = "asset_user_asset_hash_actor";
    static final String REDEEM_POINT_RELATION_ASSET_ASSET_STATUS_COLUMN_NAME = "asset_user_asset_status_actor";
    static final String REDEEM_POINT_RELATION_ASSET_ASSET_RESOURCES_COLUMN_NAME = "asset_user_asset_resources_actor";
    static final String REDEEM_POINT_RELATION_ASSET_ASSET_AMOUNT_COLUMN_NAME = "asset_user_asset_amount_actor";
    static final String REDEEM_POINT_RELATION_ASSET_ASSET_CURRENCY_COLUMN_NAME = "asset_user_asset_currency_actor";
    static final String REDEEM_POINT_RELATION_ASSET_ASSET_EXPIRATION_DATE_COLUMN_NAME = "asset_expiration_date_actor";
