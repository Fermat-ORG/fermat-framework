...
public class AssetRedeemPointIdentityDao implements DealsWithPluginDatabaseSystem {
    ...
    public void updateIdentityAssetUser(String publicKey, String alias, byte[] profileImage) throws CantUpdateIdentityRedeemPointException {
        try {
            /**
             * 1) Get the table.
             */
            ...
            table.setStringFilter(AssetRedeemPointIdentityDatabaseConstants.ASSET_REDEEM_POINT_IDENTITY_PUBLIC_KEY_COLUMN_NAME, publicKey, DatabaseFilterType.EQUAL);
            table.loadToMemory();
