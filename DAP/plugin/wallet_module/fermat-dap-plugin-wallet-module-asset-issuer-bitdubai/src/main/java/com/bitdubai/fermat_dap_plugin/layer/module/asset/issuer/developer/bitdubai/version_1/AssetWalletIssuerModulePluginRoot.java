 ...
 */
public class AssetWalletIssuerModulePluginRoot implements Plugin, DealsWithAssetIssuerWallet, Service, DealsWithLogger, LogManagerForDevelopers {
    ...
    public void start() throws CantStartPluginException {
        try {
            ...
            //TODO: Falta el catch (CantStartPluginException exception) que hay que activar al resolver el error en gradle
...
//            throw exception;
    ...
    public List<String> getClassesFullPath() {
        ...
        returnedClasses.add("com.bitdubai.fermat_dap_plugin.layer.sub_app_module.asset.factory.developer.bitdubai.version_1.AssetFactorySubAppModulePluginRoot");
        /**
         * I return the values.
         */
