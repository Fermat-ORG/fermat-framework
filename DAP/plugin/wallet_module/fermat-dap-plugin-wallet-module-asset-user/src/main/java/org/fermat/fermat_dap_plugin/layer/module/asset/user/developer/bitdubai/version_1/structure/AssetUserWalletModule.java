package org.fermat.fermat_dap_plugin.layer.module.asset.user.developer.bitdubai.version_1.structure;
...
public class AssetUserWalletModule {
    ...
    public void redeemAssetToRedeemPoint(CryptoAddress cryptoAddress, String walletPublicKey, List<ActorAssetRedeemPoint> actorAssetRedeemPoint, int assetsAmount, BlockchainNetworkType networkType) throws CantRedeemDigitalAssetException, NotEnoughAcceptsException {
        String context = "Asset Public Key: " + cryptoAddress + " - ActorAssetRedeemPoint: " + actorAssetRedeemPoint;
        try {
            ...
            HashMap<DigitalAssetMetadata, ActorAssetRedeemPoint> hashMap = createRedemptionMap(walletPublicKey, cryptoAddress, actorAssetRedeemPoint, assetsAmount, networkType);
    ...
    private HashMap<DigitalAssetMetadata, ActorAssetRedeemPoint> createRedemptionMap(String walletPublicKey, CryptoAddress cryptoAddress, List<ActorAssetRedeemPoint> redeemPoints, int assetsAmount, BlockchainNetworkType networkType) throws CantGetTransactionsException, FileNotFoundException, CantCreateFileException, CantLoadWalletException, CantGetDigitalAssetFromLocalStorageException, NotEnoughAcceptsException {
        String context = "Asset Public Key: " + cryptoAddress + " - BTC Wallet Public Key: " + walletPublicKey + " - RedeemPoints: " + redeemPoints;
        ...
        List<AssetUserWalletTransaction> availableTransactions = wallet.getAllAvailableTransactions(cryptoAddress);
    ...
    public void transferAsset(CryptoAddress cryptoAddress, String walletPublicKey, List<ActorAssetUser> actorAssetUsers, int assetsAmount, BlockchainNetworkType networkType) throws CantTransferDigitalAssetsException, CantGetTransactionsException, CantCreateFileException, FileNotFoundException, CantLoadWalletException {
        try {
            String context = "Asset PublicKey: " + cryptoAddress + " - Wallet PublicKey: " + walletPublicKey + " - Users: " + actorAssetUsers.toString();
            ...
            HashMap<DigitalAssetMetadata, ActorAssetUser> hashMap = createTransferMap(walletPublicKey, cryptoAddress, actorAssetUsers, assetsAmount, networkType);
    ...
    private HashMap<DigitalAssetMetadata, ActorAssetUser> createTransferMap(String walletPublicKey, CryptoAddress cryptoAddress, List<ActorAssetUser> actorAssetUsers, int assetsAmount, BlockchainNetworkType networkType) throws CantGetTransactionsException, FileNotFoundException, CantCreateFileException, CantLoadWalletException, CantGetDigitalAssetFromLocalStorageException {
        HashMap<DigitalAssetMetadata, ActorAssetUser> hashMap = new HashMap<>();
        AssetUserWallet wallet = assetUserWalletManager.loadAssetUserWallet(walletPublicKey, networkType);
        List<AssetUserWalletTransaction> transactions = wallet.getAllAvailableTransactions(cryptoAddress);
    ...
    public void appropriateAsset(CryptoAddress cryptoAddress, String bitcoinWalletPublicKey, BlockchainNetworkType networkType) throws CantExecuteAppropriationTransactionException, TransactionAlreadyStartedException, NotEnoughAcceptsException {
        String context = "Asset Public Key: " + cryptoAddress + " - BTC Wallet Public Key: " + bitcoinWalletPublicKey;
        try {
