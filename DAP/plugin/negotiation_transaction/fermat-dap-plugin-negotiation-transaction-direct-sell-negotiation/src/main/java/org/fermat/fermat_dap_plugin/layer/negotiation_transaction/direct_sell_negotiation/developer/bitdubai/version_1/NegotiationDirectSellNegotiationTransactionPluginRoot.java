...
import org.fermat.fermat_dap_api.layer.dap_negotiation_transaction.negotiation_direct_sell.interfaces.NegotiationDirectSellManager;
...
/**
 * Created by Víctor Mars (marsvicam@gmail.com) on 16/03/16.
 */
public class NegotiationDirectSellNegotiationTransactionPluginRoot extends AbstractPlugin implements
    ...
    public List<DeveloperDatabaseTableRecord> getDatabaseTableContent(DeveloperObjectFactory developerObjectFactory, DeveloperDatabase developerDatabase, DeveloperDatabaseTable developerDatabaseTable) {
        ...
        try {
            ...
            this.errorManager.reportUnexpectedPluginException(Plugins.ASSET_DIRECT_SELL, UnexpectedPluginExceptionSeverity.DISABLES_SOME_FUNCTIONALITY_WITHIN_THIS_PLUGIN, e);
