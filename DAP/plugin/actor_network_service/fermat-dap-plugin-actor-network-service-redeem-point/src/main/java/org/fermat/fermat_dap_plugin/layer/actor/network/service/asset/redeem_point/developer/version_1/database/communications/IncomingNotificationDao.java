...
public class IncomingNotificationDao {
    ...
    public DatabaseTable getDatabaseTable() {
        return database.getTable(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_TABLE_NAME);
    }
...
//                        senderPhrase,
    ...
    public List<ActorNotification> listUnreadNotifications() throws CantGetActorAssetNotificationException {
        ...
        try {
            ...
            cryptoPaymentRequestTable.addStringFilter(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_READ_MARK_COLUMN_NAME, String.valueOf(false), DatabaseFilterType.EQUAL);
    ...
    public void update(ActorAssetNetworkServiceRecord entity) throws CantUpdateRecordDataBaseException {
        ...
        try {
            ...
            //Set filter
            incomingNotificationtable.addUUIDFilter(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_ID_COLUMN_NAME, entity.getId(), DatabaseFilterType.EQUAL);
    ...
    public ActorAssetNetworkServiceRecord getNotificationById(final UUID notificationId) throws CantGetActorAssetNotificationException {
        ...
        try {
            ...
            cryptoPaymentRequestTable.addUUIDFilter(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_ID_COLUMN_NAME, notificationId, DatabaseFilterType.EQUAL);
    ...
    public void changeProtocolState(final UUID requestId,
        ...
        try {
            ...
            cryptoPaymentRequestTable.addUUIDFilter(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_ID_COLUMN_NAME, requestId, DatabaseFilterType.EQUAL);
            ...
            if (!records.isEmpty()) {
                ...
                record.setStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_PROTOCOL_STATE_COLUMN_NAME, actorAssetProtocolState.getCode());
    ...
    public void changeActorAssetNotificationDescriptor(final String senderPublicKey,
        ...
        try {
            ...
            cryptoPaymentRequestTable.addStringFilter(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_SENDER_PUBLIC_KEY_COLUMN_NAME, senderPublicKey, DatabaseFilterType.EQUAL);
            ...
            if (!records.isEmpty()) {
                ...
                record.setStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_DESCRIPTOR_COLUMN_NAME, assetNotificationDescriptor.getCode());
    ...
    public List<ActorAssetNetworkServiceRecord> listRequestsByProtocolStateAndType(final ActorAssetProtocolState actorAssetProtocolState)
        ...
        try {
            ...
            cryptoPaymentRequestTable.addStringFilter(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_PROTOCOL_STATE_COLUMN_NAME, actorAssetProtocolState.getCode(), DatabaseFilterType.EQUAL);
    ...
    public List<ActorAssetNetworkServiceRecord> listRequestsByProtocolStateAndType(final ActorAssetProtocolState actorAssetProtocolState,
        ...
        try {
            ...
            cryptoPaymentRequestTable.addStringFilter(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_PROTOCOL_STATE_COLUMN_NAME, actorAssetProtocolState.getCode(), DatabaseFilterType.EQUAL);
            cryptoPaymentRequestTable.addStringFilter(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_DESCRIPTOR_COLUMN_NAME, assetNotificationDescriptor.getCode(), DatabaseFilterType.EQUAL);
    ...
    private DatabaseTableRecord buildDatabaseRecord(final DatabaseTableRecord dbRecord,
        ...
        try {
            dbRecord.setUUIDValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_ID_COLUMN_NAME, record.getId());
            dbRecord.setStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_SENDER_ALIAS_COLUMN_NAME, record.getActorSenderAlias());

            dbRecord.setStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_DESCRIPTOR_COLUMN_NAME, record.getAssetNotificationDescriptor().getCode());
            dbRecord.setStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_RECEIVER_TYPE_COLUMN_NAME, record.getActorDestinationType().getCode());
            dbRecord.setStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_SENDER_TYPE_COLUMN_NAME, record.getActorSenderType().getCode());
            dbRecord.setStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_SENDER_PUBLIC_KEY_COLUMN_NAME, record.getActorSenderPublicKey());
            dbRecord.setStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_RECEIVER_PUBLIC_KEY_COLUMN_NAME, record.getActorDestinationPublicKey());
            dbRecord.setLongValue  (AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_TIMESTAMP_COLUMN_NAME, record.getSentDate());
            dbRecord.setStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_PROTOCOL_STATE_COLUMN_NAME, record.getActorAssetProtocolState().getCode());
            dbRecord.setStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_READ_MARK_COLUMN_NAME, String.valueOf(record.isFlagRead()));

            if (record.getBlockchainNetworkType() != null)
                dbRecord.setStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_BLOCKCHAIN_NETWORK_TYPE_COLUMN_NAME, record.getBlockchainNetworkType().getCode());
            if (record.getResponseToNotificationId() != null)
                dbRecord.setUUIDValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_RESPONSE_TO_NOTIFICATION_ID_COLUMN_NAME, record.getResponseToNotificationId());
    ...
    private ActorAssetNetworkServiceRecord buildAssetUserNetworkServiceRecord(DatabaseTableRecord record) throws InvalidParameterException {
        try {
            ...
            UUID notificationId = record.getUUIDValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_ID_COLUMN_NAME);
            String senderAlias = record.getStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_SENDER_ALIAS_COLUMN_NAME);
            String descriptor = record.getStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_DESCRIPTOR_COLUMN_NAME);
            String destinationType = record.getStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_RECEIVER_TYPE_COLUMN_NAME);
            String senderType = record.getStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_SENDER_TYPE_COLUMN_NAME);
            String senderPublicKey = record.getStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_SENDER_PUBLIC_KEY_COLUMN_NAME);
            String destinationPublicKey = record.getStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_RECEIVER_PUBLIC_KEY_COLUMN_NAME);
            long timestamp = record.getLongValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_TIMESTAMP_COLUMN_NAME);
            String protocolState = record.getStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_PROTOCOL_STATE_COLUMN_NAME);
            String flagRead = record.getStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_READ_MARK_COLUMN_NAME);
            String blockchainNetwork = record.getStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_BLOCKCHAIN_NETWORK_TYPE_COLUMN_NAME);
            UUID responseToNotificationId = record.getUUIDValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_RESPONSE_TO_NOTIFICATION_ID_COLUMN_NAME);
            ...
            try {
                profileImage = getActorUserProfileImagePrivateKey(record.getStringValue(AssetRedeemNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_SENDER_PUBLIC_KEY_COLUMN_NAME));
