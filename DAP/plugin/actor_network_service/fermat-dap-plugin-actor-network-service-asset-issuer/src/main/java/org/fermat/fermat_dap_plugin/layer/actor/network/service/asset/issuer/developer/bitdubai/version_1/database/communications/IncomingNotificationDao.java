...
public class IncomingNotificationDao {
    ...
    public DatabaseTable getDatabaseTable() {
        return database.getTable(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_TABLE_NAME);
    }
...
//                        senderPhrase,
    ...
    public List<ActorNotification> listUnreadNotifications() throws CantGetActorAssetNotificationException {
        ...
        try {
            ...
            cryptoPaymentRequestTable.addStringFilter(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_READ_MARK_COLUMN_NAME, String.valueOf(false), DatabaseFilterType.EQUAL);
    ...
    public void update(ActorAssetNetworkServiceRecord entity) throws CantUpdateRecordDataBaseException {
        ...
        try {
            ...
            //Set filter
            incomingNotificationtable.addUUIDFilter(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_ID_COLUMN_NAME, entity.getId(), DatabaseFilterType.EQUAL);
    ...
    public ActorAssetNetworkServiceRecord getNotificationById(final UUID notificationId) throws CantGetActorAssetNotificationException {
        ...
        try {
            ...
            cryptoPaymentRequestTable.addUUIDFilter(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_ID_COLUMN_NAME, notificationId, DatabaseFilterType.EQUAL);
    ...
    public void changeProtocolState(final UUID requestId,
        ...
        try {
            ...
            cryptoPaymentRequestTable.addUUIDFilter(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_ID_COLUMN_NAME, requestId, DatabaseFilterType.EQUAL);
    ...
    public void changeActorAssetNotificationDescriptor(final String senderPublicKey,
        ...
        try {
            ...
            cryptoPaymentRequestTable.addStringFilter(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_SENDER_PUBLIC_KEY_COLUMN_NAME, senderPublicKey, DatabaseFilterType.EQUAL);
    ...
    public List<ActorAssetNetworkServiceRecord> listRequestsByProtocolStateAndType(final ActorAssetProtocolState actorAssetProtocolState)
        ...
        try {
            ...
            cryptoPaymentRequestTable.addStringFilter(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_PROTOCOL_STATE_COLUMN_NAME, actorAssetProtocolState.getCode(), DatabaseFilterType.EQUAL);
    ...
    public List<ActorAssetNetworkServiceRecord> listRequestsByProtocolStateAndType(final ActorAssetProtocolState actorAssetProtocolState,
        ...
        try {
            ...
            cryptoPaymentRequestTable.addStringFilter(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_PROTOCOL_STATE_COLUMN_NAME, actorAssetProtocolState.getCode(), DatabaseFilterType.EQUAL);
            cryptoPaymentRequestTable.addStringFilter(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_DESCRIPTOR_COLUMN_NAME, assetNotificationDescriptor.getCode(), DatabaseFilterType.EQUAL);
    ...
    private DatabaseTableRecord buildDatabaseRecord(final DatabaseTableRecord dbRecord,
        ...
        try {
            dbRecord.setUUIDValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_ID_COLUMN_NAME, record.getId());
            dbRecord.setStringValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_SENDER_ALIAS_COLUMN_NAME, record.getActorSenderAlias());

            dbRecord.setStringValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_DESCRIPTOR_COLUMN_NAME, record.getAssetNotificationDescriptor().getCode());
            dbRecord.setStringValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_RECEIVER_TYPE_COLUMN_NAME, record.getActorDestinationType().getCode());
            ...
            if (record.getBlockchainNetworkType() != null)
                dbRecord.setStringValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_BLOCKCHAIN_NETWORK_TYPE_COLUMN_NAME, record.getBlockchainNetworkType().getCode());
            if (record.getResponseToNotificationId() != null)
                dbRecord.setUUIDValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_RESPONSE_TO_NOTIFICATION_ID_COLUMN_NAME, record.getResponseToNotificationId());
            if (record.getMessageXML() != null)
                dbRecord.setStringValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_MESSAGE, record.getMessageXML());
    ...
    private ActorAssetNetworkServiceRecord buildAssetUserNetworkServiceRecord(DatabaseTableRecord record) throws InvalidParameterException {
        try {
            ...
            UUID notificationId = record.getUUIDValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_ID_COLUMN_NAME);
            String senderAlias = record.getStringValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_SENDER_ALIAS_COLUMN_NAME);
            String descriptor = record.getStringValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_DESCRIPTOR_COLUMN_NAME);
            String destinationType = record.getStringValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_RECEIVER_TYPE_COLUMN_NAME);
            String senderType = record.getStringValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_SENDER_TYPE_COLUMN_NAME);
            String senderPublicKey = record.getStringValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_SENDER_PUBLIC_KEY_COLUMN_NAME);
            String destinationPublicKey = record.getStringValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_RECEIVER_PUBLIC_KEY_COLUMN_NAME);
            long timestamp = record.getLongValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_TIMESTAMP_COLUMN_NAME);
            String protocolState = record.getStringValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_PROTOCOL_STATE_COLUMN_NAME);
            String flagRead = record.getStringValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_READ_MARK_COLUMN_NAME);
            String blockChainNetwork = record.getStringValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_BLOCKCHAIN_NETWORK_TYPE_COLUMN_NAME);
            UUID responseToNotificationId = record.getUUIDValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_RESPONSE_TO_NOTIFICATION_ID_COLUMN_NAME);
            String messageXML = record.getStringValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_MESSAGE);
            ...
            try {
                profileImage = getActorUserProfileImagePrivateKey(record.getStringValue(AssetIssuerNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_SENDER_PUBLIC_KEY_COLUMN_NAME));
