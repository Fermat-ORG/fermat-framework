 ...
 */
public class NewRequestMessageActorNotificationEventListener implements FermatEventListener {
    ...
    public NewRequestMessageActorNotificationEventListener(EventType eventType, FermatEventMonitor fermatEventMonitor) {
