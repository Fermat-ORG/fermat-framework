 ...
 */
public class CantConnectToActorAssetUserException extends FermatException {

    public static final String DEFAULT_MESSAGE = "There was an error connecting to the Actor Asset Issuer";

    public CantConnectToActorAssetUserException(String message, Exception cause, String context, String possibleReason) {
