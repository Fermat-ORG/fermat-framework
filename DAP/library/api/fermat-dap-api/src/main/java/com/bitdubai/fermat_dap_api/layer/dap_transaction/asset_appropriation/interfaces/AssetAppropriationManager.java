...
public interface AssetAppropriationManager {
     ...
     * @param addressTo                the crypto address where the money will be sent.
     ...
     */
    void appropriateAsset(DigitalAsset digitalAsset, String assetUserWalletPublicKey, CryptoAddress addressTo) throws CantExecuteAppropriationTransactionException, TransactionAlreadyStartedException;
     ...
     * @param addressTo                the crypto address associated with the appropriation
     ...
     */
    AssetAppropriationTransactionRecord getTransaction(DigitalAsset digitalAsset, String assetUserWalletPublicKey, CryptoAddress addressTo) throws RecordsNotFoundException, CantLoadAssetAppropriationTransactionListException;
     ...
     * @return {@link List} instance filled with all the transactions associated
     * @throws RecordsNotFoundException
     * @throws CantLoadAssetAppropriationTransactionListException
     */
    List<AssetAppropriationTransactionRecord> getTransactionsForUserWallet(String assetUserWalletPublicKey) throws RecordsNotFoundException, CantLoadAssetAppropriationTransactionListException;
     ...
     * @throws CantLoadAssetAppropriationTransactionListException
     */
    List<AssetAppropriationTransactionRecord> getTransactionsForStatus(AppropriationStatus status) throws RecordsNotFoundException, CantLoadAssetAppropriationTransactionListException;
