...
public final class Validate {
    ...
    public static <T> T verifySetter(T objectToSet, String message) throws org.fermat.fermat_dap_api.layer.all_definition.exceptions.CantSetObjectException {
        if (isObjectNull(objectToSet)) {
            throw new org.fermat.fermat_dap_api.layer.all_definition.exceptions.CantSetObjectException(message);
        }
        return objectToSet;
    }

    public static <T> T verifyGetter(T objectToGet, String message) throws org.fermat.fermat_dap_api.layer.all_definition.exceptions.ObjectNotSetException {
        if (isObjectNull(objectToGet)) {
            throw new org.fermat.fermat_dap_api.layer.all_definition.exceptions.ObjectNotSetException(message);
