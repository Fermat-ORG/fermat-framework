 ...
 */
public class ActorAssetIssuerCompleteRegistrationNotificationEventListener implements FermatEventListener {
     ...
     */
    public ActorAssetIssuerCompleteRegistrationNotificationEventListener(org.fermat.fermat_dap_api.layer.all_definition.enums.EventType eventType, FermatEventMonitor fermatEventMonitor) {
     ...
     */
    @Override
    public org.fermat.fermat_dap_api.layer.all_definition.enums.EventType getEventType() {
        return eventType;
    }
