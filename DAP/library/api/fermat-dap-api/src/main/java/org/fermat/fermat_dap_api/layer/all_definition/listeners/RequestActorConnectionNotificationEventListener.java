 ...
 */
public class RequestActorConnectionNotificationEventListener implements FermatEventListener {
    ...
    public RequestActorConnectionNotificationEventListener(EventType eventType, FermatEventMonitor fermatEventMonitor) {
