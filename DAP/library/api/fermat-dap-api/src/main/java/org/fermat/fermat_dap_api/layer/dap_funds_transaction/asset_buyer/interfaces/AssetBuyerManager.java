...
public interface AssetBuyerManager extends FermatManager {
    ...
    List<org.fermat.fermat_dap_api.layer.all_definition.digital_asset.AssetNegotiation> getNewNegotiations(BlockchainNetworkType networkType) throws org.fermat.fermat_dap_api.layer.dap_funds_transaction.asset_buyer.exceptions.CantGetBuyingTransactionsException;

    org.fermat.fermat_dap_api.layer.dap_actor.asset_user.interfaces.ActorAssetUser getSellerFromNegotiation(UUID negotiationID) throws org.fermat.fermat_dap_api.layer.dap_funds_transaction.asset_buyer.exceptions.CantGetBuyingTransactionsException;
}
