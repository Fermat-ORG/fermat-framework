/*
 * @#CommunicationsNetworkNodeP2PDatabaseConstants.java - 2015
...
public class CommunicationsNetworkNodeP2PDatabaseConstants {
    ...
    public static final String ACTORS_CATALOG_TRANSACTIONS_PENDING_FOR_PROPAGATION_HASH_ID_COLUMN_NAME = "hash_id";
    public static final String ACTORS_CATALOG_TRANSACTIONS_PENDING_FOR_PROPAGATION_IDENTITY_PUBLIC_KEY_COLUMN_NAME = "identity_public_key";
    public static final String ACTORS_CATALOG_TRANSACTIONS_PENDING_FOR_PROPAGATION_NAME_COLUMN_NAME = "name";
    public static final String ACTORS_CATALOG_TRANSACTIONS_PENDING_FOR_PROPAGATION_ALIAS_COLUMN_NAME = "alias";
    public static final String ACTORS_CATALOG_TRANSACTIONS_PENDING_FOR_PROPAGATION_ACTOR_TYPE_COLUMN_NAME = "actor_type";
    public static final String ACTORS_CATALOG_TRANSACTIONS_PENDING_FOR_PROPAGATION_PHOTO_COLUMN_NAME = "photo";
    public static final String ACTORS_CATALOG_TRANSACTIONS_PENDING_FOR_PROPAGATION_LAST_LATITUDE_COLUMN_NAME = "last_latitude";
    public static final String ACTORS_CATALOG_TRANSACTIONS_PENDING_FOR_PROPAGATION_LAST_LONGITUDE_COLUMN_NAME = "last_longitude";
    ...
    public static final String CALLS_LOG_FIRST_KEY_COLUMN = "call_id";
    ...
    public static final String CHECKED_IN_ACTOR_UUID_COLUMN_NAME = "uuid";
    ...
    public static final String CHECKED_IN_NETWORK_SERVICE_UUID_COLUMN_NAME = "uuid";
    ...
    public static final String CHECKED_IN_NETWORK_SERVICE_FIRST_KEY_COLUMN = "uuid";
    ...
    public static final String CHECKED_NETWORK_SERVICE_HISTORY_FIRST_KEY_COLUMN = "uuid";
    ...
    public static final String CLIENTS_CONNECTIONS_HISTORY_FIRST_KEY_COLUMN = "uuid";
    ...
    public static final String NODES_CONNECTIONS_HISTORY_FIRST_KEY_COLUMN = "uuid";
    ...
    public static final String METHOD_CALLS_HISTORY_FIRST_KEY_COLUMN = "uuid";
    ...
    public static final String NODES_CATALOG_FIRST_KEY_COLUMN = "identity_public_key";
    ...
    public static final String NODES_CATALOG_TRANSACTION_FIRST_KEY_COLUMN = "hash_id";
    ...
    public static final String NODES_CATALOG_TRANSACTIONS_PENDING_FOR_PROPAGATION_FIRST_KEY_COLUMN = "hash_id";
