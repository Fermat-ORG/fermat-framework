package unit.com.bitdubai.fermat_p2p_plugin.layer.communication.cloud_server.developer.bitdubai.version_1.CloudServerCommunicationPluginRoot;
...
public class getClassesFullPathTest {
    ...
    public void generateClassesTree() throws ClassNotFoundException {
        ...
        String scannedPackage = CloudServerCommunicationPluginRoot.class.getPackage().getName();
        List<Class<?>> classes = find(CloudServerCommunicationPluginRoot.class.getPackage().getName());
        CloudServerCommunicationPluginRoot root = new CloudServerCommunicationPluginRoot();
