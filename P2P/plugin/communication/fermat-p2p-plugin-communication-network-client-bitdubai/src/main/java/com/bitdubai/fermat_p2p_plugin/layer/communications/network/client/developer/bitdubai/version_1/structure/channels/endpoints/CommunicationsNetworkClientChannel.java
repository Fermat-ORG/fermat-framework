...
import com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.NetworkServiceCallRequestProcessor;
import com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.ServerHandshakeRespondProcessor;
import com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.conf.ClientChannelConfigurator;
...
public class CommunicationsNetworkClientChannel {
     ...
     */
    private Map<PackageType, List<com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.PackageProcessor>> packageProcessors;
    ...
    private void initPackageProcessorsRegistration(){
         ...
         */
        registerMessageProcessor(new com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.ActorTraceDiscoveryQueryRespondProcessor(this));
        registerMessageProcessor(new com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.ActorCallRequestProcessor(this));
        registerMessageProcessor(new com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.ActorCallRespondProcessor(this));
        registerMessageProcessor(new com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.CheckInActorRespondProcessor(this));
        registerMessageProcessor(new com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.CheckInClientRespondProcessor(this));
        registerMessageProcessor(new com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.CheckInNetworkServiceRespondProcessor(this));
        registerMessageProcessor(new com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.CheckInProfileDiscoveryQueryRespondProcessor(this));
        registerMessageProcessor(new com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.NearNodeListRespondProcessor(this));
        registerMessageProcessor(new NetworkServiceCallRequestProcessor(this));
        registerMessageProcessor(new com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.NetworkServiceCallRespondProcessor(this));
        registerMessageProcessor(new ServerHandshakeRespondProcessor(this));
        registerMessageProcessor(new com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.CheckOutClientRespondProcessor(this));
        registerMessageProcessor(new com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.CheckOutNetworkServiceRespondProcessor(this));
        registerMessageProcessor(new com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.CheckOutActorRespondProcessor(this));
    ...
    protected void processMessage(Package packageReceived, Session session) throws PackageTypeNotSupportedException {
        ...
        if (canProcessMessage(packageReceived.getPackageType())){
             ...
             */
            for (com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.PackageProcessor packageProcessor : packageProcessors.get(packageReceived.getPackageType())) {
     ...
     * channel
     */
    public void registerMessageProcessor(com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.PackageProcessor packageProcessor) {
        ...
        if (packageProcessors.containsKey(packageProcessor.getPackageType())){
             ...
             * Create a new list
             */
            List<com.bitdubai.fermat_p2p_plugin.layer.communications.network.client.developer.bitdubai.version_1.structure.channels.processors.PackageProcessor> packageProcessorList = new ArrayList<>();
