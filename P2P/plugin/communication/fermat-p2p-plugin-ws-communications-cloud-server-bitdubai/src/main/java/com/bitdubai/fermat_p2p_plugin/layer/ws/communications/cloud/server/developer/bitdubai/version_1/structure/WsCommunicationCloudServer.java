 ...
 * @since Java JDK 1.7
 */
public class WsCommunicationCloudServer extends WebSocketServer {
     ...
     */
    private List<?> packetProcessorsCache;
    ...
    public void onOpen(WebSocket clientConnection, ClientHandshake handshake) {
        ...
        System.out.println(" temp-idem = " + handshake.getFieldValue("temp-idem"));

        if (handshake.getFieldValue("temp-idem") != null &&
                handshake.getFieldValue("temp-idem") != ""){
