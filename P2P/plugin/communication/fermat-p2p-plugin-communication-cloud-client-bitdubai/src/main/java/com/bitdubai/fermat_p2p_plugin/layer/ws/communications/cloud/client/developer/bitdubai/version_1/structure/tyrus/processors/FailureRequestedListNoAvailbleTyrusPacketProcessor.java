...
/**
 * The Class <code>com.bitdubai.fermat_p2p_plugin.layer.ws.communications.cloud.client.developer.bitdubai.version_1.structure.processors.FailureComponentRegistrationRequestTyrusPacketProcessor</code> implement
 ...
 * @since Java JDK 1.7
 */
public class FailureRequestedListNoAvailbleTyrusPacketProcessor extends FermatTyrusPacketProcessor {
     ...
     * Constructor
     */
    public FailureRequestedListNoAvailbleTyrusPacketProcessor(WsCommunicationsTyrusCloudClientChannel wsCommunicationsTyrusCloudClientChannel){
    ...
    public void processingPackage(FermatPacket receiveFermatPacket){
        ...
        //System.out.println("FailureComponentRegistrationRequestTyrusPacketProcessor - networkServiceApplicant " + networkServiceApplicant);
         ...
         */
        ((FailureRequestedListNotAvailableNotificationEvent)event).setNetworkServiceApplicant(networkServiceApplicant);
        ((FailureRequestedListNotAvailableNotificationEvent)event).setDiscoveryQueryParameters(discoveryQueryParameters);

        /*
         * Raise the event
         */
        //System.out.println("FailureComponentRegistrationRequestTyrusPacketProcessor - Raised a event = P2pEventType.FAILURE_COMPONENT_REGISTRATION_REQUEST_NOTIFICATION");
