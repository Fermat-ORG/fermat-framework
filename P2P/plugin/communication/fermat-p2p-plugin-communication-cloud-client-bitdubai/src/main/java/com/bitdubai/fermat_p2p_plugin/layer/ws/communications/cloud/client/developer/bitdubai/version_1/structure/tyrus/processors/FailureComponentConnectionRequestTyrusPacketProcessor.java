...
/**
 * The Class <code>com.bitdubai.fermat_p2p_plugin.layer.ws.communications.cloud.client.developer.bitdubai.version_1.structure.processors.FailureComponentConnectionRequestTyrusPacketProcessor</code> implement
 ...
 * @since Java JDK 1.7
 */
public class FailureComponentConnectionRequestTyrusPacketProcessor extends FermatTyrusPacketProcessor {
     ...
     * Constructor
     */
    public FailureComponentConnectionRequestTyrusPacketProcessor(WsCommunicationsTyrusCloudClientChannel wsCommunicationsTyrusCloudClientChannel){
    ...
    public void processingPackage(FermatPacket receiveFermatPacket){
        ...
        //System.out.println("FailureComponentConnectionRequestTyrusPacketProcessor - messageContentJsonStringRepresentation = "+messageContentJsonStringRepresentation);
        ...
        //System.out.println("FailureComponentConnectionRequestTyrusPacketProcessor - networkServiceApplicant "+networkServiceApplicant.toJson());
         ...
         * Raise the event
         */
        //System.out.println("FailureComponentConnectionRequestTyrusPacketProcessor - Raised a event = P2pEventType.FAILURE_COMPONENT_CONNECTION_REQUEST_NOTIFICATION");
