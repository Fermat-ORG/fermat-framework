/*
 * @#CheckedNetworkServicesHistoryDao.java - 2015
 ...
 * @since Java JDK 1.7
 */
public class CheckedNetworkServicesHistoryDao extends AbstractBaseDao<CheckedNetworkServicesHistory> {
    ...
    protected CheckedNetworkServicesHistory getEntityFromDatabaseTableRecord(DatabaseTableRecord record) throws InvalidParameterException {
        ...
        entity.setCheckedTimestamp(getTimestampFromLongValue(record.getLongValue(CommunicationsNetworkNodeP2PDatabaseConstants.CHECKED_NETWORK_SERVICE_HISTORY_CHECKED_TIMESTAMP_COLUMN_NAME)));
    ...
    protected DatabaseTableRecord getDatabaseTableRecordFromEntity(CheckedNetworkServicesHistory entity) {
        ...
        databaseTableRecord.setLongValue(CommunicationsNetworkNodeP2PDatabaseConstants.CHECKED_NETWORK_SERVICE_HISTORY_CHECKED_TIMESTAMP_COLUMN_NAME, getLongValueFromTimestamp(entity.getCheckedTimestamp()));
