 ...
 * @since Java JDK 1.7
 */
public class AbstractCommunicationNetworkServiceRemoteAgent extends Observable {
     ...
     */
    public AbstractCommunicationNetworkServiceRemoteAgent(final ECCKeyPair eccKeyPair,
        ...
        try {
           ...
           // System.out.println("CommunicationNetworkServiceRemoteAgent - "+communicationsVPNConnection.isActive());
            ...
            if(!toReceive.isInterrupted()){
                //Sleep for a time
                Thread.sleep(AbstractCommunicationNetworkServiceRemoteAgent.SLEEP_TIME);
            }
