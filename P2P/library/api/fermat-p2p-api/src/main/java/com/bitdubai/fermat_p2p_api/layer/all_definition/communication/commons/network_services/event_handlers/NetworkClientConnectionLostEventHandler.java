 ...
 * reference: <code>P2pEventType.NETWORK_CLIENT_CONNECTION_LOST</code>
 * <p/>
 *
 ...
 * @since   Java JDK 1.7
 */
public class NetworkClientConnectionLostEventHandler implements FermatEventHandler<NetworkClientConnectionLostEvent> {
    ...
    */
     ...
     */
    public NetworkClientConnectionLostEventHandler(AbstractNetworkService networkService) {
    ...
    public void handleEvent(NetworkClientConnectionLostEvent fermatEvent) throws FermatException {
        ...
        if (this.networkService.isStarted())
            networkService.handleNetworkClientConnectionLostEvent(fermatEvent.getCommunicationChannel());
