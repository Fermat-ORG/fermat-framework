 ...
 * the event listener for the <code>com.bitdubai.fermat_pip_api.layer.pip_platform_service.event_manager.enums.P2pEventType.COMPONENT_REGISTRATION_COMPLETE_NOTIFICATION</code>.
 * <p/>
 *
...
public class CompleteComponentRegistrationNotificationEventListener extends BasicFermatEventListener {
     ...
     * @param eventMonitor
     */
    public CompleteComponentRegistrationNotificationEventListener(P2pEventType p2pEventType, FermatEventMonitor eventMonitor) {
