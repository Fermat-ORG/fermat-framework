...
import com.bitbudai.fermat_cht_android_sub_app_chat_bitdubai.filters.ChatListFilterNew;
 ...
 * @version 1.0
 */
public class ChatListAdapterNEw extends FermatAdapter<Chat, ChatHolder> implements Filterable {

    private String filterString;

    long time, nanos, milliseconds;

    public ChatListAdapterNEw(Context context, ArrayList<Chat> chats) {
        super(context, chats);
    }
    ...
    public Filter getFilter() {
        return new ChatListFilterNew(dataSet, this);
    }
