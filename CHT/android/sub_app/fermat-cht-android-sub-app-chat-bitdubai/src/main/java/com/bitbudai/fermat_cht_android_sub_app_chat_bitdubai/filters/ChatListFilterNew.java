...
import com.bitbudai.fermat_cht_android_sub_app_chat_bitdubai.adapters.ChatListAdapterNEw;
 ...
 * @version 1.0
 */
public class ChatListFilterNew extends Filter {

    private List<Chat> data;
    private ChatListAdapterNEw adapter;

    public ChatListFilterNew(List<Chat> data, ChatListAdapterNEw adapter) {
        this.data = data;
