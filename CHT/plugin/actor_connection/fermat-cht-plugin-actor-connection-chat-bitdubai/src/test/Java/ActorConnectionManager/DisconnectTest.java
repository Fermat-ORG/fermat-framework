...
public class DisconnectTest {
    ...
    @Test
    public void disconnect() throws CantDisconnectFromActorException, ActorConnectionNotFoundException, UnexpectedConnectionStateException {
        ActorConnectionManager actorConnectionManager = mock(ActorConnectionManager.class);

        doCallRealMethod().when(actorConnectionManager).disconnect(Mockito.any(UUID.class));
    }
