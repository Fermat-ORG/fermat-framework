...
//        ExecutorService executorService =
    ...
    public void start(){
        ...
        System.out.println("ChatNetworkServicePluginRoot - CommunicationNetworkServiceRemoteAgent - started ");
    ...
    private void processMessageReceived(){
        ...
        try {
             ...
             System.out.println("ChatNetworkServicePluginRoot - CommunicationNetworkServiceRemoteAgent - "+communicationsVPNConnection.isActive());
            ...
            errorManager.reportUnexpectedPluginException(Plugins.CHAT_NETWORK_SERVICE, UnexpectedPluginExceptionSeverity.DISABLES_SOME_FUNCTIONALITY_WITHIN_THIS_PLUGIN, new Exception("Can not process message received. Error reason: "+e.getMessage()));
        }
    }
    ...
    public void processMessageToSend(){
        ...
        try {
            ...
            try {
                ...
                filters.put(NetworkServiceChatNetworkServiceDatabaseConstants.OUTGOING_MESSAGES_STATUS_COLUMN_NAME, MessagesStatus.PENDING_TO_SEND.getCode());
                filters.put(NetworkServiceChatNetworkServiceDatabaseConstants.OUTGOING_MESSAGES_RECEIVER_ID_COLUMN_NAME, communicationsVPNConnection.getRemoteParticipant().getIdentityPublicKey());
                ...
                for (FermatMessage message: messages){
                    ...
                    if (communicationsVPNConnection.isActive() && (message.getFermatMessagesStatus() != FermatMessagesStatus.SENT) && communicationsVPNConnection.isConnected()) {
                        ...
                        fermatEvent.setSource(ChatNetworkServicePluginRoot.EVENT_SOURCE);
                ...
                errorManager.reportUnexpectedPluginException(Plugins.CHAT_NETWORK_SERVICE, UnexpectedPluginExceptionSeverity.DISABLES_SOME_FUNCTIONALITY_WITHIN_THIS_PLUGIN, new Exception("Can not process messages to send. Error reason: "+e.getMessage()));
