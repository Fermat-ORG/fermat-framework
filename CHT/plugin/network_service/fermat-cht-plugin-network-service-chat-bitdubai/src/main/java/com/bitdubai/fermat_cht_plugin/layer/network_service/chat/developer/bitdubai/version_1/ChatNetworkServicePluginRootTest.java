...
import com.bitdubai.fermat_cht_plugin.layer.network_service.chat.developer.bitdubai.version_1.database.ChatMetadataRecordDAOTest;
...
public class ChatNetworkServicePluginRootTest extends AbstractNetworkService implements NetworkServiceChatManager,
    ...
    private ChatMetadataRecordDAOTest chatMetadataRecordDAO;
    /**
     ...
     *
     */
    public ChatNetworkServicePluginRootTest() {
        super(
    ...
    public ChatMetadataRecordDAOTest getChatMetadataRecordDAO() {
    ...
    protected void onNetworkServiceStart() {
         ...
         */
            ...
            chatMetadataRecordDAO = new ChatMetadataRecordDAOTest(dataBaseCommunication);
