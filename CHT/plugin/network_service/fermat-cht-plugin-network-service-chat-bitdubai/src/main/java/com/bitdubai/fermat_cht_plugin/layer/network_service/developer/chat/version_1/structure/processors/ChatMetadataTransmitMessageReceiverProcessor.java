 ...
 */
package com.bitdubai.fermat_cht_plugin.layer.network_service.developer.chat.version_1.structure.processors;
    ...
    public void processingMessage(FermatMessage fermatMessage, JsonObject jsonMsjContent) {
        ...
        try {
            ...
            */
             ...
             */
            getChatPluginRoot().getOutgoinChatMetaDataDao().create(chatMetadaTransactionRecord);
