...
public class IncomingNotificationDAO implements DAO {
     ...
     * @param pluginId
     */
    public IncomingNotificationDAO(Database database, PluginDatabaseSystem pluginDatabaseSystem, UUID pluginId) {
        super();
    ...
    DatabaseTable getDatabaseTable(Database database) {
        return database.getTable(CommunicationChatNetworkServiceDatabaseConstants.INCOMING_CHAT_TABLE_NOTIFICATION_TABLE_NAME);
    }
    ...
    public List<ChatMetadataRecord> findAll(String columnName, String columnValue) throws CantReadRecordDataBaseException {
        ...
        try {
             ...
             */
            Database database = openDatabase();
            DatabaseTable templateTable = getDatabaseTable(database);
    ...
    public ChatMetadataRecord getNotificationById(UUID transactionID) throws CantGetNotificationException, NotificationNotFoundException, CantReadRecordDataBaseException {
        ...
        try {
             ...
             */
            Database database = openDatabase();
            DatabaseTable incomingMessageTable = getDatabaseTable(database);
    ...
    @Override
    public void changeChatProtocolState(UUID requestId, ChatProtocolState protocolState) throws CantReadRecordDataBaseException, NotificationNotFoundException, CantGetNotificationException, CantUpdateRecordDataBaseException {
        if (requestId == null) {
            throw new IllegalArgumentException("The senderPublicKey is required, can not be null");
        }
    ...
    public List<ChatMetadata> listUnreadNotifications() throws CHTException {
        try {
            ...
            databaseTable.addStringFilter(CommunicationChatNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_CHAT_READ_MARK_COLUMN_NAME, String.valueOf(false), DatabaseFilterType.EQUAL);
    ...
    public void update(ChatMetadataRecord entity) throws CantUpdateRecordDataBaseException {
        ...
        try {
            ...
            Database database = openDatabase();
            DatabaseTable databaseTable = getDatabaseTable(database);
            databaseTable.addStringFilter(CommunicationChatNetworkServiceDatabaseConstants.INCOMING_NOTIFICATION_CHAT_TRANSACTION_ID_COLUMN_NAME, entity.getTransactionId().toString(), DatabaseFilterType.EQUAL);
            databaseTable.loadToMemory();
