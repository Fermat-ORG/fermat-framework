...
public class EncodeMsjContent {
     ...
     *
     * @param chatMetadaTransactionRecordToSend
     * @return String message content
     */
    public static String encodeMSjContentChatMetadataTransmit(ChatMetadaTransactionRecord chatMetadaTransactionRecordToSend, PlatformComponentType senderType, PlatformComponentType receiverType){
        ...
        jsonObjectContent.addProperty(ChatTransmissionJsonAttNames.CHAT_METADATA, chatMetadaTransactionRecordToSend.toString());
