...
public class DenyConnectionTest {
    ...
    @Test
    public void denyConnection() throws CantDenyConnectionRequestException, ConnectionRequestNotFoundException {
        ChatActorNetworkServiceManager chatActorNetworkServiceManager = mock(ChatActorNetworkServiceManager.class);

        doCallRealMethod().when(chatActorNetworkServiceManager).denyConnection(Mockito.any(UUID.class));
    }
