...
import com.bitdubai.fermat_cht_plugin.layer.actor_network_service.chat.developer.bitdubai.version_1.structure.ChatActorNetworkServiceManagerTest;
...
public class ChatActorNetworkServicePluginRootTest extends AbstractActorNetworkService implements DatabaseManagerForDevelopers {
    ...
    private ChatActorNetworkServiceManagerTest fermatManager;

    public ChatActorNetworkServicePluginRootTest() {
    ...
    protected void onActorNetworkServiceStart() throws CantStartPluginException {
        ...
        try {
            ...
            fermatManager = new ChatActorNetworkServiceManagerTest(
