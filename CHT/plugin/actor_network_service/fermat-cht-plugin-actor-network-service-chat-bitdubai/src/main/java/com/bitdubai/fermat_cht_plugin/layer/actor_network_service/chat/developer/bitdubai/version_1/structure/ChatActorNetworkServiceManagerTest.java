 ...
 * @since   Java JDK 1.7
 */
public class ChatActorNetworkServiceManagerTest implements ChatManager {
    ...
    public ChatActorNetworkServiceManagerTest(final ChatActorNetworkServiceDao chatActorNetworkServiceDao,
                                              final ChatActorNetworkServicePluginRootTest pluginRoot) {
    ...
    public ChatSearch getSearch() {
        return new ChatActorNetworkServiceSearchTest(pluginRoot);
    }
