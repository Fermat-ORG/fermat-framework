 ...
 */
public class IncomingMessageEventHandler  extends AbstractChatMiddlewareEventHandler<IncomingMessage>  {
    ...
    @Override
    public void handleCHTEvent(IncomingMessage fermatEvent) throws FermatException {
