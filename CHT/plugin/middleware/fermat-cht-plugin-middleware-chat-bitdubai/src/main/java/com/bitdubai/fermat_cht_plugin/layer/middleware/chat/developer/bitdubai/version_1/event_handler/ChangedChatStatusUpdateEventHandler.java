 ...
 */
public class ChangedChatStatusUpdateEventHandler extends AbstractChatMiddlewareEventHandler<ChangedChatStatusUpdateEvent> {

    public ChangedChatStatusUpdateEventHandler(ChatMiddlewarePluginRoot pluginRoot, ChatMiddlewareEventActions eventActions) {
        super(pluginRoot, eventActions);
    }

    @Override
    public void handleCHTEvent(ChangedChatStatusUpdateEvent fermatEvent) throws FermatException {
