 ...
 */
public class MessageFailEventHandler extends AbstractChatMiddlewareEventHandler  {
    ...
    public void handleEvent(FermatEvent fermatEvent) throws FermatException {
        if (this.chatMiddlewareRecorderService.getStatus() == ServiceStatus.STARTED) {
            ...
            try {
                this.chatMiddlewareRecorderService.incomingMessageFailEventHandler((MessageFail) fermatEvent);
            } catch (CantSaveEventException exception) {
                throw new CantSaveEventException(exception, "Handling the MessageFail", "Check the cause");
