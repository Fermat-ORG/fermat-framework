package com.fermat_cht_plugin.layer.sub_app_module.chat.version_1;
...
import com.fermat_cht_plugin.layer.sub_app_module.chat.version_1.structure.ChatSupAppModuleManager;
...
public class ChatSupAppModulePluginRoot extends AbstractPlugin implements
    ...
    public ChatManager getChatManager() throws CHTException {
        try {
            if (chatManager == null) {
                chatManager = new ChatSupAppModuleManager();
            }
            return chatManager;
        }catch (Exception e) {
