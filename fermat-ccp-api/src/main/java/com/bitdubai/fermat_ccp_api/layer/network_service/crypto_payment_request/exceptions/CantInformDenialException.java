 ...
 */
public class CantInformDenialException extends FermatException {

    private static final String DEFAULT_MESSAGE = "CAN'T INFORM APPROVAL EXCEPTION";

    public CantInformDenialException(String message, Exception cause, String context, String possibleReason) {
        super(message, cause, context, possibleReason);
    }

    public CantInformDenialException(Exception cause, String context, String possibleReason) {
